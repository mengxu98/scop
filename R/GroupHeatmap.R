...
#' Default is `0`.
#' @param border Whether to add borders to the heatmap body and annotations.
#' Kept for backward compatibility. The more specific `heatmap_border`,
#' `cell_annotation_border`, and `feature_annotation_border` arguments inherit
#' from this value when left as `NULL`.
...
#' Default is `NULL`.
#' @param split_order A numeric vector specifying the order of splits.
#' Default is `NULL`.
#' @param split_method A character vector specifying the method for splitting features.
#' Options are `"kmeans"`, `"hclust"`, or `"mfuzz"`.
#' Default is `"kmeans"`.
