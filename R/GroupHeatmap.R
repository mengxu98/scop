...
#'   \item \code{enrichment:} NULL or a enrichment result generated by \link{RunEnrichment} when any of the parameters `anno_terms`, `anno_keys`, or `anno_features` is set to TRUE.
#' }
#'
#' @export
#'
