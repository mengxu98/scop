...
#' pairwise enrichment between metadata groups. Results are stored in
#' `srt@tools`; no cell-level metadata is written.
#'
#' @md
...
#'
#' @return A `Seurat` object with cell proximity enrichment results in
#' `srt@tools[[tool_name]]`.
#'
#' @export
...
#' detection. Result tables are stored in `srt@tools`; top genes are also stored
#' in `srt@misc[[tool_name]]` and can optionally update Seurat variable
#' features.
#'
#' @md
#' @inheritParams RunGiottoCluster
...
#' @param set_variable_features Whether to set Seurat variable features to the
#' top Giotto spatial genes.
#' @param top_n Number of top genes to store.
#' @param binSpect_params Additional parameters passed to `Giotto::binSpect()`.
#'
#' @return A `Seurat` object with Giotto spatial gene results in
#' `srt@tools[[tool_name]]`.
#'
#' @export
...
#' temporary backend for feature-level spatial co-expression modules. Results
#' are stored in `srt@tools`; no cell-level metadata is written.
#'
#' @md
#' @inheritParams RunGiottoCluster
#' @param network_method Spatial network method passed to
...
#'
#' @return A `Seurat` object with spatial co-expression module results in
#' `srt@tools[[tool_name]]`.
#'
#' @export
