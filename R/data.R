...
#' @title Compact Visium result example for spatial documentation
#'
#' @description
...
#' results for short documentation examples. Optional backend results are only
#' included when generated and validated from the pinned source workflow.
#'
#' @format A Seurat object with 5000 genes and 400 spots.
#' @source
#' Derived from GSE254829 GSM8058244 through the reproducible assets in
#' \url{https://github.com/mengxu98/datasets/tree/main/SCOPExamples}.
#'
#' @examples
...
#'
#' @name visium_human_pancreas_results_sub
NULL

#' @title Compact two-sample human PanIN Visium example
#'
#' @description
#' A two-sample spatially covering subset from the public GSE254829 PanIN-LG1
#' and PanIN-LG2 Visium sections. Raw acquisition coordinates and explicit
#' sample_id labels are retained for multi-sample documentation examples.
#'
#' @format A Seurat object with 1000 genes, 440 spots, and two sample labels.
#' @source
...
#'
#' @name visium_human_pancreas_pair_sub
NULL

#' @title Compact PBMC CellTypist example
#'
#' @description
...
#'
#' @format A Seurat object with 12405 RNA genes and 400 cells.
#' @source
...
#'
#' @name pbmc_celltypist_sub
NULL

#' @title Compact Xenium human pancreas cell boundaries
#'
#' @description
...
#'
#' @format A data frame with 3900 polygon vertices for 300 cells.
#' @source
...
#'
#' @name xenium_human_pancreas_boundaries_sub
NULL
