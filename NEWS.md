...
* **refactor**:
  * **IMPORTANT**: Removed `RunMonocle()` function and related documentation (`RunMonocle2.Rd`, `RunMonocle3.Rd`).
...
* **deps**:
  ...
  * Added remote dependencies: `theislab/destiny`, `davidsjoberg/ggsankey`, `mengxu98/thisplot`.
