...
#> ℹ [2026-09-20 23:07:41] Checking a list of <Seurat>...
#> ! [2026-09-20 23:07:41] Data 1/5 of the `srt_list` is "unknown"
#> Warning: Data 1/5 of the `srt_list` is "unknown"
#> ℹ [2026-09-20 23:07:41] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/5 of `srt_list`...
#> ℹ [2026-09-20 23:07:41] Perform `FindVariableFeatures()` on 1/5 of `srt_list`...
#> ! [2026-09-20 23:07:42] Data 2/5 of the `srt_list` is "unknown"
#> Warning: Data 2/5 of the `srt_list` is "unknown"
#> ℹ [2026-09-20 23:07:42] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 2/5 of `srt_list`...
#> ℹ [2026-09-20 23:07:42] Perform `FindVariableFeatures()` on 2/5 of `srt_list`...
#> ! [2026-09-20 23:07:42] Data 3/5 of the `srt_list` is "unknown"
#> Warning: Data 3/5 of the `srt_list` is "unknown"
#> ℹ [2026-09-20 23:07:42] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 3/5 of `srt_list`...
#> ℹ [2026-09-20 23:07:42] Perform `FindVariableFeatures()` on 3/5 of `srt_list`...
#> ! [2026-09-20 23:07:42] Data 4/5 of the `srt_list` is "unknown"
#> Warning: Data 4/5 of the `srt_list` is "unknown"
#> ℹ [2026-09-20 23:07:42] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 4/5 of `srt_list`...
#> ℹ [2026-09-20 23:07:42] Perform `FindVariableFeatures()` on 4/5 of `srt_list`...
#> ! [2026-09-20 23:07:42] Data 5/5 of the `srt_list` is "unknown"
#> Warning: Data 5/5 of the `srt_list` is "unknown"
#> ℹ [2026-09-20 23:07:42] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 5/5 of `srt_list`...
#> ℹ [2026-09-20 23:07:42] Perform `FindVariableFeatures()` on 5/5 of `srt_list`...
#> ℹ [2026-09-20 23:07:42] Use the separate HVF from `srt_list`
#> ℹ [2026-09-20 23:07:43] Number of available HVF: 500
#> ℹ [2026-09-20 23:07:43] Finished check
#> ℹ [2026-09-20 23:07:46] Perform Uncorrected integration
#> Warning: No layers found matching search pattern provided
#> Warning: Layer 'scale.data' is empty
#> ℹ [2026-09-20 23:07:49] Reorder clusters...
#> ℹ [2026-09-20 23:07:49] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-09-20 23:08:00] Checking a list of <Seurat>...
#> ℹ [2026-09-20 23:08:00] Data 1/5 of the `srt_list` has been log-normalized
#> ℹ [2026-09-20 23:08:00] Perform `FindVariableFeatures()` on 1/5 of `srt_list`...
#> ℹ [2026-09-20 23:08:01] Data 2/5 of the `srt_list` has been log-normalized
#> ℹ [2026-09-20 23:08:01] Perform `FindVariableFeatures()` on 2/5 of `srt_list`...
#> ℹ [2026-09-20 23:08:01] Data 3/5 of the `srt_list` has been log-normalized
#> ℹ [2026-09-20 23:08:01] Perform `FindVariableFeatures()` on 3/5 of `srt_list`...
#> ℹ [2026-09-20 23:08:01] Data 4/5 of the `srt_list` has been log-normalized
#> ℹ [2026-09-20 23:08:01] Perform `FindVariableFeatures()` on 4/5 of `srt_list`...
#> ℹ [2026-09-20 23:08:01] Data 5/5 of the `srt_list` has been log-normalized
#> ℹ [2026-09-20 23:08:01] Perform `FindVariableFeatures()` on 5/5 of `srt_list`...
#> ℹ [2026-09-20 23:08:01] Use the separate HVF from `srt_list`
#> ℹ [2026-09-20 23:08:01] Number of available HVF: 500
#> ℹ [2026-09-20 23:08:01] Finished check
#> Warning: No layers found matching search pattern provided
#> Warning: Layer 'scale.data' is empty
#> ℹ [2026-09-20 23:08:02] Perform `Seurat::ScaleData()`
#> ℹ [2026-09-20 23:08:02] Perform linear dimension reduction("pca")
#> ℹ [2026-09-20 23:08:03] Reorder clusters...
#> ℹ [2026-09-20 23:08:03] Skip `log1p()` because `layer = data` is not "counts"
```
...
#> Uncorrected  success  0.6619509  0.7635503  0.5095517  0.06465491  0.9940998  0.5987168     0.9544486         0.9724301                    0.4879958     0.6786843     19.232     Uncorrectedpca  UncorrectedUMAP2D
#> Harmony      success  0.7467326  0.8481556  0.5945980  0.31237004  0.9864901  0.6264387     0.8768259         0.9628357                    0.8281797     0.8149896     13.986     Harmony         HarmonyUMAP2D    
