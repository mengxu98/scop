...
#> ℹ [2026-06-28 05:19:28] Start standard processing workflow...
#> ℹ [2026-06-28 05:19:28] Auto preprocess assays: "RNA" and "peaks"
#> ℹ [2026-06-28 05:19:28] Start standard processing workflow...
#> ℹ [2026-06-28 05:19:28] Checking a list of <Seurat>...
#> ! [2026-06-28 05:19:28] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-28 05:19:28] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 05:19:28] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> Warning: pseudoinverse used at -2.3979
#> Warning: neighborhood radius 0.30103
#> Warning: reciprocal condition number  1.2589e-15
#> ℹ [2026-06-28 05:19:28] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 05:19:28] Number of available HVF: 2000
#> ℹ [2026-06-28 05:19:28] Finished check
#> ℹ [2026-06-28 05:19:28] Perform `ScaleData()`
#> ℹ [2026-06-28 05:19:28] Perform pca linear dimension reduction
#> ℹ [2026-06-28 05:19:29] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 05:19:29] Reorder clusters...
#> ℹ [2026-06-28 05:19:29] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 05:19:29] Perform umap nonlinear dimension reduction
#> ℹ [2026-06-28 05:19:37] Perform umap nonlinear dimension reduction using RNApca (1:10)
#> ✔ [2026-06-28 05:19:43] Standard processing workflow completed
#> ℹ [2026-06-28 05:19:43] Start standard processing workflow...
#> ℹ [2026-06-28 05:19:43] Checking a list of <Seurat>...
#> ! [2026-06-28 05:19:44] Data 1/1 of the `srt_list` is "raw_counts"
#> ℹ [2026-06-28 05:19:44] Perform `RunTFIDF()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 05:19:44] Perform `FindTopFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 05:19:44] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 05:19:44] Number of available HVF: 11413
#> ℹ [2026-06-28 05:19:44] Finished check
#> ℹ [2026-06-28 05:19:44] `normalization_method` is TFIDF. Use lsi workflow
#> ℹ [2026-06-28 05:19:44] Perform svd linear dimension reduction
#> Running SVD
#> Scaling cell embeddings
#> ℹ [2026-06-28 05:19:46] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 05:19:46] Reorder clusters...
#> ℹ [2026-06-28 05:19:46] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 05:19:46] Perform umap nonlinear dimension reduction
#> ℹ [2026-06-28 05:19:53] Perform umap nonlinear dimension reduction using ATACsvd (1:10)
#> ✔ [2026-06-28 05:19:59] Standard processing workflow completed
#> ℹ [2026-06-28 05:19:59] Adjust neighbor k from 20 to 20 for small-sample WNN graph construction
#> ℹ [2026-06-28 05:19:59] Adjust WNN knn.range to 80 for small-sample graph construction
#> ℹ [2026-06-28 05:19:59] Perform WNN integration using RNApca and ATAClsi
...
#> ℹ [2026-06-28 05:20:04] Adjust neighbor k from 20 to 20 for small-sample clustering
#> ℹ [2026-06-28 05:20:04] Perform `Seurat::FindClusters()` with "louvain"
#> ℹ [2026-06-28 05:20:04] Reorder clusters...
#> ℹ [2026-06-28 05:20:04] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 05:20:04] Perform umap nonlinear dimension reduction using WNN
#> ℹ [2026-06-28 05:20:10] Perform umap nonlinear dimension reduction using WNN
