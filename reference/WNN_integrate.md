...
#> ℹ [2026-06-28 08:29:15] Start standard processing workflow...
#> ℹ [2026-06-28 08:29:15] Auto preprocess assays: "RNA" and "peaks"
#> ℹ [2026-06-28 08:29:15] Start standard processing workflow...
#> ℹ [2026-06-28 08:29:15] Checking a list of <Seurat>...
#> ! [2026-06-28 08:29:15] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-28 08:29:15] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 08:29:15] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> Warning: pseudoinverse used at -2.3979
#> Warning: neighborhood radius 0.30103
#> Warning: reciprocal condition number  1.2589e-15
#> ℹ [2026-06-28 08:29:15] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 08:29:15] Number of available HVF: 2000
#> ℹ [2026-06-28 08:29:15] Finished check
#> ℹ [2026-06-28 08:29:15] Perform `ScaleData()`
#> ℹ [2026-06-28 08:29:15] Perform pca linear dimension reduction
#> ℹ [2026-06-28 08:29:16] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 08:29:16] Reorder clusters...
#> ℹ [2026-06-28 08:29:17] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 08:29:17] Perform umap nonlinear dimension reduction
#> ℹ [2026-06-28 08:29:23] Perform umap nonlinear dimension reduction using RNApca (1:10)
#> ✔ [2026-06-28 08:29:28] Standard processing workflow completed
#> ℹ [2026-06-28 08:29:28] Start standard processing workflow...
#> ℹ [2026-06-28 08:29:28] Checking a list of <Seurat>...
#> ! [2026-06-28 08:29:29] Data 1/1 of the `srt_list` is "raw_counts"
#> ℹ [2026-06-28 08:29:29] Perform `RunTFIDF()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 08:29:29] Perform `FindTopFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 08:29:29] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 08:29:29] Number of available HVF: 11413
#> ℹ [2026-06-28 08:29:29] Finished check
#> ℹ [2026-06-28 08:29:29] `normalization_method` is TFIDF. Use lsi workflow
#> ℹ [2026-06-28 08:29:29] Perform svd linear dimension reduction
#> Running SVD
#> Scaling cell embeddings
#> ℹ [2026-06-28 08:29:31] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 08:29:31] Reorder clusters...
#> ℹ [2026-06-28 08:29:31] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 08:29:31] Perform umap nonlinear dimension reduction
#> ℹ [2026-06-28 08:29:37] Perform umap nonlinear dimension reduction using ATACsvd (1:10)
#> ✔ [2026-06-28 08:29:42] Standard processing workflow completed
#> ℹ [2026-06-28 08:29:42] Adjust neighbor k from 20 to 20 for small-sample WNN graph construction
#> ℹ [2026-06-28 08:29:42] Adjust WNN knn.range to 80 for small-sample graph construction
#> ℹ [2026-06-28 08:29:42] Perform WNN integration using RNApca and ATAClsi
...
#> ℹ [2026-06-28 08:29:47] Adjust neighbor k from 20 to 20 for small-sample clustering
#> ℹ [2026-06-28 08:29:47] Perform `Seurat::FindClusters()` with "louvain"
#> ℹ [2026-06-28 08:29:47] Reorder clusters...
#> ℹ [2026-06-28 08:29:47] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 08:29:47] Perform umap nonlinear dimension reduction using WNN
#> ℹ [2026-06-28 08:29:52] Perform umap nonlinear dimension reduction using WNN
