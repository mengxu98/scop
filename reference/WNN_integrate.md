...
#> ℹ [2026-07-02 10:13:02] Start standard processing workflow...
#> ℹ [2026-07-02 10:13:02] Auto preprocess assays: "RNA" and "peaks"
#> ℹ [2026-07-02 10:13:02] Start standard processing workflow...
#> ℹ [2026-07-02 10:13:02] Checking a list of <Seurat>...
#> ! [2026-07-02 10:13:02] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-07-02 10:13:02] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-07-02 10:13:02] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
...
#> Warning: neighborhood radius 0.30103
#> Warning: reciprocal condition number  1.2589e-15
#> ℹ [2026-07-02 10:13:02] Use the separate HVF from `srt_list`
#> ℹ [2026-07-02 10:13:02] Number of available HVF: 2000
#> ℹ [2026-07-02 10:13:02] Finished check
#> ℹ [2026-07-02 10:13:02] Perform `ScaleData()`
#> ℹ [2026-07-02 10:13:03] Perform pca linear dimension reduction
#> ℹ [2026-07-02 10:13:04] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-07-02 10:13:04] Reorder clusters...
#> ℹ [2026-07-02 10:13:04] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-07-02 10:13:04] Perform umap nonlinear dimension reduction
#> ℹ [2026-07-02 10:13:10] Perform umap nonlinear dimension reduction using RNApca (1:10)
#> ✔ [2026-07-02 10:13:15] Standard processing workflow completed
#> ℹ [2026-07-02 10:13:15] Start standard processing workflow...
#> ℹ [2026-07-02 10:13:15] Checking a list of <Seurat>...
#> ! [2026-07-02 10:13:16] Data 1/1 of the `srt_list` is "raw_counts"
#> ℹ [2026-07-02 10:13:16] Perform `RunTFIDF()` on 1/1 of `srt_list`...
#> ℹ [2026-07-02 10:13:16] Perform `FindTopFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-07-02 10:13:16] Use the separate HVF from `srt_list`
#> ℹ [2026-07-02 10:13:16] Number of available HVF: 11413
#> ℹ [2026-07-02 10:13:16] Finished check
#> ℹ [2026-07-02 10:13:16] `normalization_method` is TFIDF. Use lsi workflow
#> ℹ [2026-07-02 10:13:16] Perform svd linear dimension reduction
#> Running SVD
#> Scaling cell embeddings
#> ℹ [2026-07-02 10:13:18] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-07-02 10:13:18] Reorder clusters...
#> ℹ [2026-07-02 10:13:18] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-07-02 10:13:18] Perform umap nonlinear dimension reduction
#> ℹ [2026-07-02 10:13:24] Perform umap nonlinear dimension reduction using ATACsvd (1:10)
#> ✔ [2026-07-02 10:13:29] Standard processing workflow completed
#> ℹ [2026-07-02 10:13:29] Adjust neighbor k from 20 to 20 for small-sample WNN graph construction
#> ℹ [2026-07-02 10:13:29] Adjust WNN knn.range to 80 for small-sample graph construction
#> ℹ [2026-07-02 10:13:29] Perform WNN integration using RNApca and ATAClsi
...
#> ℹ [2026-07-02 10:13:34] Adjust neighbor k from 20 to 20 for small-sample clustering
#> ℹ [2026-07-02 10:13:34] Perform `Seurat::FindClusters()` with "louvain"
#> ℹ [2026-07-02 10:13:34] Reorder clusters...
#> ℹ [2026-07-02 10:13:34] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-07-02 10:13:34] Perform umap nonlinear dimension reduction using WNN
#> ℹ [2026-07-02 10:13:39] Perform umap nonlinear dimension reduction using WNN
