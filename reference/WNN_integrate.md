...
#> ℹ [2026-06-24 04:43:36] Start standard processing workflow...
#> ℹ [2026-06-24 04:43:36] Auto preprocess assays: "RNA" and "peaks"
#> ℹ [2026-06-24 04:43:36] Start standard processing workflow...
#> ℹ [2026-06-24 04:43:36] Checking a list of <Seurat>...
#> ! [2026-06-24 04:43:36] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-24 04:43:36] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-24 04:43:36] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> Warning: pseudoinverse used at -2.3979
#> Warning: neighborhood radius 0.30103
#> Warning: reciprocal condition number  1.2589e-15
#> ℹ [2026-06-24 04:43:37] Use the separate HVF from `srt_list`
#> ℹ [2026-06-24 04:43:37] Number of available HVF: 2000
#> ℹ [2026-06-24 04:43:37] Finished check
#> ℹ [2026-06-24 04:43:37] Perform `ScaleData()`
#> ℹ [2026-06-24 04:43:37] Perform pca linear dimension reduction
#> ℹ [2026-06-24 04:43:38] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-24 04:43:38] Reorder clusters...
#> ℹ [2026-06-24 04:43:38] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-24 04:43:38] Perform umap nonlinear dimension reduction
#> ℹ [2026-06-24 04:43:46] Perform umap nonlinear dimension reduction using RNApca (1:10)
#> ✔ [2026-06-24 04:43:51] Standard processing workflow completed
#> ℹ [2026-06-24 04:43:51] Start standard processing workflow...
#> ℹ [2026-06-24 04:43:51] Checking a list of <Seurat>...
#> ! [2026-06-24 04:43:51] Data 1/1 of the `srt_list` is "raw_counts"
#> ℹ [2026-06-24 04:43:51] Perform `RunTFIDF()` on 1/1 of `srt_list`...
#> ℹ [2026-06-24 04:43:51] Perform `FindTopFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-24 04:43:51] Use the separate HVF from `srt_list`
#> ℹ [2026-06-24 04:43:51] Number of available HVF: 11413
#> ℹ [2026-06-24 04:43:51] Finished check
#> ℹ [2026-06-24 04:43:51] `normalization_method` is TFIDF. Use lsi workflow
#> ℹ [2026-06-24 04:43:51] Perform svd linear dimension reduction
#> Running SVD
#> Scaling cell embeddings
#> ! [2026-06-24 04:43:52] FindNeighbors.Seurat received unsupported arguments for the scop implementation.
#> ! [2026-06-24 04:43:52] Error when performing `Seurat::FindClusters()`. Skip it
#> ℹ [2026-06-24 04:43:52] Perform umap nonlinear dimension reduction
#> ℹ [2026-06-24 04:43:59] Perform umap nonlinear dimension reduction using ATACsvd (1:10)
#> ✔ [2026-06-24 04:44:04] Standard processing workflow completed
#> ℹ [2026-06-24 04:44:04] Adjust neighbor k from 20 to 20 for small-sample WNN graph construction
#> ℹ [2026-06-24 04:44:04] Adjust WNN knn.range to 80 for small-sample graph construction
#> ℹ [2026-06-24 04:44:04] Perform WNN integration using RNApca and ATAClsi
...
#> ℹ [2026-06-24 04:44:09] Adjust neighbor k from 20 to 20 for small-sample clustering
#> ℹ [2026-06-24 04:44:09] Perform `Seurat::FindClusters()` with "louvain"
#> ℹ [2026-06-24 04:44:09] Reorder clusters...
#> ℹ [2026-06-24 04:44:09] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-24 04:44:09] Perform umap nonlinear dimension reduction using WNN
#> ℹ [2026-06-24 04:44:15] Perform umap nonlinear dimension reduction using WNN
