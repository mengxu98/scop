...
#> ℹ [2026-06-28 17:07:18] `NMFHeatmap()` input: 1000 cells x 5 NMF dimensions. Computing a 1000 x 1000 similarity matrix (~0.01 GiB dense numeric matrix).
#> ℹ [2026-06-28 17:07:18] Ordering `NMFHeatmap()` rows and columns ...
#> ℹ [2026-06-28 17:07:19] Building ComplexHeatmap object for `NMFHeatmap()` ...
#> ℹ [2026-06-28 17:07:19] Calculating `NMFHeatmap()` render size ...
#> ℹ [2026-06-28 17:07:19] Fixing `NMFHeatmap()` panel size ...
#> ℹ [2026-06-28 17:07:20] Drawing `NMFHeatmap()`; this can take time for large similarity matrices ...
#> ℹ [2026-06-28 17:07:21] Assembling `NMFHeatmap()` plot object ...
ht_cells$plot
...
#> ℹ [2026-06-28 17:07:22] `NMFHeatmap()` input: 1000 features x 5 NMF dimensions. Computing a 1000 x 1000 similarity matrix (~0.01 GiB dense numeric matrix).
#> ℹ [2026-06-28 17:07:22] Ordering `NMFHeatmap()` rows and columns ...
#> ℹ [2026-06-28 17:07:22] Building ComplexHeatmap object for `NMFHeatmap()` ...
#> ℹ [2026-06-28 17:07:22] Calculating `NMFHeatmap()` render size ...
#> ℹ [2026-06-28 17:07:22] Fixing `NMFHeatmap()` panel size ...
#> ℹ [2026-06-28 17:07:24] Drawing `NMFHeatmap()`; this can take time for large similarity matrices ...
#> ℹ [2026-06-28 17:07:25] Assembling `NMFHeatmap()` plot object ...
ht_features$plot
```
