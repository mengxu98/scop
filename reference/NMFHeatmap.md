...
#> ℹ [2026-06-27 19:49:07] `NMFHeatmap()` input: 1000 cells x 5 NMF dimensions. Computing a 1000 x 1000 similarity matrix (~0.01 GiB dense numeric matrix).
#> ℹ [2026-06-27 19:49:07] Ordering `NMFHeatmap()` rows and columns ...
#> ℹ [2026-06-27 19:49:07] Building ComplexHeatmap object for `NMFHeatmap()` ...
#> ℹ [2026-06-27 19:49:07] Calculating `NMFHeatmap()` render size ...
#> ℹ [2026-06-27 19:49:07] Fixing `NMFHeatmap()` panel size ...
#> ℹ [2026-06-27 19:49:09] Drawing `NMFHeatmap()`; this can take time for large similarity matrices ...
#> ℹ [2026-06-27 19:49:10] Assembling `NMFHeatmap()` plot object ...
ht_cells$plot
...
#> ℹ [2026-06-27 19:49:11] `NMFHeatmap()` input: 1000 features x 5 NMF dimensions. Computing a 1000 x 1000 similarity matrix (~0.01 GiB dense numeric matrix).
#> ℹ [2026-06-27 19:49:11] Ordering `NMFHeatmap()` rows and columns ...
#> ℹ [2026-06-27 19:49:11] Building ComplexHeatmap object for `NMFHeatmap()` ...
#> ℹ [2026-06-27 19:49:11] Calculating `NMFHeatmap()` render size ...
#> ℹ [2026-06-27 19:49:11] Fixing `NMFHeatmap()` panel size ...
#> ℹ [2026-06-27 19:49:13] Drawing `NMFHeatmap()`; this can take time for large similarity matrices ...
#> ℹ [2026-06-27 19:49:14] Assembling `NMFHeatmap()` plot object ...
ht_features$plot
```
