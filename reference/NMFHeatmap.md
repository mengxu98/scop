...
#> ℹ [2026-06-24 03:52:26] `NMFHeatmap()` input: 1000 cells x 5 NMF dimensions. Computing a 1000 x 1000 similarity matrix (~0.01 GiB dense numeric matrix).
#> ℹ [2026-06-24 03:52:26] Ordering `NMFHeatmap()` rows and columns ...
#> ℹ [2026-06-24 03:52:26] Building ComplexHeatmap object for `NMFHeatmap()` ...
#> ℹ [2026-06-24 03:52:26] Calculating `NMFHeatmap()` render size ...
#> ℹ [2026-06-24 03:52:26] Fixing `NMFHeatmap()` panel size ...

#> ℹ [2026-06-24 03:52:28] Drawing `NMFHeatmap()`; this can take time for large similarity matrices ...
#> ℹ [2026-06-24 03:52:29] Assembling `NMFHeatmap()` plot object ...
ht_cells$plot
...
#> ℹ [2026-06-24 03:52:29] `NMFHeatmap()` input: 1000 features x 5 NMF dimensions. Computing a 1000 x 1000 similarity matrix (~0.01 GiB dense numeric matrix).
#> ℹ [2026-06-24 03:52:30] Ordering `NMFHeatmap()` rows and columns ...
#> ℹ [2026-06-24 03:52:30] Building ComplexHeatmap object for `NMFHeatmap()` ...
#> ℹ [2026-06-24 03:52:30] Calculating `NMFHeatmap()` render size ...
#> ℹ [2026-06-24 03:52:30] Fixing `NMFHeatmap()` panel size ...

#> ℹ [2026-06-24 03:52:31] Drawing `NMFHeatmap()`; this can take time for large similarity matrices ...
#> ℹ [2026-06-24 03:52:32] Assembling `NMFHeatmap()` plot object ...
ht_features$plot
```
