...
#> ℹ [2026-06-28 10:00:36] `NMFHeatmap()` input: 1000 cells x 5 NMF dimensions. Computing a 1000 x 1000 similarity matrix (~0.01 GiB dense numeric matrix).
#> ℹ [2026-06-28 10:00:36] Ordering `NMFHeatmap()` rows and columns ...
#> ℹ [2026-06-28 10:00:36] Building ComplexHeatmap object for `NMFHeatmap()` ...
#> ℹ [2026-06-28 10:00:36] Calculating `NMFHeatmap()` render size ...
#> ℹ [2026-06-28 10:00:36] Fixing `NMFHeatmap()` panel size ...
#> ℹ [2026-06-28 10:00:37] Drawing `NMFHeatmap()`; this can take time for large similarity matrices ...
#> ℹ [2026-06-28 10:00:39] Assembling `NMFHeatmap()` plot object ...
ht_cells$plot
...
#> ℹ [2026-06-28 10:00:39] `NMFHeatmap()` input: 1000 features x 5 NMF dimensions. Computing a 1000 x 1000 similarity matrix (~0.01 GiB dense numeric matrix).
#> ℹ [2026-06-28 10:00:39] Ordering `NMFHeatmap()` rows and columns ...
#> ℹ [2026-06-28 10:00:39] Building ComplexHeatmap object for `NMFHeatmap()` ...
#> ℹ [2026-06-28 10:00:39] Calculating `NMFHeatmap()` render size ...
#> ℹ [2026-06-28 10:00:39] Fixing `NMFHeatmap()` panel size ...
#> ℹ [2026-06-28 10:00:41] Drawing `NMFHeatmap()`; this can take time for large similarity matrices ...
#> ℹ [2026-06-28 10:00:42] Assembling `NMFHeatmap()` plot object ...
ht_features$plot
```
