...
#> ℹ [2026-06-28 07:46:23] `NMFHeatmap()` input: 1000 cells x 5 NMF dimensions. Computing a 1000 x 1000 similarity matrix (~0.01 GiB dense numeric matrix).
#> ℹ [2026-06-28 07:46:23] Ordering `NMFHeatmap()` rows and columns ...
#> ℹ [2026-06-28 07:46:23] Building ComplexHeatmap object for `NMFHeatmap()` ...
#> ℹ [2026-06-28 07:46:23] Calculating `NMFHeatmap()` render size ...
#> ℹ [2026-06-28 07:46:23] Fixing `NMFHeatmap()` panel size ...
#> ℹ [2026-06-28 07:46:25] Drawing `NMFHeatmap()`; this can take time for large similarity matrices ...
#> ℹ [2026-06-28 07:46:26] Assembling `NMFHeatmap()` plot object ...
ht_cells$plot
...
#> ℹ [2026-06-28 07:46:27] `NMFHeatmap()` input: 1000 features x 5 NMF dimensions. Computing a 1000 x 1000 similarity matrix (~0.01 GiB dense numeric matrix).
#> ℹ [2026-06-28 07:46:27] Ordering `NMFHeatmap()` rows and columns ...
#> ℹ [2026-06-28 07:46:27] Building ComplexHeatmap object for `NMFHeatmap()` ...
#> ℹ [2026-06-28 07:46:27] Calculating `NMFHeatmap()` render size ...
#> ℹ [2026-06-28 07:46:27] Fixing `NMFHeatmap()` panel size ...
#> ℹ [2026-06-28 07:46:29] Drawing `NMFHeatmap()`; this can take time for large similarity matrices ...
#> ℹ [2026-06-28 07:46:30] Assembling `NMFHeatmap()` plot object ...
ht_features$plot
```
