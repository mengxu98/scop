...
#> ℹ [2026-06-24 18:31:01] `NMFHeatmap()` input: 1000 cells x 5 NMF dimensions. Computing a 1000 x 1000 similarity matrix (~0.01 GiB dense numeric matrix).
#> ℹ [2026-06-24 18:31:01] Ordering `NMFHeatmap()` rows and columns ...
#> ℹ [2026-06-24 18:31:01] Building ComplexHeatmap object for `NMFHeatmap()` ...
#> ℹ [2026-06-24 18:31:01] Calculating `NMFHeatmap()` render size ...
#> ℹ [2026-06-24 18:31:01] Fixing `NMFHeatmap()` panel size ...

#> ℹ [2026-06-24 18:31:02] Drawing `NMFHeatmap()`; this can take time for large similarity matrices ...
#> ℹ [2026-06-24 18:31:03] Assembling `NMFHeatmap()` plot object ...
ht_cells$plot
...
#> ℹ [2026-06-24 18:31:04] `NMFHeatmap()` input: 1000 features x 5 NMF dimensions. Computing a 1000 x 1000 similarity matrix (~0.01 GiB dense numeric matrix).
#> ℹ [2026-06-24 18:31:04] Ordering `NMFHeatmap()` rows and columns ...
#> ℹ [2026-06-24 18:31:04] Building ComplexHeatmap object for `NMFHeatmap()` ...
#> ℹ [2026-06-24 18:31:04] Calculating `NMFHeatmap()` render size ...
#> ℹ [2026-06-24 18:31:04] Fixing `NMFHeatmap()` panel size ...

#> ℹ [2026-06-24 18:31:05] Drawing `NMFHeatmap()`; this can take time for large similarity matrices ...
#> ℹ [2026-06-24 18:31:06] Assembling `NMFHeatmap()` plot object ...
ht_features$plot
```
