...
#> ℹ [2026-06-28 14:47:05] Start standard processing workflow...
#> ℹ [2026-06-28 14:47:06] Checking a list of <Seurat>...
#> ! [2026-06-28 14:47:06] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-28 14:47:06] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 14:47:06] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 14:47:06] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 14:47:06] Number of available HVF: 2000
#> ℹ [2026-06-28 14:47:06] Finished check
#> ℹ [2026-06-28 14:47:06] Perform `ScaleData()`
#> ℹ [2026-06-28 14:47:06] Perform pca linear dimension reduction
#> ℹ [2026-06-28 14:47:07] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-28 14:47:07] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 14:47:07] Reorder clusters...
#> ℹ [2026-06-28 14:47:08] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 14:47:08] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-28 14:47:15] Standard processing workflow completed
...
#> ℹ [2026-06-28 14:47:15] Running PAGA with BiocNeighbors using 29 neighbors
#> ✔ [2026-06-28 14:47:15] PAGA cpp backend completed
