...
#> ℹ [2026-01-27 08:35:03] Start standard scop workflow...
#> ℹ [2026-01-27 08:35:04] Checking a list of <Seurat>...
#> ! [2026-01-27 08:35:04] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-01-27 08:35:04] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-27 08:35:06] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-27 08:35:06] Use the separate HVF from srt_list
#> ℹ [2026-01-27 08:35:07] Number of available HVF: 2000
#> ℹ [2026-01-27 08:35:07] Finished check
#> ℹ [2026-01-27 08:35:07] Perform `Seurat::ScaleData()`
#> ℹ [2026-01-27 08:35:07] Perform pca linear dimension reduction
#> ℹ [2026-01-27 08:35:08] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-01-27 08:35:08] Reorder clusters...
#> ℹ [2026-01-27 08:35:08] Perform umap nonlinear dimension reduction
#> ℹ [2026-01-27 08:35:08] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2026-01-27 08:35:13] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ✔ [2026-01-27 08:35:17] Run scop standard workflow completed
