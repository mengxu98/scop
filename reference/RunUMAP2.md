...
#> ℹ [2026-07-02 10:10:24] Start standard processing workflow...
#> ℹ [2026-07-02 10:10:24] Checking a list of <Seurat>...
#> ! [2026-07-02 10:10:24] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-07-02 10:10:24] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-07-02 10:10:25] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-07-02 10:10:25] Use the separate HVF from `srt_list`
#> ℹ [2026-07-02 10:10:25] Number of available HVF: 2000
#> ℹ [2026-07-02 10:10:25] Finished check
#> ℹ [2026-07-02 10:10:25] Perform `ScaleData()`
#> ℹ [2026-07-02 10:10:25] Perform pca linear dimension reduction
#> ℹ [2026-07-02 10:10:26] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-07-02 10:10:26] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-07-02 10:10:26] Reorder clusters...
#> ℹ [2026-07-02 10:10:26] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-07-02 10:10:26] Perform umap nonlinear dimension reduction
#> ✔ [2026-07-02 10:10:33] Standard processing workflow completed
