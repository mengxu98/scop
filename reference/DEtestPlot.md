...
#> ℹ [2026-03-08 07:03:50] Start standard scop workflow...
#> ℹ [2026-03-08 07:03:50] Checking a list of <Seurat>...
#> ! [2026-03-08 07:03:50] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-03-08 07:03:50] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-03-08 07:03:52] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-03-08 07:03:53] Use the separate HVF from `srt_list`
#> ℹ [2026-03-08 07:03:53] Number of available HVF: 2000
#> ℹ [2026-03-08 07:03:53] Finished check
#> ℹ [2026-03-08 07:03:53] Perform `Seurat::ScaleData()`
#> ℹ [2026-03-08 07:03:53] Perform pca linear dimension reduction
#> ℹ [2026-03-08 07:03:54] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-03-08 07:03:54] Reorder clusters...
#> ℹ [2026-03-08 07:03:54] Perform umap nonlinear dimension reduction
#> ℹ [2026-03-08 07:03:54] Perform umap nonlinear dimension reduction using Standardpca (1:50)
#> ℹ [2026-03-08 07:03:57] Perform umap nonlinear dimension reduction using Standardpca (1:50)
#> ✔ [2026-03-08 07:04:01] Run scop standard workflow completed
pancreas_sub <- RunDEtest(
  pancreas_sub,
  group.by = "CellType",
  only.pos = FALSE
)
#> ℹ [2026-03-08 07:04:01] Data type is log-normalized
#> ℹ [2026-03-08 07:04:01] Start differential expression test
#> ℹ [2026-03-08 07:04:01] Find all markers(wilcox) among [1] 5 groups...
#> ℹ [2026-03-08 07:04:01] Using 1 core
#> ⠙ [2026-03-08 07:04:01] Running for Ductal [1/5] ■■■■■■■                       …
#> ✔ [2026-03-08 07:04:01] Completed 5 tasks in 885ms
#> 
#> ℹ [2026-03-08 07:04:01] Building results
#> ✔ [2026-03-08 07:04:02] Differential expression test completed
