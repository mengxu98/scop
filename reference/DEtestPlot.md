...
#> ℹ [2026-03-09 07:36:30] Start standard scop workflow...
#> ℹ [2026-03-09 07:36:30] Checking a list of <Seurat>...
#> ! [2026-03-09 07:36:30] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-03-09 07:36:30] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-03-09 07:36:32] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-03-09 07:36:32] Use the separate HVF from `srt_list`
#> ℹ [2026-03-09 07:36:33] Number of available HVF: 2000
#> ℹ [2026-03-09 07:36:33] Finished check
#> ℹ [2026-03-09 07:36:33] Perform `Seurat::ScaleData()`
#> ℹ [2026-03-09 07:36:33] Perform pca linear dimension reduction
#> ℹ [2026-03-09 07:36:34] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-03-09 07:36:34] Reorder clusters...
#> ℹ [2026-03-09 07:36:34] Perform umap nonlinear dimension reduction
#> ℹ [2026-03-09 07:36:34] Perform umap nonlinear dimension reduction using Standardpca (1:50)
#> ℹ [2026-03-09 07:36:37] Perform umap nonlinear dimension reduction using Standardpca (1:50)
#> ✔ [2026-03-09 07:36:40] Run scop standard workflow completed
pancreas_sub <- RunDEtest(
  pancreas_sub,
  group.by = "CellType",
  only.pos = FALSE
)
#> ℹ [2026-03-09 07:36:41] Data type is log-normalized
#> ℹ [2026-03-09 07:36:41] Start differential expression test
#> ℹ [2026-03-09 07:36:41] Find all markers(wilcox) among [1] 5 groups...
#> ℹ [2026-03-09 07:36:41] Using 1 core
#> ⠙ [2026-03-09 07:36:41] Running for Ductal [1/5] ■■■■■■■                       …
#> ✔ [2026-03-09 07:36:41] Completed 5 tasks in 926ms
#> 
#> ℹ [2026-03-09 07:36:41] Building results
#> ✔ [2026-03-09 07:36:42] Differential expression test completed
