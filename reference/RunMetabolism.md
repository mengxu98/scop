...
#> ℹ [2026-05-22 17:41:42] Start standard processing workflow...
#> ℹ [2026-05-22 17:41:42] Checking a list of <Seurat>...
#> ! [2026-05-22 17:41:42] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-22 17:41:42] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-22 17:41:44] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-22 17:41:45] Use the separate HVF from `srt_list`
#> ℹ [2026-05-22 17:41:45] Number of available HVF: 2000
#> ℹ [2026-05-22 17:41:45] Finished check
#> ℹ [2026-05-22 17:41:45] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-22 17:41:45] Perform pca linear dimension reduction
#> ℹ [2026-05-22 17:41:46] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-05-22 17:41:46] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-22 17:41:46] Reorder clusters...
#> ℹ [2026-05-22 17:41:46] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-22 17:41:46] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-22 17:41:46] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ℹ [2026-05-22 17:41:52] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ✔ [2026-05-22 17:41:57] Standard processing workflow completed
...
#> ℹ [2026-05-22 17:41:57] Start metabolism pathway scoring
#> ℹ [2026-05-22 17:41:57] Data type is raw counts
#> ℹ [2026-05-22 17:41:57] Averaging expression by "CellType" ...
#> ℹ [2026-05-22 17:41:57] Aggregated expression: 15998 genes x 5 groups
#> ℹ [2026-05-22 17:41:57] Using raw scMetabolism gene sets directly; `PrepareDB()` / BioMart-based ID rebuilding is skipped
#> ℹ [2026-05-22 17:41:57] Total metabolism gene sets to score: 127
#> ✔ [2026-05-22 17:41:57] Metabolism scores stored in tools slot "Metabolism_CellType_AUCell"
ht <- MetabolismPlot(
  pancreas_sub,
  group.by = "CellType",
  plot_type = "heatmap",
