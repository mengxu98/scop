...
#> ℹ [2026-06-28 21:12:19] Start standard processing workflow...
#> ℹ [2026-06-28 21:12:20] Checking a list of <Seurat>...
#> ! [2026-06-28 21:12:20] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-28 21:12:20] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 21:12:20] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 21:12:20] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 21:12:20] Number of available HVF: 2000
#> ℹ [2026-06-28 21:12:20] Finished check
#> ℹ [2026-06-28 21:12:20] Perform `ScaleData()`
#> ℹ [2026-06-28 21:12:20] Perform pca linear dimension reduction
#> ℹ [2026-06-28 21:12:21] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-28 21:12:21] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 21:12:21] Reorder clusters...
#> ℹ [2026-06-28 21:12:21] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 21:12:22] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-28 21:12:29] Standard processing workflow completed
...
#> ℹ [2026-06-28 21:12:29] Start metabolism pathway scoring
#> ℹ [2026-06-28 21:12:29] Data type is raw counts
#> ℹ [2026-06-28 21:12:29] Averaging expression by "CellType" ...
#> ℹ [2026-06-28 21:12:29] Aggregated expression: 15998 genes x 5 groups
#> ℹ [2026-06-28 21:12:29] Using `PrepareDB()` for species-aware gene set construction
#> ℹ [2026-06-28 21:12:29]   KEGG pathway refs: 85, Reactome pathway names: 82
#> ℹ [2026-06-28 21:12:29] Species: "Mus_musculus"
#> ℹ [2026-06-28 21:12:29] Preparing KEGG database
#> ℹ [2026-06-28 21:12:31] <simpleError in utils::download.file(url = url, destfile = destfile, method = method,     quiet = quiet, ...): cannot open URL 'https://rest.kegg.jp/list/organism'>
#> ! [2026-06-28 21:12:31] Failed to download using auto, from <https://rest.kegg.jp/list/organism>
#> ℹ [2026-06-28 21:12:33] <simpleError in utils::download.file(url = url, destfile = destfile, method = method,     quiet = quiet, ...): 'wget' call had nonzero exit status>
#> ! [2026-06-28 21:12:33] Failed to download using wget, from <https://rest.kegg.jp/list/organism>
#> ℹ [2026-06-28 21:12:35] <simpleError in utils::download.file(url = url, destfile = destfile, method = method,     quiet = quiet, ...): cannot open URL 'https://rest.kegg.jp/list/organism'>
#> ! [2026-06-28 21:12:35] Failed to download using libcurl, from <https://rest.kegg.jp/list/organism>
