...
#> ℹ [2026-06-28 10:33:27] Start standard processing workflow...
#> ℹ [2026-06-28 10:33:28] Checking a list of <Seurat>...
#> ! [2026-06-28 10:33:28] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-28 10:33:28] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 10:33:28] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 10:33:28] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 10:33:28] Number of available HVF: 2000
#> ℹ [2026-06-28 10:33:28] Finished check
#> ℹ [2026-06-28 10:33:28] Perform `ScaleData()`
#> ℹ [2026-06-28 10:33:28] Perform pca linear dimension reduction
#> ℹ [2026-06-28 10:33:29] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-28 10:33:29] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 10:33:29] Reorder clusters...
#> ℹ [2026-06-28 10:33:29] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 10:33:29] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-28 10:33:36] Standard processing workflow completed
...
#> ℹ [2026-06-28 10:33:36] Start metabolism pathway scoring
#> ℹ [2026-06-28 10:33:37] Data type is raw counts
#> ℹ [2026-06-28 10:33:37] Averaging expression by "CellType" ...
#> ℹ [2026-06-28 10:33:37] Aggregated expression: 15998 genes x 5 groups
#> ℹ [2026-06-28 10:33:37] Using `PrepareDB()` for species-aware gene set construction
#> ℹ [2026-06-28 10:33:37]   KEGG pathway refs: 85, Reactome pathway names: 82
#> ℹ [2026-06-28 10:33:37] Species: "Mus_musculus"
#> ℹ [2026-06-28 10:33:37] Preparing KEGG database
#> ℹ [2026-06-28 10:33:39] <simpleError in utils::download.file(url = url, destfile = destfile, method = method,     quiet = quiet, ...): cannot open URL 'https://rest.kegg.jp/list/organism'>
#> ! [2026-06-28 10:33:39] Failed to download using auto, from <https://rest.kegg.jp/list/organism>
#> ℹ [2026-06-28 10:33:41] <simpleError in utils::download.file(url = url, destfile = destfile, method = method,     quiet = quiet, ...): 'wget' call had nonzero exit status>
#> ! [2026-06-28 10:33:41] Failed to download using wget, from <https://rest.kegg.jp/list/organism>
#> ℹ [2026-06-28 10:33:44] <simpleError in utils::download.file(url = url, destfile = destfile, method = method,     quiet = quiet, ...): cannot open URL 'https://rest.kegg.jp/list/organism'>
#> ! [2026-06-28 10:33:44] Failed to download using libcurl, from <https://rest.kegg.jp/list/organism>
