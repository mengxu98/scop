...
#> ℹ [2026-05-12 15:52:26] Start standard processing workflow...
#> ℹ [2026-05-12 15:52:27] Checking a list of <Seurat>...
#> ! [2026-05-12 15:52:27] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-12 15:52:27] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-12 15:52:29] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-12 15:52:29] Use the separate HVF from `srt_list`
#> ℹ [2026-05-12 15:52:30] Number of available HVF: 2000
#> ℹ [2026-05-12 15:52:30] Finished check
#> ℹ [2026-05-12 15:52:30] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-12 15:52:30] Perform pca linear dimension reduction
#> ℹ [2026-05-12 15:52:30] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-12 15:52:31] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-12 15:52:31] Reorder clusters...
#> ℹ [2026-05-12 15:52:31] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-12 15:52:31] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-12 15:52:31] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-12 15:52:37] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-12 15:52:43] Standard processing workflow completed
...
#> ℹ [2026-05-12 15:52:43] Start metabolism pathway scoring
#> ℹ [2026-05-12 15:52:44] Data type is raw counts
#> ℹ [2026-05-12 15:52:44] Averaging expression by "CellType" ...
#> ℹ [2026-05-12 15:52:44] Aggregated expression: 15998 genes x 5 groups
#> ℹ [2026-05-12 15:52:44] Using raw scMetabolism gene sets directly; `PrepareDB()` / BioMart-based ID rebuilding is skipped
#> ℹ [2026-05-12 15:52:44] Total metabolism gene sets to score: 127
#> ✔ [2026-05-12 15:52:44] Metabolism scores stored in tools slot "Metabolism_CellType_AUCell"
ht <- MetabolismPlot(
  pancreas_sub,
  group.by = "CellType",
  plot_type = "heatmap",
