...
#> ℹ [2026-09-13 22:40:46] Start standard processing workflow...
#> ℹ [2026-09-13 22:40:46] Checking a list of <Seurat>...
#> ! [2026-09-13 22:40:47] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-09-13 22:40:47] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-09-13 22:40:47] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-09-13 22:40:47] Use the separate HVF from `srt_list`
#> ℹ [2026-09-13 22:40:47] Number of available HVF: 2000
#> ℹ [2026-09-13 22:40:47] Finished check
#> ℹ [2026-09-13 22:40:47] Perform `ScaleData()`
#> ℹ [2026-09-13 22:40:47] Perform pca linear dimension reduction
#> ℹ [2026-09-13 22:40:47] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-09-13 22:40:48] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-09-13 22:40:48] Reorder clusters...
#> ℹ [2026-09-13 22:40:48] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-09-13 22:40:48] Perform umap nonlinear dimension reduction
#> ✔ [2026-09-13 22:40:55] Standard processing workflow completed
pancreas_sub <- RunNMF(pancreas_sub)
#> ℹ [2026-09-13 22:40:55] Running NMF...
#> ℹ BE_ 1 
...
#> ✔ [2026-09-13 22:41:05] NMF compute completed
CellDimPlot(
  pancreas_sub,
  group.by = "CellType",
  reduction = "nmf"
...
#> ℹ [2026-09-13 22:41:06] `NMFHeatmap()` input: 1000 cells x 50 NMF dimensions. Computing a 1000 x 1000 similarity matrix (~0.01 GiB dense numeric matrix).
#> ℹ [2026-09-13 22:41:06] Ordering `NMFHeatmap()` rows and columns ...
#> ℹ [2026-09-13 22:41:06] Building ComplexHeatmap object for `NMFHeatmap()` ...
#> ℹ [2026-09-13 22:41:06] Calculating `NMFHeatmap()` render size ...
#> ℹ [2026-09-13 22:41:06] Drawing `NMFHeatmap()`; this can take time for large similarity matrices ...
#> ℹ [2026-09-13 22:41:07] Assembling `NMFHeatmap()` plot object ...
ht_cells$plot
...
#> ℹ [2026-09-13 22:41:08] `NMFHeatmap()` input: 2000 features x 50 NMF dimensions. Computing a 2000 x 2000 similarity matrix (~0.03 GiB dense numeric matrix).
#> ℹ [2026-09-13 22:41:08] Ordering `NMFHeatmap()` rows and columns ...
#> ℹ [2026-09-13 22:41:08] Building ComplexHeatmap object for `NMFHeatmap()` ...
#> ℹ [2026-09-13 22:41:08] Calculating `NMFHeatmap()` render size ...
#> ℹ [2026-09-13 22:41:08] Drawing `NMFHeatmap()`; this can take time for large similarity matrices ...
#> ℹ [2026-09-13 22:41:14] Assembling `NMFHeatmap()` plot object ...
ht_features$plot
```
