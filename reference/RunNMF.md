...
#> ℹ [2026-09-20 22:39:45] Start standard processing workflow...
#> ℹ [2026-09-20 22:39:45] Checking a list of <Seurat>...
#> ! [2026-09-20 22:39:45] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-09-20 22:39:45] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-09-20 22:39:45] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-09-20 22:39:45] Use the separate HVF from `srt_list`
#> ℹ [2026-09-20 22:39:45] Number of available HVF: 2000
#> ℹ [2026-09-20 22:39:45] Finished check
#> ℹ [2026-09-20 22:39:45] Perform `ScaleData()`
#> ℹ [2026-09-20 22:39:45] Perform pca linear dimension reduction
#> ℹ [2026-09-20 22:39:45] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-09-20 22:39:46] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-09-20 22:39:46] Reorder clusters...
#> ℹ [2026-09-20 22:39:46] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-09-20 22:39:46] Perform umap nonlinear dimension reduction
#> ✔ [2026-09-20 22:39:53] Standard processing workflow completed
pancreas_sub <- RunNMF(pancreas_sub)
#> ℹ [2026-09-20 22:39:53] Running NMF...
#> ℹ BE_ 1 
...
#> ✔ [2026-09-20 22:40:03] NMF compute completed
CellDimPlot(
  pancreas_sub,
  group.by = "CellType",
  reduction = "nmf"
...
#> ℹ [2026-09-20 22:40:04] `NMFHeatmap()` input: 1000 cells x 50 NMF dimensions. Computing a 1000 x 1000 similarity matrix (~0.01 GiB dense numeric matrix).
#> ℹ [2026-09-20 22:40:04] Ordering `NMFHeatmap()` rows and columns ...
#> ℹ [2026-09-20 22:40:04] Building ComplexHeatmap object for `NMFHeatmap()` ...
#> ℹ [2026-09-20 22:40:04] Calculating `NMFHeatmap()` render size ...
#> ℹ [2026-09-20 22:40:04] Drawing `NMFHeatmap()`; this can take time for large similarity matrices ...
#> ℹ [2026-09-20 22:40:05] Assembling `NMFHeatmap()` plot object ...
ht_cells$plot
...
#> ℹ [2026-09-20 22:40:06] `NMFHeatmap()` input: 2000 features x 50 NMF dimensions. Computing a 2000 x 2000 similarity matrix (~0.03 GiB dense numeric matrix).
#> ℹ [2026-09-20 22:40:06] Ordering `NMFHeatmap()` rows and columns ...
#> ℹ [2026-09-20 22:40:06] Building ComplexHeatmap object for `NMFHeatmap()` ...
#> ℹ [2026-09-20 22:40:06] Calculating `NMFHeatmap()` render size ...
#> ℹ [2026-09-20 22:40:06] Drawing `NMFHeatmap()`; this can take time for large similarity matrices ...
#> ℹ [2026-09-20 22:40:12] Assembling `NMFHeatmap()` plot object ...
ht_features$plot
```
