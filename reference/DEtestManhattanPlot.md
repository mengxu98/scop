...
#> ℹ [2026-04-03 08:58:34] Start standard processing workflow...
#> ℹ [2026-04-03 08:58:35] Checking a list of <Seurat>...
#> ! [2026-04-03 08:58:35] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-04-03 08:58:35] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 08:58:37] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 08:58:37] Use the separate HVF from `srt_list`
#> ℹ [2026-04-03 08:58:37] Number of available HVF: 2000
#> ℹ [2026-04-03 08:58:37] Finished check
#> ℹ [2026-04-03 08:58:38] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-03 08:58:38] Perform pca linear dimension reduction
#> ℹ [2026-04-03 08:58:38] Use stored estimated dimensions 1:12 for Standardpca
#> ℹ [2026-04-03 08:58:39] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-03 08:58:39] Reorder clusters...
#> ℹ [2026-04-03 08:58:39] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-03 08:58:39] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-03 08:58:39] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ℹ [2026-04-03 08:58:42] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ✔ [2026-04-03 08:58:46] Standard processing workflow completed
pancreas_sub <- RunDEtest(
  pancreas_sub,
  group.by = "CellType",
  only.pos = FALSE
)
#> ℹ [2026-04-03 08:58:46] Data type is log-normalized
#> ℹ [2026-04-03 08:58:46] Start differential expression test
#> ℹ [2026-04-03 08:58:46] Find all markers(wilcox) among [1] 5 groups...
#> ℹ [2026-04-03 08:58:46] Using 1 core
#> ⠙ [2026-04-03 08:58:46] Running for Ductal [1/5] ■■          20% | ETA:  1s
#> ✔ [2026-04-03 08:58:46] Completed 5 tasks in 1.1s
#> 
#> ℹ [2026-04-03 08:58:46] Building results
#> ✔ [2026-04-03 08:58:47] Differential expression test completed
DEtestManhattanPlot(
  pancreas_sub,
  group.by = "CellType"
)
