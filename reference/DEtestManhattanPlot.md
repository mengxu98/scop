...
#> ℹ [2026-07-02 08:34:50] Start standard processing workflow...
#> ℹ [2026-07-02 08:34:50] Checking a list of <Seurat>...
#> ! [2026-07-02 08:34:51] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-07-02 08:34:51] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-07-02 08:34:51] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-07-02 08:34:51] Use the separate HVF from `srt_list`
#> ℹ [2026-07-02 08:34:51] Number of available HVF: 2000
#> ℹ [2026-07-02 08:34:51] Finished check
#> ℹ [2026-07-02 08:34:51] Perform `ScaleData()`
#> ℹ [2026-07-02 08:34:51] Perform pca linear dimension reduction
#> ℹ [2026-07-02 08:34:52] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-07-02 08:34:52] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-07-02 08:34:52] Reorder clusters...
#> ℹ [2026-07-02 08:34:52] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-07-02 08:34:52] Perform umap nonlinear dimension reduction
#> ✔ [2026-07-02 08:34:57] Standard processing workflow completed
pancreas_sub <- RunDEtest(
  pancreas_sub,
  group.by = "CellType",
  only.pos = FALSE
)
#> ℹ [2026-07-02 08:34:57] Data type is log-normalized
#> ℹ [2026-07-02 08:34:57] Start differential expression test
#> ℹ [2026-07-02 08:34:57] Find all markers(wilcox) among [1] 5 groups...
#> ℹ [2026-07-02 08:34:57] Using 1 core
#> ⠙ [2026-07-02 08:34:57] Running for Ductal [1/5] ■■          20% | ETA:  0s
#> ✔ [2026-07-02 08:34:57] Completed 5 tasks in 512ms
#> 
#> ℹ [2026-07-02 08:34:57] Building results
#> ✔ [2026-07-02 08:34:58] Differential expression test completed
DEtestManhattanPlot(
  pancreas_sub,
  group.by = "CellType"
)
