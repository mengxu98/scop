...
#> ℹ [2026-04-03 03:20:48] Start standard processing workflow...
#> ℹ [2026-04-03 03:20:48] Checking a list of <Seurat>...
#> ! [2026-04-03 03:20:48] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-04-03 03:20:48] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 03:20:50] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 03:20:51] Use the separate HVF from `srt_list`
#> ℹ [2026-04-03 03:20:51] Number of available HVF: 2000
#> ℹ [2026-04-03 03:20:51] Finished check
#> ℹ [2026-04-03 03:20:51] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-03 03:20:52] Perform pca linear dimension reduction
#> ℹ [2026-04-03 03:20:52] Use stored estimated dimensions 1:12 for Standardpca
#> ℹ [2026-04-03 03:20:52] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-03 03:20:52] Reorder clusters...
#> ℹ [2026-04-03 03:20:53] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-03 03:20:53] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-03 03:20:53] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ℹ [2026-04-03 03:20:56] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ✔ [2026-04-03 03:20:59] Standard processing workflow completed
pancreas_sub <- RunDEtest(
  pancreas_sub,
  group.by = "CellType",
  only.pos = FALSE
)
#> ℹ [2026-04-03 03:21:00] Data type is log-normalized
#> ℹ [2026-04-03 03:21:00] Start differential expression test
#> ℹ [2026-04-03 03:21:00] Find all markers(wilcox) among [1] 5 groups...
#> ℹ [2026-04-03 03:21:00] Using 1 core
#> ⠙ [2026-04-03 03:21:00] Running for Ductal [1/5] ■■■■■■■                       …
#> ✔ [2026-04-03 03:21:00] Completed 5 tasks in 1.1s
#> 
#> ℹ [2026-04-03 03:21:00] Building results
#> ✔ [2026-04-03 03:21:01] Differential expression test completed
DEtestManhattanPlot(
  pancreas_sub,
  group.by = "CellType"
)
