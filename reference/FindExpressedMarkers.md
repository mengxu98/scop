...
- ident.1:
  ...
  [`BuildClusterTree`](https://rdrr.io/pkg/Seurat/man/BuildClusterTree.html)
  to have been run
...
#> ℹ [2026-01-29 13:01:16] Start standard scop workflow...
#> ℹ [2026-01-29 13:01:17] Checking a list of <Seurat>...
#> ! [2026-01-29 13:01:17] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-01-29 13:01:17] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-29 13:01:19] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-29 13:01:19] Use the separate HVF from srt_list
#> ℹ [2026-01-29 13:01:19] Number of available HVF: 2000
#> ℹ [2026-01-29 13:01:19] Finished check
#> ℹ [2026-01-29 13:01:20] Perform `Seurat::ScaleData()`
#> ℹ [2026-01-29 13:01:20] Perform pca linear dimension reduction
#> ℹ [2026-01-29 13:01:21] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-01-29 13:01:21] Reorder clusters...
#> ℹ [2026-01-29 13:01:21] Perform umap nonlinear dimension reduction
#> ℹ [2026-01-29 13:01:21] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2026-01-29 13:01:24] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ✔ [2026-01-29 13:01:28] Run scop standard workflow completed
...
#> ℹ [2026-01-29 13:01:28] Using 1 core
#> ⠙ [2026-01-29 13:01:28] Running for 1 [1/6145] ■                               …
#> ⠹ [2026-01-29 13:01:28] Running for 3943 [3943/6145] ■■■■■■■■■■■■■■■■■■■■      …
#> ✔ [2026-01-29 13:01:28] Completed 6145 tasks in 3.3s
#> 
#> ℹ [2026-01-29 13:01:28] Building results
head(markers)
