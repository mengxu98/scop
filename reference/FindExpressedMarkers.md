...
#> ℹ [2026-04-27 15:55:57] Start standard processing workflow...
#> ℹ [2026-04-27 15:55:57] Checking a list of <Seurat>...
#> ! [2026-04-27 15:55:58] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-04-27 15:55:58] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-04-27 15:56:00] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-27 15:56:00] Use the separate HVF from `srt_list`
#> ℹ [2026-04-27 15:56:00] Number of available HVF: 2000
#> ℹ [2026-04-27 15:56:01] Finished check
#> ℹ [2026-04-27 15:56:01] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-27 15:56:01] Perform pca linear dimension reduction
#> ℹ [2026-04-27 15:56:02] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-04-27 15:56:02] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-27 15:56:02] Reorder clusters...
#> ℹ [2026-04-27 15:56:02] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-27 15:56:02] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-27 15:56:02] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-04-27 15:56:06] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-04-27 15:56:10] Standard processing workflow completed
...
#> ℹ [2026-04-27 15:56:11] Using 1 core
#> ⠙ [2026-04-27 15:56:11] Running for 1 [1/6145]              0% | ETA: 47s
#> ⠹ [2026-04-27 15:56:11] Running for 1130 [1130/6145] ■           18% | ETA:  3s
#> ⠸ [2026-04-27 15:56:11] Running for 5564 [5564/6145] ■■■■■■■■■   91% | ETA:  0s
#> ✔ [2026-04-27 15:56:11] Completed 6145 tasks in 4.1s
#> 
#> ℹ [2026-04-27 15:56:11] Building results
head(markers)
