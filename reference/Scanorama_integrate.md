...
- Scanorama_dims_use:
  ...
  Dimensions returned by Scanorama that will be utilized for downstream
...
- return_corrected:
  ...
  Whether to return the corrected data.

- Scanorama_params:

  A list of parameters for the scanorama.correct function.
