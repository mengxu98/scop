...
#> ℹ [2025-11-13 12:00:47] Start standard scop workflow...
#> ℹ [2025-11-13 12:00:48] Checking a list of <Seurat> object...
#> ! [2025-11-13 12:00:48] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2025-11-13 12:00:48] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-13 12:00:50] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-13 12:00:51] Use the separate HVF from srt_list
#> ℹ [2025-11-13 12:00:51] Number of available HVF: 2000
#> ℹ [2025-11-13 12:00:51] Finished check
#> ℹ [2025-11-13 12:00:51] Perform `Seurat::ScaleData()`
#> ℹ [2025-11-13 12:00:52] Perform pca linear dimension reduction
#> StandardPC_ 1 
...
#> ℹ [2025-11-13 12:00:52] Perform `Seurat::FindClusters()` with louvain and `cluster_resolution` = 0.6
#> ℹ [2025-11-13 12:00:53] Reorder clusters...
#> ℹ [2025-11-13 12:00:53] Perform umap nonlinear dimension reduction
#> ℹ [2025-11-13 12:00:53] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-13 12:00:53] UMAP will return its model
#> ℹ [2025-11-13 12:00:56] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-13 12:00:56] UMAP will return its model
#> ✔ [2025-11-13 12:01:00] Run scop standard workflow done
