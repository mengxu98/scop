...
#> ℹ [2025-11-19 14:31:07] Start standard scop workflow...
#> ℹ [2025-11-19 14:31:08] Checking a list of <Seurat> object...
#> ! [2025-11-19 14:31:08] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2025-11-19 14:31:08] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-19 14:31:10] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-19 14:31:10] Use the separate HVF from srt_list
#> ℹ [2025-11-19 14:31:10] Number of available HVF: 2000
#> ℹ [2025-11-19 14:31:10] Finished check
#> ℹ [2025-11-19 14:31:11] Perform `Seurat::ScaleData()`
#> ℹ [2025-11-19 14:31:11] Perform pca linear dimension reduction
#> StandardPC_ 1 
...
#> ℹ [2025-11-19 14:31:12] Perform `Seurat::FindClusters()` with louvain and `cluster_resolution` = 0.6
#> ℹ [2025-11-19 14:31:12] Reorder clusters...
#> ℹ [2025-11-19 14:31:12] Perform umap nonlinear dimension reduction
#> ℹ [2025-11-19 14:31:12] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-19 14:31:12] UMAP will return its model
#> ℹ [2025-11-19 14:31:16] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-19 14:31:16] UMAP will return its model
#> ✔ [2025-11-19 14:31:20] Run scop standard workflow done
