...
#> ℹ [2026-04-03 09:37:42] Start standard processing workflow...
#> ℹ [2026-04-03 09:37:44] Checking a list of <Seurat>...
#> ! [2026-04-03 09:37:44] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-04-03 09:37:44] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 09:37:46] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 09:37:46] Use the separate HVF from `srt_list`
#> ℹ [2026-04-03 09:37:46] Number of available HVF: 2000
#> ℹ [2026-04-03 09:37:47] Finished check
#> ℹ [2026-04-03 09:37:47] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-03 09:37:47] Perform pca linear dimension reduction
#> ℹ [2026-04-03 09:37:48] Use stored estimated dimensions 1:12 for Standardpca
#> ℹ [2026-04-03 09:37:48] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-03 09:37:48] Reorder clusters...
#> ℹ [2026-04-03 09:37:48] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-03 09:37:48] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-03 09:37:48] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ℹ [2026-04-03 09:37:52] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ✔ [2026-04-03 09:37:57] Standard processing workflow completed
