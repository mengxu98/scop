...
#> ℹ [2026-05-12 04:32:28] Start standard processing workflow...
#> ℹ [2026-05-12 04:32:29] Checking a list of <Seurat>...
#> ! [2026-05-12 04:32:29] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-12 04:32:29] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-12 04:32:31] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-12 04:32:31] Use the separate HVF from `srt_list`
#> ℹ [2026-05-12 04:32:31] Number of available HVF: 2000
#> ℹ [2026-05-12 04:32:31] Finished check
#> ℹ [2026-05-12 04:32:31] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-12 04:32:32] Perform pca linear dimension reduction
#> ℹ [2026-05-12 04:32:33] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-12 04:32:33] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-12 04:32:33] Reorder clusters...
#> ℹ [2026-05-12 04:32:34] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-12 04:32:34] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-12 04:32:34] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-12 04:32:39] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-12 04:32:43] Standard processing workflow completed
...
#> ◌ [2026-05-12 04:32:44] Run integration workflow...
#> ℹ [2026-05-12 04:32:44] Split `srt_merge` into `srt_list` by "tech"
#> ℹ [2026-05-12 04:32:45] Checking a list of <Seurat>...
#> ℹ [2026-05-12 04:32:45] Data 1/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-12 04:32:45] Perform `Seurat::FindVariableFeatures()` on 1/4 of `srt_list`...
#> ℹ [2026-05-12 04:32:45] Data 2/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-12 04:32:45] Perform `Seurat::FindVariableFeatures()` on 2/4 of `srt_list`...
#> ℹ [2026-05-12 04:32:46] Data 3/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-12 04:32:46] Perform `Seurat::FindVariableFeatures()` on 3/4 of `srt_list`...
#> ℹ [2026-05-12 04:32:47] Data 4/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-12 04:32:47] Perform `Seurat::FindVariableFeatures()` on 4/4 of `srt_list`...
#> ℹ [2026-05-12 04:32:47] Use the separate HVF from `srt_list`
#> ℹ [2026-05-12 04:32:48] Number of available HVF: 2000
#> ℹ [2026-05-12 04:32:48] Finished check
#> ℹ [2026-05-12 04:33:05] Perform ScaleData
#> ℹ [2026-05-12 04:33:06] Perform "pca" linear dimension reduction
#> ℹ [2026-05-12 04:33:06] Perform CSS integration
#> ℹ [2026-05-12 04:33:06] Using "CSSpca" (1:20) as input
...
#> The following object is masked from ‘package:scop’:
#> 
#>     SpatialDimPlot
#> ℹ [2026-05-12 04:33:08] Adjust neighbor k from 20 to 20 for small-sample clustering
#> ℹ [2026-05-12 04:33:09] Perform `Seurat::FindClusters()` with "louvain"
#> ℹ [2026-05-12 04:33:09] Reorder clusters...
#> ℹ [2026-05-12 04:33:09] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-12 04:33:09] Perform umap nonlinear dimension reduction using CSS (1:24)
#> ℹ [2026-05-12 04:33:14] Perform umap nonlinear dimension reduction using CSS (1:24)
#> ℹ [2026-05-12 04:33:18] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> Warning: Key ‘StandardpcaUMAP2D_’ taken, using ‘standardpcaumap2d_’ instead
#> ✔ [2026-05-12 04:33:24] CSS integration completed
...
#> ℹ [2026-05-12 04:33:24] Data type is log-normalized
#> ℹ [2026-05-12 04:33:24] Detected `srt_query` data type: "log_normalized_counts"
...
#> ℹ [2026-05-12 04:33:25] Data type is log-normalized
#> ℹ [2026-05-12 04:33:25] Detected `srt_ref` data type: "log_normalized_counts"
#> ℹ [2026-05-12 04:33:25] Run CSS projection
