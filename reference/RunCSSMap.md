...
#> ℹ [2026-05-11 15:38:46] Start standard processing workflow...
#> ℹ [2026-05-11 15:38:46] Checking a list of <Seurat>...
#> ! [2026-05-11 15:38:47] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-11 15:38:47] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-11 15:38:48] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-11 15:38:49] Use the separate HVF from `srt_list`
#> ℹ [2026-05-11 15:38:49] Number of available HVF: 2000
#> ℹ [2026-05-11 15:38:49] Finished check
#> ℹ [2026-05-11 15:38:49] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-11 15:38:49] Perform pca linear dimension reduction
#> ℹ [2026-05-11 15:38:50] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-11 15:38:51] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-11 15:38:51] Reorder clusters...
#> ℹ [2026-05-11 15:38:51] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-11 15:38:51] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-11 15:38:51] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-11 15:38:56] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-11 15:39:00] Standard processing workflow completed
...
#> ◌ [2026-05-11 15:39:01] Run integration workflow...
#> ℹ [2026-05-11 15:39:01] Split `srt_merge` into `srt_list` by "tech"
#> ℹ [2026-05-11 15:39:02] Checking a list of <Seurat>...
#> ℹ [2026-05-11 15:39:02] Data 1/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-11 15:39:02] Perform `Seurat::FindVariableFeatures()` on 1/4 of `srt_list`...
#> ℹ [2026-05-11 15:39:03] Data 2/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-11 15:39:03] Perform `Seurat::FindVariableFeatures()` on 2/4 of `srt_list`...
#> ℹ [2026-05-11 15:39:03] Data 3/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-11 15:39:03] Perform `Seurat::FindVariableFeatures()` on 3/4 of `srt_list`...
#> ℹ [2026-05-11 15:39:04] Data 4/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-11 15:39:04] Perform `Seurat::FindVariableFeatures()` on 4/4 of `srt_list`...
#> ℹ [2026-05-11 15:39:04] Use the separate HVF from `srt_list`
#> ℹ [2026-05-11 15:39:05] Number of available HVF: 2000
#> ℹ [2026-05-11 15:39:05] Finished check
#> ℹ [2026-05-11 15:39:22] Perform ScaleData
#> ℹ [2026-05-11 15:39:23] Perform "pca" linear dimension reduction
#> ℹ [2026-05-11 15:39:23] Perform CSS integration
#> ℹ [2026-05-11 15:39:23] Using "CSSpca" (1:20) as input
...
#> 
#>     SpatialDimPlot
#> ℹ [2026-05-11 15:39:26] Adjust neighbor k from 20 to 20 for small-sample clustering
#> ℹ [2026-05-11 15:39:27] Perform `Seurat::FindClusters()` with "louvain"
#> ℹ [2026-05-11 15:39:27] Reorder clusters...
#> ℹ [2026-05-11 15:39:27] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-11 15:39:27] Perform umap nonlinear dimension reduction using CSS (1:24)
#> ℹ [2026-05-11 15:39:32] Perform umap nonlinear dimension reduction using CSS (1:24)
#> ℹ [2026-05-11 15:39:36] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> Warning: Key ‘StandardpcaUMAP2D_’ taken, using ‘standardpcaumap2d_’ instead
#> ✔ [2026-05-11 15:39:42] CSS integration completed
...
#> ℹ [2026-05-11 15:39:42] Data type is log-normalized
#> ℹ [2026-05-11 15:39:43] Detected `srt_query` data type: "log_normalized_counts"
...
#> ℹ [2026-05-11 15:39:43] Data type is log-normalized
#> ℹ [2026-05-11 15:39:43] Detected `srt_ref` data type: "log_normalized_counts"
#> ℹ [2026-05-11 15:39:43] Run CSS projection
