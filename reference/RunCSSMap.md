...
#> ℹ [2026-05-12 15:12:58] Start standard processing workflow...
#> ℹ [2026-05-12 15:12:58] Checking a list of <Seurat>...
#> ! [2026-05-12 15:12:58] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-12 15:12:58] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-12 15:13:01] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-12 15:13:01] Use the separate HVF from `srt_list`
#> ℹ [2026-05-12 15:13:01] Number of available HVF: 2000
#> ℹ [2026-05-12 15:13:02] Finished check
#> ℹ [2026-05-12 15:13:02] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-12 15:13:02] Perform pca linear dimension reduction
#> ℹ [2026-05-12 15:13:03] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-12 15:13:03] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-12 15:13:03] Reorder clusters...
#> ℹ [2026-05-12 15:13:04] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-12 15:13:04] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-12 15:13:04] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-12 15:13:09] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-12 15:13:15] Standard processing workflow completed
...
#> ◌ [2026-05-12 15:13:16] Run integration workflow...
#> ℹ [2026-05-12 15:13:16] Split `srt_merge` into `srt_list` by "tech"
#> ℹ [2026-05-12 15:13:16] Checking a list of <Seurat>...
#> ℹ [2026-05-12 15:13:17] Data 1/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-12 15:13:17] Perform `Seurat::FindVariableFeatures()` on 1/4 of `srt_list`...
#> ℹ [2026-05-12 15:13:17] Data 2/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-12 15:13:17] Perform `Seurat::FindVariableFeatures()` on 2/4 of `srt_list`...
#> ℹ [2026-05-12 15:13:18] Data 3/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-12 15:13:18] Perform `Seurat::FindVariableFeatures()` on 3/4 of `srt_list`...
#> ℹ [2026-05-12 15:13:18] Data 4/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-12 15:13:18] Perform `Seurat::FindVariableFeatures()` on 4/4 of `srt_list`...
#> ℹ [2026-05-12 15:13:19] Use the separate HVF from `srt_list`
#> ℹ [2026-05-12 15:13:19] Number of available HVF: 2000
#> ℹ [2026-05-12 15:13:20] Finished check
#> ℹ [2026-05-12 15:13:39] Perform ScaleData
#> ℹ [2026-05-12 15:13:39] Perform "pca" linear dimension reduction
#> ℹ [2026-05-12 15:13:40] Perform CSS integration
#> ℹ [2026-05-12 15:13:40] Using "CSSpca" (1:20) as input
...
#> 
#>     intersect, t
#> ℹ [2026-05-12 15:13:41] Adjust neighbor k from 20 to 20 for small-sample clustering
#> ℹ [2026-05-12 15:13:42] Perform `Seurat::FindClusters()` with "louvain"
#> ℹ [2026-05-12 15:13:42] Reorder clusters...
#> ℹ [2026-05-12 15:13:42] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-12 15:13:42] Perform umap nonlinear dimension reduction using CSS (1:24)
#> ℹ [2026-05-12 15:13:48] Perform umap nonlinear dimension reduction using CSS (1:24)
#> ℹ [2026-05-12 15:13:53] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> Warning: Key ‘StandardpcaUMAP2D_’ taken, using ‘standardpcaumap2d_’ instead
#> ✔ [2026-05-12 15:14:00] CSS integration completed
...
#> ℹ [2026-05-12 15:14:00] Data type is log-normalized
#> ℹ [2026-05-12 15:14:00] Detected `srt_query` data type: "log_normalized_counts"
...
#> ℹ [2026-05-12 15:14:01] Data type is log-normalized
#> ℹ [2026-05-12 15:14:01] Detected `srt_ref` data type: "log_normalized_counts"
#> ℹ [2026-05-12 15:14:01] Run CSS projection
#> ℹ [2026-05-12 15:14:01] Run UMAP projection
#> ℹ [2026-05-12 15:14:01] Use the reduction to calculate distance metric
#> ℹ [2026-05-12 15:14:01] Use cpp method to find neighbors
#> ℹ [2026-05-12 15:14:01] Running UMAP projection
ProjectionPlot(
  srt_query = srt_query,
  srt_ref = srt_ref,
