...
#> ℹ [2026-06-28 06:47:07] Start standard processing workflow...
#> ℹ [2026-06-28 06:47:07] Checking a list of <Seurat>...
#> ! [2026-06-28 06:47:07] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-28 06:47:07] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 06:47:07] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 06:47:08] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 06:47:08] Number of available HVF: 2000
#> ℹ [2026-06-28 06:47:08] Finished check
#> ℹ [2026-06-28 06:47:08] Perform `ScaleData()`
#> ℹ [2026-06-28 06:47:08] Perform pca linear dimension reduction
#> ℹ [2026-06-28 06:47:08] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-28 06:47:09] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 06:47:09] Reorder clusters...
#> ℹ [2026-06-28 06:47:09] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 06:47:09] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-28 06:47:12] Standard processing workflow completed
CellDensityPlot(
  pancreas_sub,
  features = "Sox9",
