...
#> ℹ [2026-05-23 07:02:22] Start standard processing workflow...
#> ℹ [2026-05-23 07:02:22] Checking a list of <Seurat>...
#> ! [2026-05-23 07:02:23] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-23 07:02:23] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-23 07:02:24] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-23 07:02:24] Use the separate HVF from `srt_list`
#> ℹ [2026-05-23 07:02:24] Number of available HVF: 2000
#> ℹ [2026-05-23 07:02:24] Finished check
#> ℹ [2026-05-23 07:02:24] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-23 07:02:25] Perform pca linear dimension reduction
#> ℹ [2026-05-23 07:02:25] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-05-23 07:02:26] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-23 07:02:26] Reorder clusters...
#> ℹ [2026-05-23 07:02:26] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-23 07:02:26] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-23 07:02:26] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ℹ [2026-05-23 07:02:29] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ✔ [2026-05-23 07:02:32] Standard processing workflow completed
CellDensityPlot(
  pancreas_sub,
  features = "Sox9",
