...
#> ℹ [2026-05-23 10:02:46] Start standard processing workflow...
#> ℹ [2026-05-23 10:02:47] Checking a list of <Seurat>...
#> ! [2026-05-23 10:02:47] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-23 10:02:47] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-23 10:02:48] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-23 10:02:49] Use the separate HVF from `srt_list`
#> ℹ [2026-05-23 10:02:49] Number of available HVF: 2000
#> ℹ [2026-05-23 10:02:49] Finished check
#> ℹ [2026-05-23 10:02:49] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-23 10:02:49] Perform pca linear dimension reduction
#> ℹ [2026-05-23 10:02:50] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-05-23 10:02:50] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-23 10:02:50] Reorder clusters...
#> ℹ [2026-05-23 10:02:50] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-23 10:02:50] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-23 10:02:50] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ℹ [2026-05-23 10:02:53] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ✔ [2026-05-23 10:02:55] Standard processing workflow completed
CellDensityPlot(
  pancreas_sub,
  features = "Sox9",
