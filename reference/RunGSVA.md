...
#> ℹ [2026-04-03 04:26:58] Start standard processing workflow...
#> ℹ [2026-04-03 04:26:59] Checking a list of <Seurat>...
#> ! [2026-04-03 04:26:59] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-04-03 04:26:59] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 04:27:01] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 04:27:02] Use the separate HVF from `srt_list`
#> ℹ [2026-04-03 04:27:02] Number of available HVF: 2000
#> ℹ [2026-04-03 04:27:02] Finished check
#> ℹ [2026-04-03 04:27:02] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-03 04:27:02] Perform pca linear dimension reduction
#> ℹ [2026-04-03 04:27:03] Use stored estimated dimensions 1:12 for Standardpca
#> ℹ [2026-04-03 04:27:04] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-03 04:27:04] Reorder clusters...
#> ℹ [2026-04-03 04:27:04] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-03 04:27:04] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-03 04:27:04] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ℹ [2026-04-03 04:27:08] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ✔ [2026-04-03 04:27:13] Standard processing workflow completed
...
#> ℹ [2026-04-03 04:27:13] Start GSVA analysis
#> ℹ [2026-04-03 04:27:13] Averaging expression by "CellType" ...
#> ℹ [2026-04-03 04:27:13] Aggregated expression matrix: 15998 genes x 5 groups
#> ℹ [2026-04-03 04:27:13] Species: "Mus_musculus"
#> ℹ [2026-04-03 04:27:13] Loading cached: GO_BP version: 3.22.0 nterm:15169 created: 2026-04-03 03:34:12
#> ℹ [2026-04-03 04:27:14] Processing database: "GO_BP" ...
#> ℹ [2026-04-03 04:27:16] Initial overlap: 11182 genes out of 15998 expression genes and 16088 genes in gene sets
#> ℹ [2026-04-03 04:27:19] Running GSVA for 5668 gene sets ...
...
#> ℹ [2026-04-03 04:28:47] GSVA results stored in `tools` slot: "GSVA_CellType_gsva"
#> ✔ [2026-04-03 04:28:47] GSVA analysis done
ht <- GSVAPlot(
  pancreas_sub,
  group.by = "CellType",
  plot_type = "heatmap",
