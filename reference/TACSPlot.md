...
#> ℹ [2026-05-12 16:09:46] Start standard processing workflow...
#> ℹ [2026-05-12 16:09:47] Checking a list of <Seurat>...
#> ! [2026-05-12 16:09:47] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-12 16:09:47] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-12 16:09:49] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-12 16:09:50] Use the separate HVF from `srt_list`
#> ℹ [2026-05-12 16:09:50] Number of available HVF: 2000
#> ℹ [2026-05-12 16:09:50] Finished check
#> ℹ [2026-05-12 16:09:50] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-12 16:09:50] Perform pca linear dimension reduction
#> ℹ [2026-05-12 16:09:51] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-12 16:09:51] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-12 16:09:51] Reorder clusters...
#> ℹ [2026-05-12 16:09:52] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-12 16:09:52] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-12 16:09:52] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-12 16:09:58] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-12 16:10:04] Standard processing workflow completed
TACSPlot(
  pancreas_sub,
  feature1 = "H3f3b",
  feature2 = "Eif1",
