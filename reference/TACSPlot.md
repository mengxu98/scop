...
#> ℹ [2025-11-13 12:43:35] Start standard scop workflow...
#> ℹ [2025-11-13 12:43:36] Checking a list of <Seurat> object...
#> ! [2025-11-13 12:43:36] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2025-11-13 12:43:36] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-13 12:43:38] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-13 12:43:39] Use the separate HVF from srt_list
#> ℹ [2025-11-13 12:43:39] Number of available HVF: 2000
#> ℹ [2025-11-13 12:43:39] Finished check
#> ℹ [2025-11-13 12:43:39] Perform `Seurat::ScaleData()`
#> ℹ [2025-11-13 12:43:40] Perform pca linear dimension reduction
#> StandardPC_ 1 
...
#> ℹ [2025-11-13 12:43:41] Perform `Seurat::FindClusters()` with louvain and `cluster_resolution` = 0.6
#> ℹ [2025-11-13 12:43:41] Reorder clusters...
#> ℹ [2025-11-13 12:43:41] Perform umap nonlinear dimension reduction
#> ℹ [2025-11-13 12:43:41] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-13 12:43:41] UMAP will return its model
#> ℹ [2025-11-13 12:43:45] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-13 12:43:46] UMAP will return its model
#> ✔ [2025-11-13 12:43:50] Run scop standard workflow done
TACSPlot(
  pancreas_sub,
  feature1 = "H3f3b",
  feature2 = "Eif1",
