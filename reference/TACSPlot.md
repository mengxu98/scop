...
#> ℹ [2026-01-22 04:24:00] Start standard scop workflow...
#> ℹ [2026-01-22 04:24:01] Checking a list of <Seurat>...
#> ! [2026-01-22 04:24:01] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-01-22 04:24:01] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-22 04:24:03] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-22 04:24:04] Use the separate HVF from srt_list
#> ℹ [2026-01-22 04:24:04] Number of available HVF: 2000
#> ℹ [2026-01-22 04:24:04] Finished check
#> ℹ [2026-01-22 04:24:05] Perform `Seurat::ScaleData()`
#> ℹ [2026-01-22 04:24:05] Perform pca linear dimension reduction
#> ℹ [2026-01-22 04:24:06] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-01-22 04:24:06] Reorder clusters...
#> ℹ [2026-01-22 04:24:06] Perform umap nonlinear dimension reduction
#> ℹ [2026-01-22 04:24:06] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2026-01-22 04:24:11] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ✔ [2026-01-22 04:24:15] Run scop standard workflow completed
TACSPlot(
  pancreas_sub,
  feature1 = "H3f3b",
  feature2 = "Eif1",
