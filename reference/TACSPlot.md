...
#> ℹ [2026-06-28 15:32:30] Start standard processing workflow...
#> ℹ [2026-06-28 15:32:31] Checking a list of <Seurat>...
#> ! [2026-06-28 15:32:31] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-28 15:32:31] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 15:32:31] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 15:32:31] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 15:32:31] Number of available HVF: 2000
#> ℹ [2026-06-28 15:32:31] Finished check
#> ℹ [2026-06-28 15:32:31] Perform `ScaleData()`
#> ℹ [2026-06-28 15:32:31] Perform pca linear dimension reduction
#> ℹ [2026-06-28 15:32:32] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-28 15:32:32] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 15:32:32] Reorder clusters...
#> ℹ [2026-06-28 15:32:33] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 15:32:33] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-28 15:32:42] Standard processing workflow completed
TACSPlot(
  pancreas_sub,
  feature1 = "H3f3b",
  feature2 = "Eif1",
