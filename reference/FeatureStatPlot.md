...
#> ℹ [2026-05-23 07:45:50] Start standard processing workflow...
#> ℹ [2026-05-23 07:45:51] Checking a list of <Seurat>...
#> ! [2026-05-23 07:45:51] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-23 07:45:51] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-23 07:45:53] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-23 07:45:54] Use the separate HVF from `srt_list`
#> ℹ [2026-05-23 07:45:54] Number of available HVF: 2000
#> ℹ [2026-05-23 07:45:54] Finished check
#> ℹ [2026-05-23 07:45:54] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-23 07:45:54] Perform pca linear dimension reduction
#> ℹ [2026-05-23 07:45:55] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-05-23 07:45:55] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-23 07:45:55] Reorder clusters...
#> ℹ [2026-05-23 07:45:55] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-23 07:45:55] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-23 07:45:55] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ℹ [2026-05-23 07:46:00] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ✔ [2026-05-23 07:46:05] Standard processing workflow completed
FeatureStatPlot(
  pancreas_sub,
...
#> ! [2026-05-23 07:46:15] Removed 10 groups with < 2 observations for violin plot: "sp-S-gp-Beta", "sp-G2M-gp-Beta", "sp-S-gp-Pre-endocrine", "sp-G2M-gp-Pre-endocrine", "sp-S-gp-Alpha", "sp-G2M-gp-Alpha", "sp-S-gp-Epsilon", "sp-G2M-gp-Epsilon", "sp-S-gp-Delta", and "sp-G2M-gp-Delta"
#> ! [2026-05-23 07:46:15] Removed 10 groups with < 2 observations for violin plot: "sp-S-gp-Beta", "sp-G2M-gp-Beta", "sp-S-gp-Pre-endocrine", "sp-G2M-gp-Pre-endocrine", "sp-S-gp-Alpha", "sp-G2M-gp-Alpha", "sp-S-gp-Epsilon", "sp-G2M-gp-Epsilon", "sp-S-gp-Delta", and "sp-G2M-gp-Delta"
#> Warning: No shared levels found between `names(values)` of the manual scale and the
#> data's colour values.
#> Warning: No shared levels found between `names(values)` of the manual scale and the
...
#> ! [2026-05-23 07:46:16] Removed 10 groups with < 2 observations for violin plot: "sp-S-gp-Beta", "sp-G2M-gp-Beta", "sp-S-gp-Pre-endocrine", "sp-G2M-gp-Pre-endocrine", "sp-S-gp-Alpha", "sp-G2M-gp-Alpha", "sp-S-gp-Epsilon", "sp-G2M-gp-Epsilon", "sp-S-gp-Delta", and "sp-G2M-gp-Delta"
#> ! [2026-05-23 07:46:16] Removed 10 groups with < 2 observations for violin plot: "sp-S-gp-Beta", "sp-G2M-gp-Beta", "sp-S-gp-Pre-endocrine", "sp-G2M-gp-Pre-endocrine", "sp-S-gp-Alpha", "sp-G2M-gp-Alpha", "sp-S-gp-Epsilon", "sp-G2M-gp-Epsilon", "sp-S-gp-Delta", and "sp-G2M-gp-Delta"
#> Warning: No shared levels found between `names(values)` of the manual scale and the
#> data's colour values.
#> Warning: No shared levels found between `names(values)` of the manual scale and the
...
#> ! [2026-05-23 07:46:26] Removed 10 groups with < 2 observations for violin plot: "sp-S-gp-Beta", "sp-G2M-gp-Beta", "sp-S-gp-Pre-endocrine", "sp-G2M-gp-Pre-endocrine", "sp-S-gp-Alpha", "sp-G2M-gp-Alpha", "sp-S-gp-Epsilon", "sp-G2M-gp-Epsilon", "sp-S-gp-Delta", and "sp-G2M-gp-Delta"
#> ℹ [2026-05-23 07:46:26] Detected more than 2 groups. Use "kruskal.test" for comparison
#> ! [2026-05-23 07:46:27] Removed 10 groups with < 2 observations for violin plot: "sp-S-gp-Beta", "sp-G2M-gp-Beta", "sp-S-gp-Pre-endocrine", "sp-G2M-gp-Pre-endocrine", "sp-S-gp-Alpha", "sp-G2M-gp-Alpha", "sp-S-gp-Epsilon", "sp-G2M-gp-Epsilon", "sp-S-gp-Delta", and "sp-G2M-gp-Delta"
#> ℹ [2026-05-23 07:46:27] Detected more than 2 groups. Use "kruskal.test" for comparison
#> Warning: No shared levels found between `names(values)` of the manual scale and the
#> data's colour values.
#> Warning: No shared levels found between `names(values)` of the manual scale and the
#> data's colour values.
...
#> ! [2026-05-23 07:46:33] Removed 10 groups with < 2 observations for violin plot: "sp-S-gp-Beta", "sp-G2M-gp-Beta", "sp-S-gp-Pre-endocrine", "sp-G2M-gp-Pre-endocrine", "sp-S-gp-Alpha", "sp-G2M-gp-Alpha", "sp-S-gp-Epsilon", "sp-G2M-gp-Epsilon", "sp-S-gp-Delta", and "sp-G2M-gp-Delta"
#> ℹ [2026-05-23 07:46:33] Detected more than 2 groups. Use "kruskal.test" for comparison
#> ! [2026-05-23 07:46:33] Removed 10 groups with < 2 observations for violin plot: "sp-S-gp-Beta", "sp-G2M-gp-Beta", "sp-S-gp-Pre-endocrine", "sp-G2M-gp-Pre-endocrine", "sp-S-gp-Alpha", "sp-G2M-gp-Alpha", "sp-S-gp-Epsilon", "sp-G2M-gp-Epsilon", "sp-S-gp-Delta", and "sp-G2M-gp-Delta"
#> ℹ [2026-05-23 07:46:33] Detected more than 2 groups. Use "kruskal.test" for comparison
#> Warning: No shared levels found between `names(values)` of the manual scale and the
#> data's colour values.
...
#> ℹ [2026-05-23 07:46:45] Setting `group.by` to "Features" as `plot.by` is set to "feature"
#> Warning: No shared levels found between `names(values)` of the manual scale and the
#> data's colour values.
#> Warning: No shared levels found between `names(values)` of the manual scale and the
#> data's colour values.
...
#> ℹ [2026-05-23 07:46:47] Setting `group.by` to "Features" as `plot.by` is set to "feature"
#> Warning: No shared levels found between `names(values)` of the manual scale and the
#> data's colour values.
#> Warning: No shared levels found between `names(values)` of the manual scale and the
#> data's colour values.
...
#> ℹ [2026-05-23 07:46:50] Setting `group.by` to "Features" as `plot.by` is set to "feature"
...
#> ℹ [2026-05-23 07:46:53] Setting `group.by` to "Features" as `plot.by` is set to "feature"
