...
#> ! [2026-06-01 09:58:25] <error/httr2_http_405>
...
#> ! [2026-06-01 09:58:25] Get errors when retrieving information from the BioMart database
#> ! [2026-06-01 09:58:26] Retrying...
#> ! [2026-06-01 09:58:29] <error/httr2_http_405>
#> !                       Error in `httr2::req_perform()`:
#> !                       ! HTTP 405 Method Not Allowed.
#> !                       ---
#> !                       Backtrace:
...
#> !                        57.                                       └─biomaRt:::.submitQueryXML(...)
#> !                        58.                                         └─httr2::req_perform(req)
#> ! [2026-06-01 09:58:29] Get errors when retrieving information from the BioMart database
#> ! [2026-06-01 09:58:30] Retrying...
#> ! [2026-06-01 09:58:32] <error/httr2_http_405>
#> !                       Error in `httr2::req_perform()`:
#> !                       ! HTTP 405 Method Not Allowed.
#> !                       ---
#> !                       Backtrace:
...
#> !                        57.                                       └─biomaRt:::.submitQueryXML(...)
#> !                        58.                                         └─httr2::req_perform(req)
#> ! [2026-06-01 09:58:32] Get errors when retrieving information from the BioMart database
#> ! [2026-06-01 09:58:33] Retrying...
#> ! [2026-06-01 09:58:33] <error/httr2_http_405>
#> !                       Error in `httr2::req_perform()`:
#> !                       ! HTTP 405 Method Not Allowed.
#> !                       ---
#> !                       Backtrace:
...
#> !                        57.                                       └─biomaRt:::.submitQueryXML(...)
#> !                        58.                                         └─httr2::req_perform(req)
#> ! [2026-06-01 09:58:34] Get errors when retrieving information from the BioMart database
#> ! [2026-06-01 09:58:35] Retrying...
#> ! [2026-06-01 09:58:36] <error/httr2_http_405>
#> !                       Error in `httr2::req_perform()`:
#> !                       ! HTTP 405 Method Not Allowed.
#> !                       ---
#> !                       Backtrace:
...
#> !                        57.                                       └─biomaRt:::.submitQueryXML(...)
#> !                        58.                                         └─httr2::req_perform(req)
#> ! [2026-06-01 09:58:36] Get errors when retrieving information from the BioMart database
#> Error in try_get(expr = {    biomaRt::getBM(mart = mart1, attributes = unique(c("ensembl_gene_id",         to_attr)), filters = "ensembl_gene_id", values = list(geneID_res1[,         "ensembl_gene_id_tmp"]))}, max_tries = max_tries, error_message = "Get errors when retrieving information from the BioMart database"): <error/httr2_http_405> Error in `httr2::req_perform()`: ! HTTP 405
