...
- scVI_dims_use:
  ...
  Dimensions returned by scVI that will be utilized for downstream cell
...
- SCVI_params:
  ...
  A list of parameters for the SCVI model.

- PEAKVI_params:

  A list of parameters for the PEAKVI model.

- POISSONVI_params:

  A list of parameters for the POISSONVI model.

- train_params:

  A list of parameters passed to the model \`train()\` method.

- cores:

  An integer setting the number of threads for \`scVI\`.
