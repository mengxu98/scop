...
#> ℹ [2026-05-12 05:08:01] Start standard processing workflow...
#> ℹ [2026-05-12 05:08:02] Checking a list of <Seurat>...
#> ! [2026-05-12 05:08:02] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-12 05:08:02] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-12 05:08:03] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-12 05:08:04] Use the separate HVF from `srt_list`
#> ℹ [2026-05-12 05:08:04] Number of available HVF: 2000
#> ℹ [2026-05-12 05:08:04] Finished check
#> ℹ [2026-05-12 05:08:04] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-12 05:08:05] Perform pca linear dimension reduction
#> ℹ [2026-05-12 05:08:05] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-12 05:08:05] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-12 05:08:06] Reorder clusters...
#> ℹ [2026-05-12 05:08:06] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-12 05:08:06] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-12 05:08:06] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-12 05:08:11] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-12 05:08:16] Standard processing workflow completed
pancreas_sub <- RunLargeVis(
  object = pancreas_sub,
  features = SeuratObject::VariableFeatures(pancreas_sub)
)
#> 05:08:16 Read 1000 rows and found 2000 numeric columns
#> 05:08:16 Normalizing by max-abs
#> 05:08:16 Using FNN for neighbor search, n_neighbors = 150
#> 05:08:19 Commencing calibration for perplexity = 50 using 2 threads
#> 05:08:22 Initializing from random Gaussian with sd = 1e-4
#> 05:08:22 Commencing optimization for 254033 epochs, with 194344 positive edges
#> 05:08:22 Using rng type: pcg
#> 05:10:52 Optimization finished
CellDimPlot(
  pancreas_sub,
  group.by = "CellType",
  reduction = "largevis"
