...
#> ℹ [2026-06-24 04:25:34] Start standard processing workflow...
#> ℹ [2026-06-24 04:25:35] Checking a list of <Seurat>...
#> ! [2026-06-24 04:25:35] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-24 04:25:35] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-24 04:25:35] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-24 04:25:35] Use the separate HVF from `srt_list`
#> ℹ [2026-06-24 04:25:35] Number of available HVF: 2000
#> ℹ [2026-06-24 04:25:36] Finished check
#> ℹ [2026-06-24 04:25:36] Perform `ScaleData()`
#> ℹ [2026-06-24 04:25:36] Perform pca linear dimension reduction
#> ℹ [2026-06-24 04:25:36] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-24 04:25:36] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-24 04:25:36] Reorder clusters...
#> ℹ [2026-06-24 04:25:37] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-24 04:25:37] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-24 04:25:44] Standard processing workflow completed
...
#> 04:25:44 Read 1000 rows and found 200 numeric columns
#> 04:25:44 Normalizing by max-abs
#> 04:25:44 Using FNN for neighbor search, n_neighbors = 50
#> 04:25:46 Commencing calibration for perplexity = 10 using 2 threads
#> 04:25:49 Initializing from random Gaussian with sd = 1e-4
#> 04:25:49 Commencing optimization for 50 epochs, with 13770 positive edges
#> 04:25:49 Using rng type: pcg
#> 04:25:51 Optimization finished
