...
#> ℹ [2026-06-28 21:15:13] Start standard processing workflow...
#> ℹ [2026-06-28 21:15:14] Checking a list of <Seurat>...
#> ! [2026-06-28 21:15:14] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-28 21:15:14] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 21:15:14] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 21:15:14] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 21:15:14] Number of available HVF: 2000
#> ℹ [2026-06-28 21:15:14] Finished check
#> ℹ [2026-06-28 21:15:14] Perform `ScaleData()`
#> ℹ [2026-06-28 21:15:14] Perform pca linear dimension reduction
#> ℹ [2026-06-28 21:15:15] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-28 21:15:15] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 21:15:15] Reorder clusters...
#> ℹ [2026-06-28 21:15:15] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 21:15:15] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-28 21:15:23] Standard processing workflow completed
...
#> ℹ [2026-06-28 21:15:23] Running scanpy-compatible preprocessing (15998 features -> filter + normalize)...
#> ℹ [2026-06-28 21:15:24] Running scVelo "stochastic" mode with `backend = 'cpp'` (10590 features)
#> ✔ [2026-06-28 21:15:27] scVelo "stochastic" mode completed
#> ✔ [2026-06-28 21:15:27] scVelo cpp backend completed
