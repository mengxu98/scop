...
#> ℹ [2026-06-28 19:47:16] Start standard processing workflow...
#> ℹ [2026-06-28 19:47:17] Checking a list of <Seurat>...
#> ! [2026-06-28 19:47:17] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-28 19:47:17] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 19:47:17] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 19:47:17] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 19:47:17] Number of available HVF: 2000
#> ℹ [2026-06-28 19:47:18] Finished check
#> ℹ [2026-06-28 19:47:18] Perform `ScaleData()`
#> ℹ [2026-06-28 19:47:18] Perform pca linear dimension reduction
#> ℹ [2026-06-28 19:47:18] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-28 19:47:18] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 19:47:19] Reorder clusters...
#> ℹ [2026-06-28 19:47:19] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 19:47:19] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-28 19:47:23] Standard processing workflow completed
p1 <- CellDimPlot(
  pancreas_sub,
...
#> ℹ [2026-06-28 19:47:57] Running PAGA with BiocNeighbors using 29 neighbors
#> ✔ [2026-06-28 19:48:46] PAGA cpp backend completed
...
#> ℹ [2026-06-28 19:48:48] Running scanpy-compatible preprocessing (15998 features -> filter + normalize)...
#> ℹ [2026-06-28 19:48:49] Running scVelo "stochastic" mode with `backend = 'cpp'` (10590 features)
#> ✔ [2026-06-28 19:48:52] scVelo "stochastic" mode completed
#> ✔ [2026-06-28 19:48:52] scVelo cpp backend completed
