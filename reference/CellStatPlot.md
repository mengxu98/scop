...
#> ℹ [2026-06-28 16:20:33] Start standard processing workflow...
#> ℹ [2026-06-28 16:20:34] Checking a list of <Seurat>...
#> ! [2026-06-28 16:20:34] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-28 16:20:34] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 16:20:34] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 16:20:34] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 16:20:35] Number of available HVF: 2000
#> ℹ [2026-06-28 16:20:35] Finished check
#> ℹ [2026-06-28 16:20:35] Perform `ScaleData()`
#> ℹ [2026-06-28 16:20:35] Perform pca linear dimension reduction
#> ℹ [2026-06-28 16:20:35] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-28 16:20:35] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 16:20:36] Reorder clusters...
#> ℹ [2026-06-28 16:20:36] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 16:20:36] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-28 16:20:41] Standard processing workflow completed
p1 <- CellStatPlot(
  pancreas_sub,
  stat.by = "Phase",
...
#> ! [2026-06-28 16:21:01] `stat_type` is forcibly set to "count" when plot "sankey", "chord", "venn", and "upset"
...
#> ! [2026-06-28 16:21:02] `stat_type` is forcibly set to "count" when plot "sankey", "chord", "venn", and "upset"
...
#> ! [2026-06-28 16:21:10] `stat_type` is forcibly set to "count" when plot "sankey", "chord", "venn", and "upset"
...
#> ! [2026-06-28 16:21:11] `stat_type` is forcibly set to "count" when plot "sankey", "chord", "venn", and "upset"
...
#> ! [2026-06-28 16:21:16] `stat_type` is forcibly set to "count" when plot "sankey", "chord", "venn", and "upset"
