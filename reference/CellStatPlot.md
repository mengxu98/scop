...
#> ℹ [2026-06-29 03:10:02] Start standard processing workflow...
#> ℹ [2026-06-29 03:10:03] Checking a list of <Seurat>...
#> ! [2026-06-29 03:10:03] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-29 03:10:03] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-29 03:10:03] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-29 03:10:03] Use the separate HVF from `srt_list`
#> ℹ [2026-06-29 03:10:03] Number of available HVF: 2000
#> ℹ [2026-06-29 03:10:03] Finished check
#> ℹ [2026-06-29 03:10:03] Perform `ScaleData()`
#> ℹ [2026-06-29 03:10:03] Perform pca linear dimension reduction
#> ℹ [2026-06-29 03:10:04] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-29 03:10:04] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-29 03:10:04] Reorder clusters...
#> ℹ [2026-06-29 03:10:04] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-29 03:10:04] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-29 03:10:09] Standard processing workflow completed
p1 <- CellStatPlot(
  pancreas_sub,
  stat.by = "Phase",
...
#> ! [2026-06-29 03:10:29] `stat_type` is forcibly set to "count" when plot "sankey", "chord", "venn", and "upset"
...
#> ! [2026-06-29 03:10:30] `stat_type` is forcibly set to "count" when plot "sankey", "chord", "venn", and "upset"
...
#> ! [2026-06-29 03:10:38] `stat_type` is forcibly set to "count" when plot "sankey", "chord", "venn", and "upset"
...
#> ! [2026-06-29 03:10:39] `stat_type` is forcibly set to "count" when plot "sankey", "chord", "venn", and "upset"
...
#> ! [2026-06-29 03:10:43] `stat_type` is forcibly set to "count" when plot "sankey", "chord", "venn", and "upset"
