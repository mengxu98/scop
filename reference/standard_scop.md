...
#> ℹ [2026-04-06 05:27:15] Start standard processing workflow...
#> ℹ [2026-04-06 05:27:15] Checking a list of <Seurat>...
#> ! [2026-04-06 05:27:16] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-04-06 05:27:16] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-04-06 05:27:18] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-06 05:27:18] Use the separate HVF from `srt_list`
#> ℹ [2026-04-06 05:27:18] Number of available HVF: 2000
#> ℹ [2026-04-06 05:27:19] Finished check
#> ℹ [2026-04-06 05:27:19] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-06 05:27:19] Perform pca linear dimension reduction
#> ℹ [2026-04-06 05:27:20] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-04-06 05:27:20] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-06 05:27:20] Reorder clusters...
#> ℹ [2026-04-06 05:27:21] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-06 05:27:21] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-06 05:27:21] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-04-06 05:27:25] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-04-06 05:27:30] Standard processing workflow completed
CellDimPlot(
  pancreas_sub,
...
#> ℹ [2026-04-06 05:27:30] Start standard processing workflow...
#> ℹ [2026-04-06 05:27:30] Checking a list of <Seurat>...
#> ℹ [2026-04-06 05:27:30] Data 1/1 of the `srt_list` has been log-normalized
#> ℹ [2026-04-06 05:27:30] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-06 05:27:31] Use the separate HVF from `srt_list`
#> ℹ [2026-04-06 05:27:31] Number of available HVF: 2000
#> ℹ [2026-04-06 05:27:31] Finished check
#> ℹ [2026-04-06 05:27:31] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-06 05:27:32] Perform pca linear dimension reduction
#> ℹ [2026-04-06 05:27:32] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-04-06 05:27:33] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-06 05:27:33] Reorder clusters...
#> ℹ [2026-04-06 05:27:33] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-06 05:27:33] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-06 05:27:33] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> Warning: Key ‘StandardpcaUMAP2D_’ taken, using ‘standardpcaumap2d_’ instead
#> ℹ [2026-04-06 05:27:38] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> Warning: Key ‘StandardpcaUMAP3D_’ taken, using ‘standardpcaumap3d_’ instead
#> ℹ [2026-04-06 05:27:42] Perform nmf linear dimension reduction
#> ℹ [2026-04-06 05:27:42] Running NMF...
#> ℹ StandardBE_ 1 
...
#> ✔ [2026-04-06 05:27:47] NMF compute completed
#> ℹ [2026-04-06 05:27:47] Use stored estimated dimensions 1:50 for Standardnmf
#> ℹ [2026-04-06 05:27:48] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-06 05:27:48] Reorder clusters...
#> ℹ [2026-04-06 05:27:48] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-06 05:27:48] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-06 05:27:48] Perform umap nonlinear dimension reduction using Standardnmf (1:50)
#> ℹ [2026-04-06 05:27:52] Perform umap nonlinear dimension reduction using Standardnmf (1:50)
#> ℹ [2026-04-06 05:27:57] Perform mds linear dimension reduction
#> ℹ [2026-04-06 05:27:58] Use stored estimated dimensions 1:20 for Standardmds
#> ℹ [2026-04-06 05:27:58] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-06 05:27:58] Reorder clusters...
#> ℹ [2026-04-06 05:27:59] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-06 05:27:59] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-06 05:27:59] Perform umap nonlinear dimension reduction using Standardmds (1:20)
#> ℹ [2026-04-06 05:28:03] Perform umap nonlinear dimension reduction using Standardmds (1:20)
#> ✔ [2026-04-06 05:28:08] Standard processing workflow completed
plist1 <- lapply(
...
#> ℹ [2026-04-06 05:28:08] Start standard processing workflow...
#> ℹ [2026-04-06 05:28:08] Checking a list of <Seurat>...
#> ℹ [2026-04-06 05:28:09] Data 1/1 of the `srt_list` has been log-normalized
#> ℹ [2026-04-06 05:28:09] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-06 05:28:09] Use the separate HVF from `srt_list`
#> ℹ [2026-04-06 05:28:09] Number of available HVF: 2000
#> ℹ [2026-04-06 05:28:10] Finished check
#> ℹ [2026-04-06 05:28:10] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-06 05:28:10] Perform pca linear dimension reduction
#> ℹ [2026-04-06 05:28:11] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-04-06 05:28:11] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-06 05:28:11] Reorder clusters...
#> ℹ [2026-04-06 05:28:12] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-06 05:28:12] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-06 05:28:12] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-04-06 05:28:16] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-04-06 05:28:21] Perform tsne nonlinear dimension reduction
#> ℹ [2026-04-06 05:28:21] Perform tsne nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-04-06 05:28:23] Perform tsne nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-04-06 05:28:26] Perform fr nonlinear dimension reduction
#> ℹ [2026-04-06 05:28:26] Perform fr nonlinear dimension reduction using Standardpca_SNN
#> ℹ [2026-04-06 05:28:27] Perform fr nonlinear dimension reduction using Standardpca_SNN
#> ✔ [2026-04-06 05:28:29] Standard processing workflow completed
plist2 <- lapply(
