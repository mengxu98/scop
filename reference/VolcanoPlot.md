...
#> ℹ [2026-01-30 17:37:11] Start standard scop workflow...
#> ℹ [2026-01-30 17:37:12] Checking a list of <Seurat>...
#> ! [2026-01-30 17:37:12] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-01-30 17:37:12] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-30 17:37:14] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-30 17:37:15] Use the separate HVF from srt_list
#> ℹ [2026-01-30 17:37:15] Number of available HVF: 2000
#> ℹ [2026-01-30 17:37:15] Finished check
#> ℹ [2026-01-30 17:37:15] Perform `Seurat::ScaleData()`
#> ℹ [2026-01-30 17:37:15] Perform pca linear dimension reduction
#> ℹ [2026-01-30 17:37:16] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-01-30 17:37:17] Reorder clusters...
#> ℹ [2026-01-30 17:37:17] Perform umap nonlinear dimension reduction
#> ℹ [2026-01-30 17:37:17] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2026-01-30 17:37:21] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ✔ [2026-01-30 17:37:26] Run scop standard workflow completed
pancreas_sub <- RunDEtest(
  pancreas_sub,
  group.by = "CellType"
)
#> ℹ [2026-01-30 17:37:27] Data type is log-normalized
#> ℹ [2026-01-30 17:37:27] Start differential expression test
#> ℹ [2026-01-30 17:37:27] Find all markers(wilcox) among [1] 5 groups...
#> ℹ [2026-01-30 17:37:27] Using 1 core
#> ⠙ [2026-01-30 17:37:27] Running for Ductal [1/5] ■■■■■■■                       …
#> ✔ [2026-01-30 17:37:27] Completed 5 tasks in 803ms
#> 
#> ℹ [2026-01-30 17:37:27] Building results
#> ✔ [2026-01-30 17:37:28] Differential expression test completed
VolcanoPlot(
  pancreas_sub,
  group.by = "CellType",
  ncol = 2
