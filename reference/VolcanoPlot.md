...
#> ℹ [2026-04-03 10:22:02] Start standard processing workflow...
#> ℹ [2026-04-03 10:22:03] Checking a list of <Seurat>...
#> ! [2026-04-03 10:22:03] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-04-03 10:22:03] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 10:22:05] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 10:22:06] Use the separate HVF from `srt_list`
#> ℹ [2026-04-03 10:22:06] Number of available HVF: 2000
#> ℹ [2026-04-03 10:22:06] Finished check
#> ℹ [2026-04-03 10:22:06] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-03 10:22:07] Perform pca linear dimension reduction
#> ℹ [2026-04-03 10:22:07] Use stored estimated dimensions 1:12 for Standardpca
#> ℹ [2026-04-03 10:22:08] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-03 10:22:08] Reorder clusters...
#> ℹ [2026-04-03 10:22:08] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-03 10:22:08] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-03 10:22:08] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ℹ [2026-04-03 10:22:13] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ✔ [2026-04-03 10:22:18] Standard processing workflow completed
pancreas_sub <- RunDEtest(
  pancreas_sub,
  group.by = "CellType"
)
#> ℹ [2026-04-03 10:22:18] Data type is log-normalized
#> ℹ [2026-04-03 10:22:18] Start differential expression test
#> ℹ [2026-04-03 10:22:18] Find all markers(wilcox) among [1] 5 groups...
#> ℹ [2026-04-03 10:22:18] Using 1 core
#> ⠙ [2026-04-03 10:22:18] Running for Ductal [1/5] ■■          20% | ETA:  1s
#> ⠹ [2026-04-03 10:22:18] Running for Ngn3-low-EP [4/5] ■■■■■■■■    80% | ETA:  0s
#> ✔ [2026-04-03 10:22:18] Completed 5 tasks in 800ms
#> 
#> ℹ [2026-04-03 10:22:18] Building results
#> ✔ [2026-04-03 10:22:19] Differential expression test completed
VolcanoPlot(
  pancreas_sub,
  group.by = "CellType",
  ncol = 2
