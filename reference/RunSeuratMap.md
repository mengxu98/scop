...
#> ℹ [2025-11-13 12:31:50] Start standard scop workflow...
#> ℹ [2025-11-13 12:31:50] Checking a list of <Seurat> object...
#> ! [2025-11-13 12:31:50] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2025-11-13 12:31:50] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-13 12:31:53] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-13 12:31:53] Use the separate HVF from srt_list
#> ℹ [2025-11-13 12:31:53] Number of available HVF: 2000
#> ℹ [2025-11-13 12:31:54] Finished check
#> ℹ [2025-11-13 12:31:54] Perform `Seurat::ScaleData()`
#> ℹ [2025-11-13 12:31:54] Perform pca linear dimension reduction
#> StandardPC_ 1 
...
#> ℹ [2025-11-13 12:31:56] Perform `Seurat::FindClusters()` with louvain and `cluster_resolution` = 0.6
#> ℹ [2025-11-13 12:31:56] Reorder clusters...
#> ℹ [2025-11-13 12:31:56] Perform umap nonlinear dimension reduction
#> ℹ [2025-11-13 12:31:56] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-13 12:31:56] UMAP will return its model
#> ℹ [2025-11-13 12:32:01] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-13 12:32:01] UMAP will return its model
#> ✔ [2025-11-13 12:32:06] Run scop standard workflow done
...
#> ◌ [2025-11-13 12:32:07] Run Uncorrected integration...
#> ℹ [2025-11-13 12:32:07] Spliting `srt_merge` into `srt_list` by column "tech"...
#> ℹ [2025-11-13 12:32:08] Checking a list of <Seurat> object...
#> ℹ [2025-11-13 12:32:08] Data 1/4 of the `srt_list` has been log-normalized
#> ℹ [2025-11-13 12:32:08] Perform `Seurat::FindVariableFeatures()` on the data 1/4 of the `srt_list`...
#> ℹ [2025-11-13 12:32:08] Data 2/4 of the `srt_list` has been log-normalized
#> ℹ [2025-11-13 12:32:09] Perform `Seurat::FindVariableFeatures()` on the data 2/4 of the `srt_list`...
#> ℹ [2025-11-13 12:32:09] Data 3/4 of the `srt_list` has been log-normalized
#> ℹ [2025-11-13 12:32:09] Perform `Seurat::FindVariableFeatures()` on the data 3/4 of the `srt_list`...
#> ℹ [2025-11-13 12:32:10] Data 4/4 of the `srt_list` has been log-normalized
#> ℹ [2025-11-13 12:32:10] Perform `Seurat::FindVariableFeatures()` on the data 4/4 of the `srt_list`...
#> ℹ [2025-11-13 12:32:10] Use the separate HVF from srt_list
#> ℹ [2025-11-13 12:32:10] Number of available HVF: 2000
#> ℹ [2025-11-13 12:32:11] Finished check
#> ℹ [2025-11-13 12:32:12] Perform Uncorrected integration
#> ℹ [2025-11-13 12:32:13] Perform `Seurat::ScaleData()`
#> ℹ [2025-11-13 12:32:13] Perform linear dimension reduction("pca")
#> ℹ [2025-11-13 12:32:15] Perform FindClusters ("louvain")
#> ℹ [2025-11-13 12:32:15] Reorder clusters...
#> ℹ [2025-11-13 12:32:15] Perform nonlinear dimension reduction ("umap")
#> ℹ [2025-11-13 12:32:15] Non-linear dimensionality reduction (umap) using (Uncorrectedpca) dims (1-10) as input
#> ℹ [2025-11-13 12:32:20] Non-linear dimensionality reduction (umap) using (Uncorrectedpca) dims (1-10) as input
#> ✔ [2025-11-13 12:32:27] Run Uncorrected integration done
...
#> ℹ [2025-11-13 12:32:27] Data type is log-normalized
#> ℹ [2025-11-13 12:32:27] Detected srt_query data type: log_normalized_counts
#> ℹ [2025-11-13 12:32:28] Data type is log-normalized
#> ℹ [2025-11-13 12:32:28] Detected srt_ref data type: log_normalized_counts
#> ℹ [2025-11-13 12:32:28] Run FindTransferAnchors
...
#> Integrating data
#> ℹ [2025-11-13 12:32:33] Run UMAP projection
#> ℹ [2025-11-13 12:32:33] Use the reduction to calculate distance metric
#> ℹ [2025-11-13 12:32:33] Use raw method to find neighbors
#> ℹ [2025-11-13 12:32:33] Running UMAP projection
ProjectionPlot(
  srt_query = srt_query,
  srt_ref = srt_ref,
