...
#> ℹ [2026-05-24 16:35:52] Start standard processing workflow...
#> ℹ [2026-05-24 16:35:52] Checking a list of <Seurat>...
#> ! [2026-05-24 16:35:52] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-24 16:35:52] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-24 16:35:54] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-24 16:35:54] Use the separate HVF from `srt_list`
#> ℹ [2026-05-24 16:35:55] Number of available HVF: 2000
#> ℹ [2026-05-24 16:35:55] Finished check
#> ℹ [2026-05-24 16:35:55] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-24 16:35:55] Perform pca linear dimension reduction
#> ℹ [2026-05-24 16:35:56] Use stored estimated dimensions 1:27 for Standardpca
#> ℹ [2026-05-24 16:35:56] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-24 16:35:56] Reorder clusters...
#> ℹ [2026-05-24 16:35:57] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-24 16:35:57] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-24 16:35:57] Perform umap nonlinear dimension reduction using Standardpca (1:27)
#> ℹ [2026-05-24 16:36:02] Perform umap nonlinear dimension reduction using Standardpca (1:27)
#> ✔ [2026-05-24 16:36:08] Standard processing workflow completed
...
#> ◌ [2026-05-24 16:36:08] Run integration workflow...
#> ℹ [2026-05-24 16:36:08] Split `srt_merge` into `srt_list` by "tech"
#> ℹ [2026-05-24 16:36:09] Checking a list of <Seurat>...
#> ℹ [2026-05-24 16:36:09] Data 1/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-24 16:36:09] Perform `Seurat::FindVariableFeatures()` on 1/4 of `srt_list`...
#> ℹ [2026-05-24 16:36:10] Data 2/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-24 16:36:10] Perform `Seurat::FindVariableFeatures()` on 2/4 of `srt_list`...
#> ℹ [2026-05-24 16:36:10] Data 3/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-24 16:36:10] Perform `Seurat::FindVariableFeatures()` on 3/4 of `srt_list`...
#> ℹ [2026-05-24 16:36:11] Data 4/4 of the `srt_list` has been log-normalized
#> ℹ [2026-05-24 16:36:11] Perform `Seurat::FindVariableFeatures()` on 4/4 of `srt_list`...
#> ℹ [2026-05-24 16:36:11] Use the separate HVF from `srt_list`
#> ℹ [2026-05-24 16:36:12] Number of available HVF: 2000
#> ℹ [2026-05-24 16:36:12] Finished check
#> ℹ [2026-05-24 16:36:15] Perform Uncorrected integration
#> ℹ [2026-05-24 16:36:16] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-24 16:36:16] Perform "pca" linear dimension reduction
#> ℹ [2026-05-24 16:36:17] Adjust neighbor k from 20 to 20 for small-sample clustering
#> ℹ [2026-05-24 16:36:17] Perform `Seurat::FindClusters()` with "louvain"
#> ℹ [2026-05-24 16:36:18] Reorder clusters...
#> ℹ [2026-05-24 16:36:18] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-24 16:36:18] Perform umap nonlinear dimension reduction using Uncorrectedpca (1:19)
#> ℹ [2026-05-24 16:36:24] Perform umap nonlinear dimension reduction using Uncorrectedpca (1:19)
#> ℹ [2026-05-24 16:36:29] Perform umap nonlinear dimension reduction using Standardpca (1:27)
#> Warning: Key ‘StandardpcaUMAP2D_’ taken, using ‘standardpcaumap2d_’ instead
#> ✔ [2026-05-24 16:36:36] Uncorrected integration completed
...
#> ℹ [2026-05-24 16:36:37] Data type is log-normalized
#> ℹ [2026-05-24 16:36:37] Detected srt_query data type: log_normalized_counts
#> ℹ [2026-05-24 16:36:37] Data type is log-normalized
#> ℹ [2026-05-24 16:36:37] Detected srt_ref data type: log_normalized_counts
#> ℹ [2026-05-24 16:36:37] Run FindTransferAnchors
...
#> Integrating data
#> ℹ [2026-05-24 16:36:43] Run UMAP projection
#> ℹ [2026-05-24 16:36:43] Use the reduction to calculate distance metric
#> ℹ [2026-05-24 16:36:43] Use cpp method to find neighbors
#> ℹ [2026-05-24 16:36:43] Running UMAP projection
ProjectionPlot(
  srt_query = srt_query,
  srt_ref = srt_ref,
