...
#> ℹ [2026-04-03 08:39:23] Start standard processing workflow...
#> ℹ [2026-04-03 08:39:24] Checking a list of <Seurat>...
#> ! [2026-04-03 08:39:25] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-04-03 08:39:25] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 08:39:27] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 08:39:28] Use the separate HVF from `srt_list`
#> ℹ [2026-04-03 08:39:28] Number of available HVF: 2000
#> ℹ [2026-04-03 08:39:29] Finished check
#> ℹ [2026-04-03 08:39:29] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-03 08:39:30] Perform pca linear dimension reduction
#> ℹ [2026-04-03 08:39:34] Use stored estimated dimensions 1:12 for Standardpca
#> ℹ [2026-04-03 08:39:34] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-03 08:39:34] Reorder clusters...
#> ℹ [2026-04-03 08:39:34] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-03 08:39:34] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-03 08:39:35] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ℹ [2026-04-03 08:39:37] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ✔ [2026-04-03 08:39:39] Standard processing workflow completed
...
#> ℹ [2026-04-03 08:39:39] Start CellChat analysis
#> ℹ [2026-04-03 08:42:55] Processing condition: "ConditionA"
