...
- k_geom:
  ...
  Unitless number of spatial neighbors used by BANKSY.
...
- coordinate_space:
  ...
  Coordinate space used for BANKSY spatial input. The default is raw
  acquisition coordinates, so geometry and distance weighting use raw
