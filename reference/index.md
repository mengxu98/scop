...
- [`RunSpatialQM()`](https://mengxu98.github.io/scop/reference/RunSpatialQM.md)
...
- [`GiottoPreprocess()`](https://mengxu98.github.io/scop/reference/GiottoPreprocess.md)
  : Preprocess an internal Giotto workflow object
- [`GiottoReduce()`](https://mengxu98.github.io/scop/reference/GiottoReduce.md)
  : Run Giotto dimensional reduction
- [`GiottoCluster()`](https://mengxu98.github.io/scop/reference/GiottoCluster.md)
  : Run Giotto nearest-network clustering
- [`GiottoSpatialNetwork()`](https://mengxu98.github.io/scop/reference/GiottoSpatialNetwork.md)
  : Create a Giotto spatial network
- [`GiottoSpatialGenes()`](https://mengxu98.github.io/scop/reference/GiottoSpatialGenes.md)
  : Run Giotto spatial gene detection
- [`GiottoSpatialModules()`](https://mengxu98.github.io/scop/reference/GiottoSpatialModules.md)
  : Run Giotto spatial co-expression modules
- [`GiottoCellProximity()`](https://mengxu98.github.io/scop/reference/GiottoCellProximity.md)
  : Run Giotto cell proximity enrichment
- [`GiottoHMRF()`](https://mengxu98.github.io/scop/reference/GiottoHMRF.md)
...
- [`ListScopDatasets()`](https://mengxu98.github.io/scop/reference/ListScopDatasets.md)
  : List SCOP external datasets
- [`LoadScopDataset()`](https://mengxu98.github.io/scop/reference/LoadScopDataset.md)
