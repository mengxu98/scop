...
#> ℹ [2026-05-31 05:15:11] Start standard processing workflow...
#> ℹ [2026-05-31 05:15:11] Checking a list of <Seurat>...
#> ! [2026-05-31 05:15:12] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-31 05:15:12] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-31 05:15:13] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-31 05:15:13] Use the separate HVF from `srt_list`
#> ℹ [2026-05-31 05:15:14] Number of available HVF: 2000
#> ℹ [2026-05-31 05:15:14] Finished check
#> ℹ [2026-05-31 05:15:14] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-31 05:15:14] Perform pca linear dimension reduction
#> ℹ [2026-05-31 05:15:14] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-05-31 05:15:15] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-31 05:15:15] Reorder clusters...
#> ℹ [2026-05-31 05:15:15] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-31 05:15:15] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-31 05:15:15] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ℹ [2026-05-31 05:15:18] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ✔ [2026-05-31 05:15:20] Standard processing workflow completed
...
#> ℹ [2026-05-31 05:15:20] Start CellChat analysis
