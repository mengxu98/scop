...
#> ℹ [2026-05-25 09:10:24] Start standard processing workflow...
#> ℹ [2026-05-25 09:10:24] Checking a list of <Seurat>...
#> ! [2026-05-25 09:10:25] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-25 09:10:25] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-25 09:10:26] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-25 09:10:27] Use the separate HVF from `srt_list`
#> ℹ [2026-05-25 09:10:27] Number of available HVF: 2000
#> ℹ [2026-05-25 09:10:27] Finished check
#> ℹ [2026-05-25 09:10:27] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-25 09:10:27] Perform pca linear dimension reduction
#> ℹ [2026-05-25 09:10:28] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-05-25 09:10:28] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-25 09:10:28] Reorder clusters...
#> ℹ [2026-05-25 09:10:28] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-25 09:10:29] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-25 09:10:29] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ℹ [2026-05-25 09:10:31] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ✔ [2026-05-25 09:10:34] Standard processing workflow completed
...
#> ℹ [2026-05-25 09:10:34] Start CellChat analysis
#> ℹ [2026-05-25 09:10:39] Processing condition: "ConditionA"
