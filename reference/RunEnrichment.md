...
#> ℹ [2025-11-13 12:21:00] Start standard scop workflow...
#> ℹ [2025-11-13 12:21:01] Checking a list of <Seurat> object...
#> ! [2025-11-13 12:21:01] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2025-11-13 12:21:01] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-13 12:21:03] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-13 12:21:03] Use the separate HVF from srt_list
#> ℹ [2025-11-13 12:21:04] Number of available HVF: 2000
#> ℹ [2025-11-13 12:21:04] Finished check
#> ℹ [2025-11-13 12:21:04] Perform `Seurat::ScaleData()`
#> ℹ [2025-11-13 12:21:04] Perform pca linear dimension reduction
#> StandardPC_ 1 
...
#> ℹ [2025-11-13 12:21:05] Perform `Seurat::FindClusters()` with louvain and `cluster_resolution` = 0.6
#> ℹ [2025-11-13 12:21:05] Reorder clusters...
#> ℹ [2025-11-13 12:21:05] Perform umap nonlinear dimension reduction
#> ℹ [2025-11-13 12:21:05] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-13 12:21:05] UMAP will return its model
#> ℹ [2025-11-13 12:21:10] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-13 12:21:10] UMAP will return its model
#> ✔ [2025-11-13 12:21:15] Run scop standard workflow done
pancreas_sub <- RunDEtest(
  pancreas_sub,
  group_by = "CellType"
)
#> ✔ [2025-11-13 12:21:15] immunogenomics/presto installed successfully
#> ℹ [2025-11-13 12:21:16] Data type is log-normalized
#> ℹ [2025-11-13 12:21:16] Start differential expression test
#> ℹ [2025-11-13 12:21:16] Find all markers(wilcox) among 5 groups...
#> ℹ [2025-11-13 12:21:16] Using 1 core
#> ⠙ [2025-11-13 12:21:16] Running [1/5] ETA:  1s
#> ✔ [2025-11-13 12:21:16] Completed 5 tasks in 759ms
#> 
#> ℹ [2025-11-13 12:21:16] Building results
#> ✔ [2025-11-13 12:21:16] Differential expression test completed
...
#> ℹ [2025-11-13 12:21:16] Start Enrichment analysis
#> ✔ [2025-11-13 12:21:16] clusterProfiler installed successfully
#> ℹ [2025-11-13 12:21:16] Species: "Mus_musculus"
#> ℹ [2025-11-13 12:21:16] Loading cached: GO_BP version: 3.22.0 nterm:15169 created: 2025-11-13 11:51:23
#> ℹ [2025-11-13 12:21:18] Permform enrichment...
#> ℹ [2025-11-13 12:21:18] Using 1 core
#> ⠙ [2025-11-13 12:21:18] Running [1/5] ETA:  2m
#> ⠹ [2025-11-13 12:21:18] Running [2/5] ETA:  1m
#> ⠸ [2025-11-13 12:21:18] Running [3/5] ETA: 36s
#> ⠼ [2025-11-13 12:21:18] Running [4/5] ETA: 18s
#> ✔ [2025-11-13 12:21:18] Completed 5 tasks in 1m 23.2s
#> 
#> ℹ [2025-11-13 12:21:18] Building results
#> ✔ [2025-11-13 12:22:41] Enrichment analysis done
EnrichmentPlot(
  pancreas_sub,
  db = "GO_BP",
  group_by = "CellType",
