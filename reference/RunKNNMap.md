...
#> ℹ [2026-01-30 17:18:10] Start standard scop workflow...
#> ℹ [2026-01-30 17:18:10] Checking a list of <Seurat>...
#> ! [2026-01-30 17:18:10] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-01-30 17:18:10] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-30 17:18:13] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-30 17:18:14] Use the separate HVF from srt_list
#> ℹ [2026-01-30 17:18:14] Number of available HVF: 2000
#> ℹ [2026-01-30 17:18:14] Finished check
#> ℹ [2026-01-30 17:18:15] Perform `Seurat::ScaleData()`
#> ℹ [2026-01-30 17:18:15] Perform pca linear dimension reduction
#> ℹ [2026-01-30 17:18:16] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-01-30 17:18:17] Reorder clusters...
#> ℹ [2026-01-30 17:18:17] Perform umap nonlinear dimension reduction
#> ℹ [2026-01-30 17:18:17] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2026-01-30 17:18:22] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ✔ [2026-01-30 17:18:27] Run scop standard workflow completed
...
#> ◌ [2026-01-30 17:18:28] Run Uncorrected integration...
#> ℹ [2026-01-30 17:18:28] Spliting `srt_merge` into `srt_list` by column "tech"...
#> ℹ [2026-01-30 17:18:29] Checking a list of <Seurat>...
#> ℹ [2026-01-30 17:18:29] Data 1/4 of the `srt_list` has been log-normalized
#> ℹ [2026-01-30 17:18:29] Perform `Seurat::FindVariableFeatures()` on the data 1/4 of the `srt_list`...
#> ℹ [2026-01-30 17:18:30] Data 2/4 of the `srt_list` has been log-normalized
#> ℹ [2026-01-30 17:18:30] Perform `Seurat::FindVariableFeatures()` on the data 2/4 of the `srt_list`...
#> ℹ [2026-01-30 17:18:30] Data 3/4 of the `srt_list` has been log-normalized
#> ℹ [2026-01-30 17:18:30] Perform `Seurat::FindVariableFeatures()` on the data 3/4 of the `srt_list`...
#> ℹ [2026-01-30 17:18:31] Data 4/4 of the `srt_list` has been log-normalized
#> ℹ [2026-01-30 17:18:31] Perform `Seurat::FindVariableFeatures()` on the data 4/4 of the `srt_list`...
#> ℹ [2026-01-30 17:18:31] Use the separate HVF from srt_list
#> ℹ [2026-01-30 17:18:32] Number of available HVF: 2000
#> ℹ [2026-01-30 17:18:32] Finished check
#> ℹ [2026-01-30 17:18:33] Perform Uncorrected integration
#> ℹ [2026-01-30 17:18:34] Perform `Seurat::ScaleData()`
#> ℹ [2026-01-30 17:18:34] Perform linear dimension reduction("pca")
#> ℹ [2026-01-30 17:18:38] Perform Seurat::FindClusters ("louvain")
#> ℹ [2026-01-30 17:18:38] Reorder clusters...
#> ℹ [2026-01-30 17:18:38] Perform nonlinear dimension reduction ("umap")
#> ℹ [2026-01-30 17:18:38] Non-linear dimensionality reduction (umap) using (Uncorrectedpca) dims (1-10) as input
#> ℹ [2026-01-30 17:18:43] Non-linear dimensionality reduction (umap) using (Uncorrectedpca) dims (1-10) as input
#> ✔ [2026-01-30 17:18:50] Run Uncorrected integration done
CellDimPlot(
  srt_ref,
...
#> ℹ [2026-01-30 17:18:51] Use the features to calculate distance metric
#> ℹ [2026-01-30 17:18:51] Data type is log-normalized
#> ℹ [2026-01-30 17:18:52] Data type is log-normalized
#> ℹ [2026-01-30 17:18:52] Use 2000 features to calculate distance
#> ℹ [2026-01-30 17:18:52] Use raw method to find neighbors
#> ℹ [2026-01-30 17:18:52] Running UMAP projection
ProjectionPlot(
  srt_query = srt_query,
  srt_ref = srt_ref,
