...
#> ℹ [2026-01-22 04:05:56] Start standard scop workflow...
#> ℹ [2026-01-22 04:05:57] Checking a list of <Seurat>...
#> ! [2026-01-22 04:05:57] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-01-22 04:05:57] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-22 04:05:59] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-22 04:06:00] Use the separate HVF from srt_list
#> ℹ [2026-01-22 04:06:00] Number of available HVF: 2000
#> ℹ [2026-01-22 04:06:00] Finished check
#> ℹ [2026-01-22 04:06:01] Perform `Seurat::ScaleData()`
#> ℹ [2026-01-22 04:06:01] Perform pca linear dimension reduction
#> ℹ [2026-01-22 04:06:02] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-01-22 04:06:02] Reorder clusters...
#> ℹ [2026-01-22 04:06:02] Perform umap nonlinear dimension reduction
#> ℹ [2026-01-22 04:06:02] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2026-01-22 04:06:07] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ✔ [2026-01-22 04:06:12] Run scop standard workflow completed
...
#> ◌ [2026-01-22 04:06:13] Run Uncorrected integration...
#> ℹ [2026-01-22 04:06:13] Spliting `srt_merge` into `srt_list` by column "tech"...
#> ℹ [2026-01-22 04:06:14] Checking a list of <Seurat>...
#> ℹ [2026-01-22 04:06:14] Data 1/4 of the `srt_list` has been log-normalized
#> ℹ [2026-01-22 04:06:14] Perform `Seurat::FindVariableFeatures()` on the data 1/4 of the `srt_list`...
#> ℹ [2026-01-22 04:06:15] Data 2/4 of the `srt_list` has been log-normalized
#> ℹ [2026-01-22 04:06:15] Perform `Seurat::FindVariableFeatures()` on the data 2/4 of the `srt_list`...
#> ℹ [2026-01-22 04:06:15] Data 3/4 of the `srt_list` has been log-normalized
#> ℹ [2026-01-22 04:06:15] Perform `Seurat::FindVariableFeatures()` on the data 3/4 of the `srt_list`...
#> ℹ [2026-01-22 04:06:16] Data 4/4 of the `srt_list` has been log-normalized
#> ℹ [2026-01-22 04:06:16] Perform `Seurat::FindVariableFeatures()` on the data 4/4 of the `srt_list`...
#> ℹ [2026-01-22 04:06:16] Use the separate HVF from srt_list
#> ℹ [2026-01-22 04:06:17] Number of available HVF: 2000
#> ℹ [2026-01-22 04:06:17] Finished check
#> ℹ [2026-01-22 04:06:18] Perform Uncorrected integration
#> ℹ [2026-01-22 04:06:19] Perform `Seurat::ScaleData()`
#> ℹ [2026-01-22 04:06:19] Perform linear dimension reduction("pca")
#> ℹ [2026-01-22 04:06:21] Perform Seurat::FindClusters ("louvain")
#> ℹ [2026-01-22 04:06:21] Reorder clusters...
#> ℹ [2026-01-22 04:06:21] Perform nonlinear dimension reduction ("umap")
#> ℹ [2026-01-22 04:06:21] Non-linear dimensionality reduction (umap) using (Uncorrectedpca) dims (1-10) as input
#> ℹ [2026-01-22 04:06:26] Non-linear dimensionality reduction (umap) using (Uncorrectedpca) dims (1-10) as input
#> ✔ [2026-01-22 04:06:32] Run Uncorrected integration done
CellDimPlot(
  srt_ref,
...
#> ℹ [2026-01-22 04:06:33] Use the features to calculate distance metric
#> ℹ [2026-01-22 04:06:33] Data type is log-normalized
#> ℹ [2026-01-22 04:06:34] Data type is log-normalized
#> ℹ [2026-01-22 04:06:34] Use 2000 features to calculate distance
#> ℹ [2026-01-22 04:06:34] Use raw method to find neighbors
#> ℹ [2026-01-22 04:06:34] Running UMAP projection
ProjectionPlot(
  srt_query = srt_query,
  srt_ref = srt_ref,
