...
#> ℹ [2026-06-28 08:15:29] Start standard processing workflow...
#> ℹ [2026-06-28 08:15:29] Checking a list of <Seurat>...
#> ! [2026-06-28 08:15:29] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-28 08:15:29] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 08:15:29] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 08:15:29] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 08:15:29] Number of available HVF: 2000
#> ℹ [2026-06-28 08:15:29] Finished check
#> ℹ [2026-06-28 08:15:29] Perform `ScaleData()`
#> ℹ [2026-06-28 08:15:30] Perform pca linear dimension reduction
#> ℹ [2026-06-28 08:15:30] Use stored estimated dimensions 1:27 for Standardpca
#> ℹ [2026-06-28 08:15:31] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 08:15:31] Reorder clusters...
#> ℹ [2026-06-28 08:15:31] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 08:15:31] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-28 08:15:38] Standard processing workflow completed
...
#> ◌ [2026-06-28 08:15:38] Run integration workflow...
#> ℹ [2026-06-28 08:15:39] Split `srt_merge` into `srt_list` by "tech"
#> ℹ [2026-06-28 08:15:40] Checking a list of <Seurat>...
#> ℹ [2026-06-28 08:15:40] Data 1/4 of the `srt_list` has been log-normalized
#> ℹ [2026-06-28 08:15:40] Perform `FindVariableFeatures()` on 1/4 of `srt_list`...
#> ℹ [2026-06-28 08:15:40] Data 2/4 of the `srt_list` has been log-normalized
#> ℹ [2026-06-28 08:15:40] Perform `FindVariableFeatures()` on 2/4 of `srt_list`...
#> ℹ [2026-06-28 08:15:41] Data 3/4 of the `srt_list` has been log-normalized
#> ℹ [2026-06-28 08:15:41] Perform `FindVariableFeatures()` on 3/4 of `srt_list`...
#> ℹ [2026-06-28 08:15:41] Data 4/4 of the `srt_list` has been log-normalized
#> ℹ [2026-06-28 08:15:41] Perform `FindVariableFeatures()` on 4/4 of `srt_list`...
#> ℹ [2026-06-28 08:15:41] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 08:15:42] Number of available HVF: 2000
#> ℹ [2026-06-28 08:15:42] Finished check
#> ℹ [2026-06-28 08:15:42] Perform Uncorrected integration
#> ℹ [2026-06-28 08:15:42] Perform `Seurat::ScaleData()`
#> ℹ [2026-06-28 08:15:42] Perform "pca" linear dimension reduction
#> ! [2026-06-28 08:15:42] Some PCA features are absent from scale.data and will be dropped: "G0S2", "MRC2", "COL18A1", "COL5A3", "NOTCH3", "CRLF1", "PTGR1", "IL11", "LIF", "PDLIM3", "HTRA1", "TFPI2", "NREP", "ENG", "AQP3", "SEMA7A", "NPTX2", "SNAI2", …, "PCDH18", and "SCN11A"
#> ℹ [2026-06-28 08:15:42] Adjust neighbor k from 20 to 20 for small-sample clustering
#> ℹ [2026-06-28 08:15:43] Perform `Seurat::FindClusters()` with "louvain"
#> ℹ [2026-06-28 08:15:43] Reorder clusters...
#> ℹ [2026-06-28 08:15:43] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 08:15:43] Perform umap nonlinear dimension reduction using Uncorrectedpca (1:25)
#> ℹ [2026-06-28 08:15:48] Perform umap nonlinear dimension reduction using Uncorrectedpca (1:25)
#> ℹ [2026-06-28 08:15:53] Perform umap nonlinear dimension reduction using Uncorrectedpca (1:25)
#> ✔ [2026-06-28 08:15:59] Uncorrected integration completed
CellDimPlot(
  srt_ref,
...
#> ℹ [2026-06-28 08:15:59] Use the features to calculate distance metric
#> ℹ [2026-06-28 08:15:59] Data type is log-normalized
#> ℹ [2026-06-28 08:16:00] Data type is log-normalized
#> ℹ [2026-06-28 08:16:00] Use 636 features to calculate distance
#> ℹ [2026-06-28 08:16:00] Use raw method to find neighbors
#> ℹ [2026-06-28 08:16:00] Running UMAP projection
ProjectionPlot(
  srt_query = srt_query,
  srt_ref = srt_ref,
