...
#> ℹ [2025-11-13 12:24:11] Start standard scop workflow...
#> ℹ [2025-11-13 12:24:12] Checking a list of <Seurat> object...
#> ! [2025-11-13 12:24:12] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2025-11-13 12:24:12] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-13 12:24:14] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-13 12:24:15] Use the separate HVF from srt_list
#> ℹ [2025-11-13 12:24:15] Number of available HVF: 2000
#> ℹ [2025-11-13 12:24:15] Finished check
#> ℹ [2025-11-13 12:24:15] Perform `Seurat::ScaleData()`
#> ℹ [2025-11-13 12:24:16] Perform pca linear dimension reduction
#> StandardPC_ 1 
...
#> ℹ [2025-11-13 12:24:17] Perform `Seurat::FindClusters()` with louvain and `cluster_resolution` = 0.6
#> ℹ [2025-11-13 12:24:17] Reorder clusters...
#> ℹ [2025-11-13 12:24:17] Perform umap nonlinear dimension reduction
#> ℹ [2025-11-13 12:24:17] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-13 12:24:17] UMAP will return its model
#> ℹ [2025-11-13 12:24:23] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-13 12:24:23] UMAP will return its model
#> ✔ [2025-11-13 12:24:28] Run scop standard workflow done
...
#> ◌ [2025-11-13 12:24:28] Run Uncorrected integration...
#> ℹ [2025-11-13 12:24:28] Spliting `srt_merge` into `srt_list` by column "tech"...
#> ℹ [2025-11-13 12:24:29] Checking a list of <Seurat> object...
#> ℹ [2025-11-13 12:24:29] Data 1/4 of the `srt_list` has been log-normalized
#> ℹ [2025-11-13 12:24:29] Perform `Seurat::FindVariableFeatures()` on the data 1/4 of the `srt_list`...
#> ℹ [2025-11-13 12:24:30] Data 2/4 of the `srt_list` has been log-normalized
#> ℹ [2025-11-13 12:24:30] Perform `Seurat::FindVariableFeatures()` on the data 2/4 of the `srt_list`...
#> ℹ [2025-11-13 12:24:30] Data 3/4 of the `srt_list` has been log-normalized
#> ℹ [2025-11-13 12:24:30] Perform `Seurat::FindVariableFeatures()` on the data 3/4 of the `srt_list`...
#> ℹ [2025-11-13 12:24:31] Data 4/4 of the `srt_list` has been log-normalized
#> ℹ [2025-11-13 12:24:31] Perform `Seurat::FindVariableFeatures()` on the data 4/4 of the `srt_list`...
#> ℹ [2025-11-13 12:24:31] Use the separate HVF from srt_list
#> ℹ [2025-11-13 12:24:32] Number of available HVF: 2000
#> ℹ [2025-11-13 12:24:32] Finished check
#> ℹ [2025-11-13 12:24:33] Perform Uncorrected integration
#> ℹ [2025-11-13 12:24:34] Perform `Seurat::ScaleData()`
#> ℹ [2025-11-13 12:24:34] Perform linear dimension reduction("pca")
#> ℹ [2025-11-13 12:24:36] Perform FindClusters ("louvain")
#> ℹ [2025-11-13 12:24:36] Reorder clusters...
#> ℹ [2025-11-13 12:24:36] Perform nonlinear dimension reduction ("umap")
#> ℹ [2025-11-13 12:24:36] Non-linear dimensionality reduction (umap) using (Uncorrectedpca) dims (1-10) as input
#> ℹ [2025-11-13 12:24:41] Non-linear dimensionality reduction (umap) using (Uncorrectedpca) dims (1-10) as input
#> ✔ [2025-11-13 12:24:49] Run Uncorrected integration done
CellDimPlot(
  srt_ref,
...
#> ℹ [2025-11-13 12:24:50] Use the features to calculate distance metric
#> ℹ [2025-11-13 12:24:50] Data type is log-normalized
#> ℹ [2025-11-13 12:24:51] Data type is log-normalized
#> ℹ [2025-11-13 12:24:51] Use 2000 features to calculate distance
#> ℹ [2025-11-13 12:24:51] Use raw method to find neighbors
#> ℹ [2025-11-13 12:24:51] Running UMAP projection
ProjectionPlot(
  srt_query = srt_query,
  srt_ref = srt_ref,
