...
#> ℹ [2026-01-29 13:26:08] Start standard scop workflow...
#> ℹ [2026-01-29 13:26:08] Checking a list of <Seurat>...
#> ! [2026-01-29 13:26:08] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-01-29 13:26:08] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-29 13:26:11] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-29 13:26:11] Use the separate HVF from srt_list
#> ℹ [2026-01-29 13:26:11] Number of available HVF: 2000
#> ℹ [2026-01-29 13:26:12] Finished check
#> ℹ [2026-01-29 13:26:12] Perform `Seurat::ScaleData()`
#> ℹ [2026-01-29 13:26:12] Perform pca linear dimension reduction
#> ℹ [2026-01-29 13:26:14] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-01-29 13:26:14] Reorder clusters...
#> ℹ [2026-01-29 13:26:14] Perform umap nonlinear dimension reduction
#> ℹ [2026-01-29 13:26:14] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2026-01-29 13:26:19] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ✔ [2026-01-29 13:26:24] Run scop standard workflow completed
...
#> ◌ [2026-01-29 13:26:24] Run Uncorrected integration...
#> ℹ [2026-01-29 13:26:24] Spliting `srt_merge` into `srt_list` by column "tech"...
#> ℹ [2026-01-29 13:26:25] Checking a list of <Seurat>...
#> ℹ [2026-01-29 13:26:25] Data 1/4 of the `srt_list` has been log-normalized
#> ℹ [2026-01-29 13:26:25] Perform `Seurat::FindVariableFeatures()` on the data 1/4 of the `srt_list`...
#> ℹ [2026-01-29 13:26:26] Data 2/4 of the `srt_list` has been log-normalized
#> ℹ [2026-01-29 13:26:26] Perform `Seurat::FindVariableFeatures()` on the data 2/4 of the `srt_list`...
#> ℹ [2026-01-29 13:26:26] Data 3/4 of the `srt_list` has been log-normalized
#> ℹ [2026-01-29 13:26:26] Perform `Seurat::FindVariableFeatures()` on the data 3/4 of the `srt_list`...
#> ℹ [2026-01-29 13:26:27] Data 4/4 of the `srt_list` has been log-normalized
#> ℹ [2026-01-29 13:26:27] Perform `Seurat::FindVariableFeatures()` on the data 4/4 of the `srt_list`...
#> ℹ [2026-01-29 13:26:27] Use the separate HVF from srt_list
#> ℹ [2026-01-29 13:26:28] Number of available HVF: 2000
#> ℹ [2026-01-29 13:26:28] Finished check
#> ℹ [2026-01-29 13:26:29] Perform Uncorrected integration
#> ℹ [2026-01-29 13:26:30] Perform `Seurat::ScaleData()`
#> ℹ [2026-01-29 13:26:30] Perform linear dimension reduction("pca")
#> ℹ [2026-01-29 13:26:33] Perform Seurat::FindClusters ("louvain")
#> ℹ [2026-01-29 13:26:33] Reorder clusters...
#> ℹ [2026-01-29 13:26:33] Perform nonlinear dimension reduction ("umap")
#> ℹ [2026-01-29 13:26:33] Non-linear dimensionality reduction (umap) using (Uncorrectedpca) dims (1-10) as input
#> ℹ [2026-01-29 13:26:38] Non-linear dimensionality reduction (umap) using (Uncorrectedpca) dims (1-10) as input
#> ✔ [2026-01-29 13:26:44] Run Uncorrected integration done
CellDimPlot(
  srt_ref,
...
#> ℹ [2026-01-29 13:26:44] Use the features to calculate distance metric
#> ℹ [2026-01-29 13:26:44] Data type is log-normalized
#> ℹ [2026-01-29 13:26:45] Data type is log-normalized
#> ℹ [2026-01-29 13:26:45] Use 2000 features to calculate distance
#> ℹ [2026-01-29 13:26:45] Use raw method to find neighbors
#> ℹ [2026-01-29 13:26:46] Running UMAP projection
ProjectionPlot(
  srt_query = srt_query,
  srt_ref = srt_ref,
