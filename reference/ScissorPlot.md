...
#> ℹ [2026-05-23 15:08:51] Build a temporary Scissor-style SNN graph
#> ℹ [2026-05-23 15:08:57] Scissor alpha 0.2 selected 4 positive and 444 negative cells (28%)
#> ✔ [2026-05-23 15:08:57] Scissor stored 4 Scissor+ and 444 Scissor- cells
panc8_sub <- standard_scop(panc8_sub, verbose = FALSE)
#> ℹ [2026-05-23 15:09:01] Skip `log1p()` because `layer = data` is not "counts"
