...
#> ℹ [2026-04-03 03:21:36] Start standard processing workflow...
#> ℹ [2026-04-03 03:21:37] Checking a list of <Seurat>...
#> ! [2026-04-03 03:21:37] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-04-03 03:21:37] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 03:21:39] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 03:21:39] Use the separate HVF from `srt_list`
#> ℹ [2026-04-03 03:21:40] Number of available HVF: 2000
#> ℹ [2026-04-03 03:21:40] Finished check
#> ℹ [2026-04-03 03:21:40] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-03 03:21:40] Perform pca linear dimension reduction
#> ℹ [2026-04-03 03:21:41] Use stored estimated dimensions 1:12 for Standardpca
#> ℹ [2026-04-03 03:21:41] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-03 03:21:41] Reorder clusters...
#> ℹ [2026-04-03 03:21:41] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-03 03:21:41] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-03 03:21:41] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ℹ [2026-04-03 03:21:45] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ✔ [2026-04-03 03:21:48] Standard processing workflow completed
pancreas_sub <- RunDEtest(
  pancreas_sub,
  group.by = "CellType",
  only.pos = FALSE
)
#> ℹ [2026-04-03 03:21:49] Data type is log-normalized
#> ℹ [2026-04-03 03:21:49] Start differential expression test
#> ℹ [2026-04-03 03:21:49] Find all markers(wilcox) among [1] 5 groups...
#> ℹ [2026-04-03 03:21:49] Using 1 core
#> ⠙ [2026-04-03 03:21:49] Running for Ductal [1/5] ■■■■■■■                       …
#> ✔ [2026-04-03 03:21:49] Completed 5 tasks in 898ms
#> 
#> ℹ [2026-04-03 03:21:49] Building results
#> ✔ [2026-04-03 03:21:50] Differential expression test completed
DEtestRingPlot(
  pancreas_sub,
  group.by = "CellType"
)
