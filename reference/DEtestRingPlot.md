...
#> ℹ [2026-06-28 04:09:10] Start standard processing workflow...
#> ℹ [2026-06-28 04:09:10] Checking a list of <Seurat>...
#> ! [2026-06-28 04:09:10] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-28 04:09:10] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 04:09:10] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 04:09:10] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 04:09:11] Number of available HVF: 2000
#> ℹ [2026-06-28 04:09:11] Finished check
#> ℹ [2026-06-28 04:09:11] Perform `ScaleData()`
#> ℹ [2026-06-28 04:09:11] Perform pca linear dimension reduction
#> ℹ [2026-06-28 04:09:12] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-28 04:09:12] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 04:09:12] Reorder clusters...
#> ℹ [2026-06-28 04:09:12] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 04:09:12] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-28 04:09:18] Standard processing workflow completed
pancreas_sub <- RunDEtest(
  pancreas_sub,
  group.by = "CellType",
  only.pos = FALSE
)
#> ℹ [2026-06-28 04:09:19] Data type is log-normalized
#> ℹ [2026-06-28 04:09:19] Start differential expression test
#> ℹ [2026-06-28 04:09:19] Find all markers(wilcox) among [1] 5 groups...
#> ℹ [2026-06-28 04:09:19] Using 1 core
#> ⠙ [2026-06-28 04:09:19] Running for Ductal [1/5] ■■          20% | ETA:  0s
#> ✔ [2026-06-28 04:09:19] Completed 5 tasks in 517ms
#> 
#> ℹ [2026-06-28 04:09:19] Building results
#> ✔ [2026-06-28 04:09:19] Differential expression test completed
DEtestRingPlot(
  pancreas_sub,
  group.by = "CellType"
)
