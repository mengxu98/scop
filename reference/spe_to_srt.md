...
and spatial coordinates as metadata columns. SCOP display exports are
inverted to raw coordinates using their saved transform. External
SpatialExperiment coordinates without SCOP provenance are treated as raw
coordinates in their supplied units. Original import provenance is
retained in `object@misc$spatial_coordinate_import`.
