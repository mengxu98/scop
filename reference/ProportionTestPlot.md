...
#> ℹ [2026-06-24 03:53:38] Start standard processing workflow...
#> ℹ [2026-06-24 03:53:39] Checking a list of <Seurat>...
#> ! [2026-06-24 03:53:39] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-24 03:53:39] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-24 03:53:39] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-24 03:53:39] Use the separate HVF from `srt_list`
#> ℹ [2026-06-24 03:53:39] Number of available HVF: 2000
#> ℹ [2026-06-24 03:53:39] Finished check
#> ℹ [2026-06-24 03:53:39] Perform `ScaleData()`
#> ℹ [2026-06-24 03:53:39] Perform pca linear dimension reduction
#> ℹ [2026-06-24 03:53:40] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-24 03:53:40] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-24 03:53:40] Reorder clusters...
#> ℹ [2026-06-24 03:53:40] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-24 03:53:40] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-24 03:53:47] Standard processing workflow completed
...
#> ℹ [2026-06-24 03:53:47] Start proportion test ("permutation")
#> ℹ [2026-06-24 03:53:47] Running comparison: "S" vs "G1"
#> ℹ [2026-06-24 03:53:48] Running comparison: "G2M" vs "G1"
#> ℹ [2026-06-24 03:53:51] Running comparison: "G2M" vs "S"
#> ℹ [2026-06-24 03:53:51] Running comparison: "G1" vs "S"
#> ℹ [2026-06-24 03:53:51] Running comparison: "G1" vs "G2M"
#> ℹ [2026-06-24 03:53:51] Running comparison: "S" vs "G2M"
#> ✔ [2026-06-24 03:53:51] Proportion test completed ("permutation")
