...
- comparison:
  ...
  Which comparison to plot. If `NULL`, plots all comparisons.
...
- xlab:
  ...
  X-axis label. For `plot_type = "umap"`, this is forwarded to the
  projection plot when set.

- ylab:

  Y-axis label. For `plot_type = "umap"`, this is forwarded to the
  projection plot when set.
