...
#> ℹ [2026-06-26 11:36:22] Start standard processing workflow...
#> ℹ [2026-06-26 11:36:23] Checking a list of <Seurat>...
#> ! [2026-06-26 11:36:23] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-26 11:36:23] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-26 11:36:23] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-26 11:36:23] Use the separate HVF from `srt_list`
#> ℹ [2026-06-26 11:36:23] Number of available HVF: 2000
#> ℹ [2026-06-26 11:36:23] Finished check
#> ℹ [2026-06-26 11:36:23] Perform `ScaleData()`
#> ℹ [2026-06-26 11:36:23] Perform pca linear dimension reduction
#> ℹ [2026-06-26 11:36:24] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-26 11:36:24] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-26 11:36:24] Reorder clusters...
#> ℹ [2026-06-26 11:36:24] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-26 11:36:24] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-26 11:36:32] Standard processing workflow completed
pancreas_sub <- RunCellQC(
  pancreas_sub,
  db_method = "scds_cxds"
)
#> ◌ [2026-06-26 11:36:32] Running cell-level quality control
#> ℹ [2026-06-26 11:36:32] Data type is raw counts
#> ℹ [2026-06-26 11:36:32] Running scds with method "cxds"
#> Registered S3 method overwritten by 'pROC':
#>   method   from            
#>   plot.roc spatstat.explore
#> ! [2026-06-26 11:36:54] Skip "atac" QC because `assay = 'RNA'` is not a <ChromatinAssay>
#> ℹ [2026-06-26 11:36:54] Running decontX
...
#> See help("Deprecated")
#> ℹ [2026-06-26 11:40:15] decontX contamination (median/mean/max): 0.0136 / 0.1628 / 0.7465
#> ℹ [2026-06-26 11:40:15] decontX assay stored as decontXcounts
#> ✔ [2026-06-26 11:40:15] decontX decontamination completed
#> ✔ [2026-06-26 11:40:15] ● Total cells: 1000
#> ✔                       ◉ 967 cells remained
...
#> ! [2026-06-26 11:40:16] `stat_type` is forcibly set to "count" when plot "sankey", "chord", "venn", and "upset"
