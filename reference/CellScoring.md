...
#> ℹ [2026-04-06 03:57:02] Start standard processing workflow...
#> ℹ [2026-04-06 03:57:03] Checking a list of <Seurat>...
#> ! [2026-04-06 03:57:03] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-04-06 03:57:03] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-04-06 03:57:04] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-06 03:57:05] Use the separate HVF from `srt_list`
#> ℹ [2026-04-06 03:57:05] Number of available HVF: 2000
#> ℹ [2026-04-06 03:57:05] Finished check
#> ℹ [2026-04-06 03:57:05] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-06 03:57:06] Perform pca linear dimension reduction
#> ℹ [2026-04-06 03:57:06] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-04-06 03:57:07] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-06 03:57:07] Reorder clusters...
#> ℹ [2026-04-06 03:57:07] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-06 03:57:07] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-06 03:57:07] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-04-06 03:57:10] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-04-06 03:57:13] Standard processing workflow completed
...
#> ℹ [2026-04-06 03:57:13] Start cell scoring
#> ℹ [2026-04-06 03:57:13] Data type is log-normalized
#> ℹ [2026-04-06 03:57:13] Number of feature lists to be scored: 2
#> ℹ [2026-04-06 03:57:13] Using 1 core
#> ⠙ [2026-04-06 03:57:13] Running for 1 [1/2] ■■■■■       50% | ETA:  0s
#> ✔ [2026-04-06 03:57:13] Completed 2 tasks in 176ms
#> 
#> ℹ [2026-04-06 03:57:13] Building results
#> ✔ [2026-04-06 03:57:14] Cell scoring completed
