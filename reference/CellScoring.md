...
#> ℹ [2026-04-03 08:55:15] Start standard processing workflow...
#> ℹ [2026-04-03 08:55:15] Checking a list of <Seurat>...
#> ! [2026-04-03 08:55:15] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-04-03 08:55:15] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 08:55:17] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 08:55:17] Use the separate HVF from `srt_list`
#> ℹ [2026-04-03 08:55:18] Number of available HVF: 2000
#> ℹ [2026-04-03 08:55:18] Finished check
#> ℹ [2026-04-03 08:55:18] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-03 08:55:18] Perform pca linear dimension reduction
#> ℹ [2026-04-03 08:55:19] Use stored estimated dimensions 1:12 for Standardpca
#> ℹ [2026-04-03 08:55:19] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-03 08:55:19] Reorder clusters...
#> ℹ [2026-04-03 08:55:19] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-03 08:55:19] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-03 08:55:19] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ℹ [2026-04-03 08:55:23] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ✔ [2026-04-03 08:55:26] Standard processing workflow completed
...
#> ℹ [2026-04-03 08:55:26] Start cell scoring
#> ℹ [2026-04-03 08:55:26] Data type is log-normalized
#> ℹ [2026-04-03 08:55:26] Number of feature lists to be scored: 2
#> ℹ [2026-04-03 08:55:26] Using 1 core
#> ⠙ [2026-04-03 08:55:26] Running for 1 [1/2] ■■■■■       50% | ETA:  0s
#> ✔ [2026-04-03 08:55:26] Completed 2 tasks in 136ms
#> 
#> ℹ [2026-04-03 08:55:26] Building results
#> ✔ [2026-04-03 08:55:26] Cell scoring completed
