...
#> ℹ [2026-05-11 15:51:59] Start standard processing workflow...
#> ℹ [2026-05-11 15:52:00] Checking a list of <Seurat>...
#> ! [2026-05-11 15:52:00] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-11 15:52:00] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-11 15:52:02] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-11 15:52:02] Use the separate HVF from `srt_list`
#> ℹ [2026-05-11 15:52:02] Number of available HVF: 2000
#> ℹ [2026-05-11 15:52:03] Finished check
#> ℹ [2026-05-11 15:52:03] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-11 15:52:03] Perform pca linear dimension reduction
#> ℹ [2026-05-11 15:52:03] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-11 15:52:04] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-11 15:52:04] Reorder clusters...
#> ℹ [2026-05-11 15:52:04] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-11 15:52:04] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-11 15:52:04] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-11 15:52:09] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-11 15:52:13] Standard processing workflow completed
pancreas_sub <- RunDecontX(
  pancreas_sub,
  group.by = "CellType"
)
#> ℹ [2026-05-11 15:52:13] Running decontX
#> ℹ [2026-05-11 15:52:14] Data type is raw counts
...
#> See help("Deprecated")
#> ℹ [2026-05-11 15:52:25] decontX contamination (median/mean/max): 0.0272 / 0.0875 / 0.6737
#> ℹ [2026-05-11 15:52:25] decontX assay stored as decontXcounts
#> ✔ [2026-05-11 15:52:25] decontX decontamination completed
