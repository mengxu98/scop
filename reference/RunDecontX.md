...
#> ℹ [2026-05-12 04:45:59] Start standard processing workflow...
#> ℹ [2026-05-12 04:46:00] Checking a list of <Seurat>...
#> ! [2026-05-12 04:46:00] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-12 04:46:00] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-12 04:46:02] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-12 04:46:02] Use the separate HVF from `srt_list`
#> ℹ [2026-05-12 04:46:02] Number of available HVF: 2000
#> ℹ [2026-05-12 04:46:02] Finished check
#> ℹ [2026-05-12 04:46:02] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-12 04:46:03] Perform pca linear dimension reduction
#> ℹ [2026-05-12 04:46:03] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-12 04:46:04] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-12 04:46:04] Reorder clusters...
#> ℹ [2026-05-12 04:46:04] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-12 04:46:04] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-12 04:46:04] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-12 04:46:09] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-12 04:46:13] Standard processing workflow completed
pancreas_sub <- RunDecontX(
  pancreas_sub,
  group.by = "CellType"
)
#> ℹ [2026-05-12 04:46:13] Running decontX
#> ℹ [2026-05-12 04:46:14] Data type is raw counts
...
#> See help("Deprecated")
#> ℹ [2026-05-12 04:46:25] decontX contamination (median/mean/max): 0.0272 / 0.0875 / 0.6737
#> ℹ [2026-05-12 04:46:26] decontX assay stored as decontXcounts
#> ✔ [2026-05-12 04:46:26] decontX decontamination completed
