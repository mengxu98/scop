...
#> ℹ [2026-04-03 09:49:49] Start standard processing workflow...
#> ℹ [2026-04-03 09:49:49] Checking a list of <Seurat>...
#> ! [2026-04-03 09:49:49] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-04-03 09:49:49] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 09:49:52] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 09:49:52] Use the separate HVF from `srt_list`
#> ℹ [2026-04-03 09:49:52] Number of available HVF: 2000
#> ℹ [2026-04-03 09:49:52] Finished check
#> ℹ [2026-04-03 09:49:53] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-03 09:49:53] Perform pca linear dimension reduction
#> ℹ [2026-04-03 09:49:53] Use stored estimated dimensions 1:12 for Standardpca
#> ℹ [2026-04-03 09:49:54] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-03 09:49:54] Reorder clusters...
#> ℹ [2026-04-03 09:49:54] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-03 09:49:54] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-03 09:49:54] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ℹ [2026-04-03 09:49:59] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ✔ [2026-04-03 09:50:03] Standard processing workflow completed
#> ◌ [2026-04-03 09:50:03] Running CytoTRACE2
...
#> cytotrace2: Finished
#> ✔ [2026-04-03 09:51:11] CytoTRACE2 computed successfully
```
