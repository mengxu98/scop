...
#> ℹ [2026-02-27 18:16:39] Start standard scop workflow...
#> ℹ [2026-02-27 18:16:40] Checking a list of <Seurat>...
#> ! [2026-02-27 18:16:40] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-02-27 18:16:40] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2026-02-27 18:16:42] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2026-02-27 18:16:42] Use the separate HVF from srt_list
#> ℹ [2026-02-27 18:16:42] Number of available HVF: 2000
#> ℹ [2026-02-27 18:16:43] Finished check
#> ℹ [2026-02-27 18:16:43] Perform `Seurat::ScaleData()`
#> ℹ [2026-02-27 18:16:43] Perform pca linear dimension reduction
#> ℹ [2026-02-27 18:16:44] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-02-27 18:16:44] Reorder clusters...
#> ℹ [2026-02-27 18:16:44] Perform umap nonlinear dimension reduction
#> ℹ [2026-02-27 18:16:44] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2026-02-27 18:16:48] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ✔ [2026-02-27 18:16:52] Run scop standard workflow completed
#> ◌ [2026-02-27 18:16:52] Running CytoTRACE2
...
#> cytotrace2: Finished
#> ✔ [2026-02-27 18:17:53] CytoTRACE2 computed successfully
```
