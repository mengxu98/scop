...
#> ℹ [2026-05-25 07:55:57] Start standard processing workflow...
#> ℹ [2026-05-25 07:55:58] Checking a list of <Seurat>...
#> ! [2026-05-25 07:55:58] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-25 07:55:58] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-25 07:56:00] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-25 07:56:00] Use the separate HVF from `srt_list`
#> ℹ [2026-05-25 07:56:00] Number of available HVF: 2000
#> ℹ [2026-05-25 07:56:00] Finished check
#> ℹ [2026-05-25 07:56:00] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-25 07:56:01] Perform pca linear dimension reduction
#> ℹ [2026-05-25 07:56:01] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-05-25 07:56:02] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-25 07:56:02] Reorder clusters...
#> ℹ [2026-05-25 07:56:02] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-25 07:56:02] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-25 07:56:02] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ℹ [2026-05-25 07:56:06] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ✔ [2026-05-25 07:56:11] Standard processing workflow completed
pancreas_sub <- RunCytoTRACE(
  pancreas_sub,
  species = "Mus_musculus"
)
#> ◌ [2026-05-25 07:56:11] Running CytoTRACE2
#> ℹ [2026-05-25 07:56:11] Extracting expression matrix from `assay = RNA, layer = counts`
#> ℹ [2026-05-25 07:56:11] Loading model from /home/runner/.local/share/R/scop/CytoTRACE2
#> ℹ [2026-05-25 07:56:14] Dataset contains 15998 genes and 1000 cells.
#> ℹ [2026-05-25 07:56:14] Running on 1 subsample(s)
#> ℹ [2026-05-25 07:56:14] Preprocessing subsample (1000 cells)
#> ℹ [2026-05-25 07:56:14] 12486 input genes mapped to model genes.
#> ℹ [2026-05-25 07:56:16] Running ensemble prediction and postprocessing
#> ℹ [2026-05-25 07:56:16] Computing PCA for kNN smoothing
#> ✔ [2026-05-25 07:57:06] CytoTRACE2 computed successfully
