...
#> ℹ [2026-05-23 11:49:44] Start standard processing workflow...
#> ℹ [2026-05-23 11:49:45] Checking a list of <Seurat>...
#> ! [2026-05-23 11:49:45] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-23 11:49:45] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-23 11:49:47] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-23 11:49:48] Use the separate HVF from `srt_list`
#> ℹ [2026-05-23 11:49:48] Number of available HVF: 2000
#> ℹ [2026-05-23 11:49:48] Finished check
#> ℹ [2026-05-23 11:49:48] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-23 11:49:48] Perform pca linear dimension reduction
#> ℹ [2026-05-23 11:49:49] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-05-23 11:49:49] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-23 11:49:49] Reorder clusters...
#> ℹ [2026-05-23 11:49:49] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-23 11:49:49] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-23 11:49:49] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ℹ [2026-05-23 11:49:54] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ✔ [2026-05-23 11:49:59] Standard processing workflow completed
...
#> ℹ [2026-05-23 11:49:59] Running PAGA with `backend = 'cpp'` using 29 neighbors
#> ✔ [2026-05-23 11:49:59] PAGA cpp backend completed
CellDimPlot(
  pancreas_sub,
  group.by = "SubCellType",
  reduction = "UMAP"
