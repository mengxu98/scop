...
#> ℹ [2026-05-23 14:50:05] Start standard processing workflow...
#> ℹ [2026-05-23 14:50:06] Checking a list of <Seurat>...
#> ! [2026-05-23 14:50:06] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-23 14:50:06] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-23 14:50:08] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-23 14:50:08] Use the separate HVF from `srt_list`
#> ℹ [2026-05-23 14:50:09] Number of available HVF: 2000
#> ℹ [2026-05-23 14:50:09] Finished check
#> ℹ [2026-05-23 14:50:09] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-23 14:50:09] Perform pca linear dimension reduction
#> ℹ [2026-05-23 14:50:09] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-05-23 14:50:10] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-23 14:50:10] Reorder clusters...
#> ℹ [2026-05-23 14:50:10] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-23 14:50:10] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-23 14:50:10] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ℹ [2026-05-23 14:50:16] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ✔ [2026-05-23 14:50:21] Standard processing workflow completed
...
#> ℹ [2026-05-23 14:50:21] Running PAGA with `backend = 'cpp'` using 29 neighbors
#> ✔ [2026-05-23 14:50:21] PAGA cpp backend completed
CellDimPlot(
  pancreas_sub,
  group.by = "SubCellType",
  reduction = "UMAP"
