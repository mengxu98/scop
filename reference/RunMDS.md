...
#> ℹ [2026-01-27 08:21:42] Start standard scop workflow...
#> ℹ [2026-01-27 08:21:43] Checking a list of <Seurat>...
#> ! [2026-01-27 08:21:43] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-01-27 08:21:43] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-27 08:21:45] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-27 08:21:45] Use the separate HVF from srt_list
#> ℹ [2026-01-27 08:21:46] Number of available HVF: 2000
#> ℹ [2026-01-27 08:21:46] Finished check
#> ℹ [2026-01-27 08:21:46] Perform `Seurat::ScaleData()`
#> ℹ [2026-01-27 08:21:46] Perform pca linear dimension reduction
#> ℹ [2026-01-27 08:21:47] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-01-27 08:21:47] Reorder clusters...
#> ℹ [2026-01-27 08:21:48] Perform umap nonlinear dimension reduction
#> ℹ [2026-01-27 08:21:48] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2026-01-27 08:21:52] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
