...
- optimizeALS_params:
  ...
  A list of parameters for the rliger::runIntegration function. Default
  is [`list()`](https://rdrr.io/r/base/list.html).

- quantilenorm_params:

  A list of parameters for the rliger::quantileNorm function. Default is
...
#> ℹ [2026-04-02 16:29:04] Split `srt_merge` into `srt_list` by "tech"
#> ℹ [2026-04-02 16:29:04] Checking a list of <Seurat>...
#> ! [2026-04-02 16:29:04] Data 1/5 of the `srt_list` is "unknown"
#> ℹ [2026-04-02 16:29:04] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/5 of `srt_list`...
#> ℹ [2026-04-02 16:29:05] Perform `Seurat::FindVariableFeatures()` on 1/5 of `srt_list`...
#> ! [2026-04-02 16:29:06] Data 2/5 of the `srt_list` is "unknown"
#> ℹ [2026-04-02 16:29:06] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 2/5 of `srt_list`...
#> ℹ [2026-04-02 16:29:07] Perform `Seurat::FindVariableFeatures()` on 2/5 of `srt_list`...
#> ! [2026-04-02 16:29:07] Data 3/5 of the `srt_list` is "unknown"
#> ℹ [2026-04-02 16:29:07] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 3/5 of `srt_list`...
#> ℹ [2026-04-02 16:29:08] Perform `Seurat::FindVariableFeatures()` on 3/5 of `srt_list`...
#> ! [2026-04-02 16:29:08] Data 4/5 of the `srt_list` is "unknown"
#> ℹ [2026-04-02 16:29:08] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 4/5 of `srt_list`...
#> ℹ [2026-04-02 16:29:10] Perform `Seurat::FindVariableFeatures()` on 4/5 of `srt_list`...
#> ! [2026-04-02 16:29:10] Data 5/5 of the `srt_list` is "unknown"
#> ℹ [2026-04-02 16:29:10] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 5/5 of `srt_list`...
#> ℹ [2026-04-02 16:29:11] Perform `Seurat::FindVariableFeatures()` on 5/5 of `srt_list`...
#> ℹ [2026-04-02 16:29:11] Use the separate HVF from `srt_list`
#> ℹ [2026-04-02 16:29:12] Number of available HVF: 2000
#> ℹ [2026-04-02 16:29:12] Finished check
#> Warning: Layer ‘ligerScaleData’ is empty
#> ℹ [2026-04-02 16:29:17] Prepare rliger layer "ligerScaleData" ...
