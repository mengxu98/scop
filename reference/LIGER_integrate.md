...
#> ℹ [2026-05-12 14:56:09] Split `srt_merge` into `srt_list` by "tech"
#> ℹ [2026-05-12 14:56:10] Checking a list of <Seurat>...
#> ! [2026-05-12 14:56:10] Data 1/5 of the `srt_list` is "unknown"
#> ℹ [2026-05-12 14:56:10] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/5 of `srt_list`...
#> ℹ [2026-05-12 14:56:12] Perform `Seurat::FindVariableFeatures()` on 1/5 of `srt_list`...
#> ! [2026-05-12 14:56:12] Data 2/5 of the `srt_list` is "unknown"
#> ℹ [2026-05-12 14:56:12] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 2/5 of `srt_list`...
#> ℹ [2026-05-12 14:56:14] Perform `Seurat::FindVariableFeatures()` on 2/5 of `srt_list`...
#> ! [2026-05-12 14:56:14] Data 3/5 of the `srt_list` is "unknown"
#> ℹ [2026-05-12 14:56:14] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 3/5 of `srt_list`...
#> ℹ [2026-05-12 14:56:16] Perform `Seurat::FindVariableFeatures()` on 3/5 of `srt_list`...
#> ! [2026-05-12 14:56:16] Data 4/5 of the `srt_list` is "unknown"
#> ℹ [2026-05-12 14:56:16] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 4/5 of `srt_list`...
#> ℹ [2026-05-12 14:56:18] Perform `Seurat::FindVariableFeatures()` on 4/5 of `srt_list`...
#> ! [2026-05-12 14:56:18] Data 5/5 of the `srt_list` is "unknown"
#> ℹ [2026-05-12 14:56:18] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 5/5 of `srt_list`...
#> ℹ [2026-05-12 14:56:20] Perform `Seurat::FindVariableFeatures()` on 5/5 of `srt_list`...
#> ℹ [2026-05-12 14:56:20] Use the separate HVF from `srt_list`
#> ℹ [2026-05-12 14:56:21] Number of available HVF: 2000
#> ℹ [2026-05-12 14:56:21] Finished check
#> Warning: Layer ‘ligerScaleData’ is empty
#> ℹ [2026-05-12 14:56:24] Prepare rliger layer "ligerScaleData" ...
#> ℹ [2026-05-12 14:56:24] Perform LIGER integration
#> ℹ [2026-05-12 14:56:32] Adjust neighbor k from 20 to 20 for small-sample clustering
#> ℹ [2026-05-12 14:56:33] Perform `Seurat::FindClusters()` with "louvain"
#> ℹ [2026-05-12 14:56:33] Reorder clusters...
#> ℹ [2026-05-12 14:56:34] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-12 14:56:34] Perform umap nonlinear dimension reduction using LIGER (1:20)
#> ℹ [2026-05-12 14:56:40] Perform umap nonlinear dimension reduction using LIGER (1:20)
CellDimPlot(
  panc8_sub,
