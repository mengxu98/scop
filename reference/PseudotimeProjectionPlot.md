...
#> ℹ [2026-06-28 07:48:20] Start standard processing workflow...
#> ℹ [2026-06-28 07:48:21] Checking a list of <Seurat>...
#> ! [2026-06-28 07:48:21] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-28 07:48:21] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 07:48:21] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 07:48:21] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 07:48:21] Number of available HVF: 2000
#> ℹ [2026-06-28 07:48:22] Finished check
#> ℹ [2026-06-28 07:48:22] Perform `ScaleData()`
#> ℹ [2026-06-28 07:48:22] Perform pca linear dimension reduction
#> ℹ [2026-06-28 07:48:22] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-28 07:48:22] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 07:48:22] Reorder clusters...
#> ℹ [2026-06-28 07:48:23] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 07:48:23] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-28 07:48:28] Standard processing workflow completed
...
#> ! [2026-06-28 07:48:31] Removed 328 cells with NA pseudotime values
...
#> ! [2026-06-28 07:48:31] Removed 328 cells with NA pseudotime values
#> ℹ [2026-06-28 07:48:31] Computing KNN graph from embedding...
...
#> ! [2026-06-28 07:48:33] Removed 244 cells with NA pseudotime values
#> ℹ [2026-06-28 07:48:33] Computing KNN graph from embedding...
...
#> ! [2026-06-28 07:48:35] Removed 328 cells with NA pseudotime values
```
