...
#> ℹ [2026-04-21 07:16:57] Start standard processing workflow...
#> ℹ [2026-04-21 07:16:57] Checking a list of <Seurat>...
#> ! [2026-04-21 07:16:57] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-04-21 07:16:57] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-04-21 07:16:59] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-21 07:17:00] Use the separate HVF from `srt_list`
#> ℹ [2026-04-21 07:17:00] Number of available HVF: 2000
#> ℹ [2026-04-21 07:17:00] Finished check
#> ℹ [2026-04-21 07:17:00] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-21 07:17:01] Perform pca linear dimension reduction
#> ℹ [2026-04-21 07:17:01] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-04-21 07:17:02] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-21 07:17:02] Reorder clusters...
#> ℹ [2026-04-21 07:17:02] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-21 07:17:02] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-21 07:17:02] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-04-21 07:17:06] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-04-21 07:17:10] Standard processing workflow completed
...
#> ! [2026-04-21 07:17:12] Removed 339 cells with NA pseudotime values
...
#> ! [2026-04-21 07:17:16] Removed 339 cells with NA pseudotime values
#> ℹ [2026-04-21 07:17:16] Computing KNN graph from embedding...
...
#> ! [2026-04-21 07:17:28] Removed 185 cells with NA pseudotime values
#> ℹ [2026-04-21 07:17:28] Computing KNN graph from embedding...
...
#> ! [2026-04-21 07:17:37] Removed 339 cells with NA pseudotime values
```
