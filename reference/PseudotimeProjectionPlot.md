...
#> ℹ [2026-06-24 18:32:53] Start standard processing workflow...
#> ℹ [2026-06-24 18:32:53] Checking a list of <Seurat>...
#> ! [2026-06-24 18:32:53] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-24 18:32:53] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-24 18:32:54] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-24 18:32:54] Use the separate HVF from `srt_list`
#> ℹ [2026-06-24 18:32:54] Number of available HVF: 2000
#> ℹ [2026-06-24 18:32:54] Finished check
#> ℹ [2026-06-24 18:32:54] Perform `ScaleData()`
#> ℹ [2026-06-24 18:32:54] Perform pca linear dimension reduction
#> ℹ [2026-06-24 18:32:54] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-24 18:32:55] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-24 18:32:55] Reorder clusters...
#> ℹ [2026-06-24 18:32:55] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-24 18:32:55] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-24 18:33:01] Standard processing workflow completed
...
#> ! [2026-06-24 18:33:03] Removed 328 cells with NA pseudotime values
...
#> ! [2026-06-24 18:33:03] Removed 328 cells with NA pseudotime values
#> ℹ [2026-06-24 18:33:03] Computing KNN graph from embedding...
...
#> ! [2026-06-24 18:33:05] Removed 244 cells with NA pseudotime values
#> ℹ [2026-06-24 18:33:05] Computing KNN graph from embedding...
...
#> ! [2026-06-24 18:33:07] Removed 328 cells with NA pseudotime values
```
