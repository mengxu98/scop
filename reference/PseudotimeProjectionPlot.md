...
#> ℹ [2026-06-28 04:36:57] Start standard processing workflow...
#> ℹ [2026-06-28 04:36:58] Checking a list of <Seurat>...
#> ! [2026-06-28 04:36:58] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-28 04:36:58] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 04:36:58] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 04:36:58] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 04:36:58] Number of available HVF: 2000
#> ℹ [2026-06-28 04:36:58] Finished check
#> ℹ [2026-06-28 04:36:58] Perform `ScaleData()`
#> ℹ [2026-06-28 04:36:58] Perform pca linear dimension reduction
#> ℹ [2026-06-28 04:36:59] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-28 04:36:59] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 04:36:59] Reorder clusters...
#> ℹ [2026-06-28 04:37:00] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 04:37:00] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-28 04:37:07] Standard processing workflow completed
...
#> ! [2026-06-28 04:37:08] Removed 328 cells with NA pseudotime values
...
#> ! [2026-06-28 04:37:09] Removed 328 cells with NA pseudotime values
#> ℹ [2026-06-28 04:37:09] Computing KNN graph from embedding...
...
#> ! [2026-06-28 04:37:11] Removed 244 cells with NA pseudotime values
#> ℹ [2026-06-28 04:37:11] Computing KNN graph from embedding...
...
#> ! [2026-06-28 04:37:12] Removed 328 cells with NA pseudotime values
```
