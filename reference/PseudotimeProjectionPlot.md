...
#> ℹ [2026-05-23 08:13:34] Start standard processing workflow...
#> ℹ [2026-05-23 08:13:34] Checking a list of <Seurat>...
#> ! [2026-05-23 08:13:34] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-23 08:13:34] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-23 08:13:36] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-23 08:13:37] Use the separate HVF from `srt_list`
#> ℹ [2026-05-23 08:13:37] Number of available HVF: 2000
#> ℹ [2026-05-23 08:13:37] Finished check
#> ℹ [2026-05-23 08:13:37] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-23 08:13:37] Perform pca linear dimension reduction
#> ℹ [2026-05-23 08:13:38] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-05-23 08:13:38] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-23 08:13:38] Reorder clusters...
#> ℹ [2026-05-23 08:13:38] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-23 08:13:38] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-23 08:13:38] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ℹ [2026-05-23 08:13:44] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ✔ [2026-05-23 08:13:49] Standard processing workflow completed
...
#> ! [2026-05-23 08:13:51] Removed 20 cells with NA pseudotime values
...
#> ! [2026-05-23 08:13:51] Removed 20 cells with NA pseudotime values
#> ℹ [2026-05-23 08:13:51] Computing KNN graph from embedding...
...
#> ! [2026-05-23 08:13:54] Removed 344 cells with NA pseudotime values
#> ℹ [2026-05-23 08:13:54] Computing KNN graph from embedding...
...
#> ! [2026-05-23 08:13:55] Removed 20 cells with NA pseudotime values
```
