...
#> ℹ [2026-04-22 08:32:29] Start standard processing workflow...
#> ℹ [2026-04-22 08:32:29] Checking a list of <Seurat>...
#> ! [2026-04-22 08:32:30] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-04-22 08:32:30] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-04-22 08:32:32] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-22 08:32:32] Use the separate HVF from `srt_list`
#> ℹ [2026-04-22 08:32:32] Number of available HVF: 2000
#> ℹ [2026-04-22 08:32:32] Finished check
#> ℹ [2026-04-22 08:32:33] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-22 08:32:33] Perform pca linear dimension reduction
#> ℹ [2026-04-22 08:32:33] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-04-22 08:32:34] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-22 08:32:34] Reorder clusters...
#> ℹ [2026-04-22 08:32:34] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-22 08:32:34] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-22 08:32:34] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-04-22 08:32:38] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-04-22 08:32:42] Standard processing workflow completed
...
#> ! [2026-04-22 08:32:44] Removed 339 cells with NA pseudotime values
...
#> ! [2026-04-22 08:32:48] Removed 339 cells with NA pseudotime values
#> ℹ [2026-04-22 08:32:48] Computing KNN graph from embedding...
...
#> ! [2026-04-22 08:33:03] Removed 185 cells with NA pseudotime values
#> ℹ [2026-04-22 08:33:03] Computing KNN graph from embedding...
...
#> ! [2026-04-22 08:33:12] Removed 339 cells with NA pseudotime values
```
