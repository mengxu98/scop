...
[`RunCNV()`](https://mengxu98.github.io/scop/reference/RunCNV.md) from
the unified `srt@tools[[tool_name]]` result bundle.
...
- plot_type:
  ...
  returns a hierarchical clustering of cells or CNV clusters.
