...
#> ℹ [2026-05-14 06:06:41] Start standard processing workflow...
#> ℹ [2026-05-14 06:06:42] Checking a list of <Seurat>...
#> ! [2026-05-14 06:06:42] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-14 06:06:42] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-14 06:06:44] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-14 06:06:44] Use the separate HVF from `srt_list`
#> ℹ [2026-05-14 06:06:45] Number of available HVF: 2000
#> ℹ [2026-05-14 06:06:45] Finished check
#> ℹ [2026-05-14 06:06:45] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-14 06:06:45] Perform pca linear dimension reduction
#> ℹ [2026-05-14 06:06:45] Use stored estimated dimensions 1:20 for Standardpca
#> ℹ [2026-05-14 06:06:46] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-14 06:06:46] Reorder clusters...
#> ℹ [2026-05-14 06:06:46] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-14 06:06:46] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-14 06:06:46] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ℹ [2026-05-14 06:06:51] Perform umap nonlinear dimension reduction using Standardpca (1:20)
#> ✔ [2026-05-14 06:06:55] Standard processing workflow completed
FeatureCorPlot(
  pancreas_sub,
