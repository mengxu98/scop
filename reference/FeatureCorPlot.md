...
#> ℹ [2026-04-03 03:37:04] Start standard processing workflow...
#> ℹ [2026-04-03 03:37:05] Checking a list of <Seurat>...
#> ! [2026-04-03 03:37:05] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-04-03 03:37:05] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 03:37:07] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-04-03 03:37:08] Use the separate HVF from `srt_list`
#> ℹ [2026-04-03 03:37:08] Number of available HVF: 2000
#> ℹ [2026-04-03 03:37:08] Finished check
#> ℹ [2026-04-03 03:37:08] Perform `Seurat::ScaleData()`
#> ℹ [2026-04-03 03:37:10] Perform pca linear dimension reduction
#> ℹ [2026-04-03 03:37:10] Use stored estimated dimensions 1:12 for Standardpca
#> ℹ [2026-04-03 03:37:11] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-04-03 03:37:11] Reorder clusters...
#> ℹ [2026-04-03 03:37:11] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-04-03 03:37:11] Perform umap nonlinear dimension reduction
#> ℹ [2026-04-03 03:37:11] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ℹ [2026-04-03 03:37:15] Perform umap nonlinear dimension reduction using Standardpca (1:12)
#> ✔ [2026-04-03 03:37:18] Standard processing workflow completed
FeatureCorPlot(
  pancreas_sub,
