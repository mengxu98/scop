...
#> ℹ [2025-11-19 14:24:29] Start standard scop workflow...
#> ℹ [2025-11-19 14:24:30] Checking a list of <Seurat> object...
#> ! [2025-11-19 14:24:30] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2025-11-19 14:24:30] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-19 14:24:32] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-19 14:24:33] Use the separate HVF from srt_list
#> ℹ [2025-11-19 14:24:33] Number of available HVF: 2000
#> ℹ [2025-11-19 14:24:33] Finished check
#> ℹ [2025-11-19 14:24:33] Perform `Seurat::ScaleData()`
#> ℹ [2025-11-19 14:24:33] Perform pca linear dimension reduction
#> StandardPC_ 1 
...
#> ℹ [2025-11-19 14:24:34] Perform `Seurat::FindClusters()` with louvain and `cluster_resolution` = 0.6
#> ℹ [2025-11-19 14:24:34] Reorder clusters...
#> ℹ [2025-11-19 14:24:34] Perform umap nonlinear dimension reduction
#> ℹ [2025-11-19 14:24:34] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-19 14:24:34] UMAP will return its model
#> ℹ [2025-11-19 14:24:38] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-19 14:24:38] UMAP will return its model
#> ✔ [2025-11-19 14:24:42] Run scop standard workflow done
FeatureCorPlot(
  pancreas_sub,
