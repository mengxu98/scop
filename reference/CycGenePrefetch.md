...
#> ℹ [2026-04-03 03:15:26] Prefetching cell cycle genes for "Homo_sapiens" ...
#> ✔ [2026-04-03 03:15:26] Cell cycle gene prefetching completed "Homo_sapiens"
str(ccgenes)
#> List of 3
#>  $ res: NULL
...
#> ℹ [2026-04-03 03:15:26] Prefetching cell cycle genes for "Mus_musculus" ...
#> ℹ [2026-04-03 03:15:44] Connect to the Ensembl archives...
#> ℹ [2026-04-03 03:15:46] Using the 115 version of ensembl database...
#> ℹ [2026-04-03 03:15:46] Downloading the ensembl database from https://sep2025.archive.ensembl.org...
#> ℹ [2026-04-03 03:15:48] Searching the dataset hsapiens ...
#> ℹ [2026-04-03 03:15:49] Connecting to the dataset hsapiens_gene_ensembl ...
#> ℹ [2026-04-03 03:15:52] Converting the geneIDs...
#> ! [2026-04-03 03:15:55] <simpleError in .processResults(postRes, mart = mart, hostURLsep = sep, fullXmlQuery = fullXmlQuery,     quote = quote, numAttributes = length(attributes)): Query ERROR: caught BioMart::Exception::Database: Could not connect to mysql database ensembl_mart_115: DBI connect('database=ensembl_mart_115;host=127.0.0.1;port=5316','ensro',...) failed: Can't connect to MySQL server on '127.0.0.1' (111) at /nfs/public/ro/ensweb/live/mart/www_115/biomart-perl/lib/BioMart/Configuration/DBLocation.pm line 98.
#> !                       >
#> ! [2026-04-03 03:15:55] Get errors when retrieving information from the BioMart database
#> ! [2026-04-03 03:15:56] Retrying...
#> ℹ [2026-04-03 03:15:57] 97 genes mapped with "ensembl_symbol"
#> ℹ [2026-04-03 03:15:57] ==============================
#> ℹ                       97 genes mapped
#> ℹ                       0 genes unmapped
#> ℹ                       ==============================
#> ℹ [2026-04-03 03:15:57] Cached conversion results for "Mus_musculus"
#> ✔ [2026-04-03 03:15:57] Cell cycle gene prefetching completed "Mus_musculus"
str(ccgenes)
#> List of 3
#>  $ res:List of 7
