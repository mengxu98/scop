...
#> ℹ [2026-04-06 10:12:50] Prefetching cell cycle genes for "Homo_sapiens" ...
#> ✔ [2026-04-06 10:12:50] Cell cycle gene prefetching completed "Homo_sapiens"
str(ccgenes)
#> List of 3
#>  $ res: NULL
...
#> ℹ [2026-04-06 10:12:50] Prefetching cell cycle genes for "Mus_musculus" ...
#> ℹ [2026-04-06 10:13:09] Connect to the Ensembl archives...
#> ℹ [2026-04-06 10:13:11] Using the 115 version of ensembl database...
#> ℹ [2026-04-06 10:13:11] Downloading the ensembl database from https://sep2025.archive.ensembl.org...
#> ℹ [2026-04-06 10:13:12] Searching the dataset hsapiens ...
#> ℹ [2026-04-06 10:13:12] Connecting to the dataset hsapiens_gene_ensembl ...
#> ℹ [2026-04-06 10:13:15] Converting the geneIDs...
#> ! [2026-04-06 10:13:17] <simpleError in .processResults(postRes, mart = mart, hostURLsep = sep, fullXmlQuery = fullXmlQuery,     quote = quote, numAttributes = length(attributes)): Query ERROR: caught BioMart::Exception::Database: Could not connect to mysql database ensembl_mart_115: DBI connect('database=ensembl_mart_115;host=127.0.0.1;port=5316','ensro',...) failed: Can't connect to MySQL server on '127.0.0.1' (111) at /nfs/public/ro/ensweb/live/mart/www_115/biomart-perl/lib/BioMart/Configuration/DBLocation.pm line 98.
#> !                       >
#> ! [2026-04-06 10:13:17] Get errors when retrieving information from the BioMart database
#> ! [2026-04-06 10:13:18] Retrying...
#> ! [2026-04-06 10:13:19] <simpleError in .processResults(postRes, mart = mart, hostURLsep = sep, fullXmlQuery = fullXmlQuery,     quote = quote, numAttributes = length(attributes)): Query ERROR: caught BioMart::Exception::Database: Could not connect to mysql database ensembl_mart_115: DBI connect('database=ensembl_mart_115;host=127.0.0.1;port=5316','ensro',...) failed: Can't connect to MySQL server on '127.0.0.1' (111) at /nfs/public/ro/ensweb/live/mart/www_115/biomart-perl/lib/BioMart/Configuration/DBLocation.pm line 98.
#> !                       >
#> ! [2026-04-06 10:13:19] Get errors when retrieving information from the BioMart database
#> ! [2026-04-06 10:13:20] Retrying...
#> ℹ [2026-04-06 10:13:21] 97 genes mapped with "ensembl_symbol"
#> ℹ [2026-04-06 10:13:21] ==============================
#> ℹ                       97 genes mapped
#> ℹ                       0 genes unmapped
#> ℹ                       ==============================
#> ℹ [2026-04-06 10:13:21] Cached conversion results for "Mus_musculus"
#> ✔ [2026-04-06 10:13:21] Cell cycle gene prefetching completed "Mus_musculus"
str(ccgenes)
#> List of 3
#>  $ res:List of 7
