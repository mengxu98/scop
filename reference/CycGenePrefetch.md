...
#> ℹ [2026-06-29 03:11:56] Prefetching cell cycle genes for "Homo_sapiens" ...
#> ✔ [2026-06-29 03:11:56] Cell cycle gene prefetching completed "Homo_sapiens"
str(ccgenes)
#> List of 5
#>  $ res         : NULL
...
#> ℹ [2026-06-29 03:11:56] Prefetching cell cycle genes for "Mus_musculus" ...
#> ℹ [2026-06-29 03:11:56] Connect to the Ensembl archives...
#> ℹ [2026-06-29 03:11:56] Using the 116 version of ensembl database...
#> ℹ [2026-06-29 03:11:56] Downloading the ensembl database from https://jun2026.archive.ensembl.org...
#> Ensembl site unresponsive, trying www mirror
#> Ensembl site unresponsive, trying asia mirror
#> ℹ [2026-06-29 03:12:07] Searching the dataset hsapiens ...
#> ℹ [2026-06-29 03:12:08] Connecting to the dataset hsapiens_gene_ensembl ...
#> ℹ [2026-06-29 03:12:11] Converting the geneIDs...
#> ℹ [2026-06-29 03:12:14] 97 genes mapped with "ensembl_symbol"
#> ℹ [2026-06-29 03:12:14] ==============================
#> ℹ                       97 genes mapped
#> ℹ                       0 genes unmapped
#> ℹ                       ==============================
#> ℹ [2026-06-29 03:12:14] Cached conversion results for "Mus_musculus"
#> ✔ [2026-06-29 03:12:14] Cell cycle gene prefetching completed "Mus_musculus"
str(ccgenes)
#> List of 5
#>  $ res         :List of 7
...
#>   ..$ Attributes     :'data.frame':  3175 obs. of  3 variables:
#>   .. ..$ name       : chr [1:3175] "ensembl_gene_id" "ensembl_gene_id_version" "ensembl_transcript_id" "ensembl_transcript_id_version" ...
#>   .. ..$ description: chr [1:3175] "Gene stable ID" "Gene stable ID version" "Transcript stable ID" "Transcript stable ID version" ...
#>   .. ..$ page       : chr [1:3175] "feature_page" "feature_page" "feature_page" "feature_page" ...
#>   ..$ geneID_unmapped: chr(0) 
#>  $ S           : chr [1:41] "Mcm5" "Pcna" "Tyms" "Fen1" ...
#>  $ G2M         : chr [1:53] "Hmgb2" "Cdk1" "Nusap1" "Ube2c" ...
#>  $ cc_S_genes  : chr [1:41] "Mcm5" "Pcna" "Tyms" "Fen1" ...
#>  $ cc_G2M_genes: chr [1:53] "Hmgb2" "Cdk1" "Nusap1" "Ube2c" ...
```
