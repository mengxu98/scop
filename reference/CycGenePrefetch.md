...
#> ℹ [2026-05-22 16:12:14] Prefetching cell cycle genes for "Homo_sapiens" ...
#> ✔ [2026-05-22 16:12:14] Cell cycle gene prefetching completed "Homo_sapiens"
str(ccgenes)
#> List of 5
#>  $ res         : NULL
...
#> ℹ [2026-05-22 16:12:14] Prefetching cell cycle genes for "Mus_musculus" ...
#> ℹ [2026-05-22 16:12:14] Connect to the Ensembl archives...
#> ℹ [2026-05-22 16:12:15] Using the 115 version of ensembl database...
#> ℹ [2026-05-22 16:12:15] Downloading the ensembl database from https://sep2025.archive.ensembl.org...
...
#> Ensembl site unresponsive, trying asia mirror
#> Ensembl site unresponsive, trying useast mirror
#> ! [2026-05-22 16:12:18] <simpleError: Your query has been redirected to https://status.ensembl.org indicating this Ensembl service is currently unavailable.
#> !                       Look at ?useEnsembl for details on how to try a mirror site.>
#> ! [2026-05-22 16:12:18] Get errors when connecting with ensembl database...
#> ! [2026-05-22 16:12:19] Retrying...
#> Ensembl site unresponsive, trying www mirror
#> Ensembl site unresponsive, trying asia mirror
#> Warning: Invalid mirror. Select a mirror from [www, useast, asia].
#> Default when no mirror is specified is to use www.ensembl.org which may be automatically redirected.
...
#> Ensembl site unresponsive, trying useast mirror
#> Ensembl site unresponsive, trying asia mirror
#> ! [2026-05-22 16:12:22] <simpleError: Your query has been redirected to https://status.ensembl.org indicating this Ensembl service is currently unavailable.
#> !                       Look at ?useEnsembl for details on how to try a mirror site.>
#> ! [2026-05-22 16:12:22] Get errors when connecting with ensembl database...
#> ! [2026-05-22 16:12:23] Retrying...
#> Ensembl site unresponsive, trying asia mirror
#> Ensembl site unresponsive, trying www mirror
#> Warning: Invalid mirror. Select a mirror from [www, useast, asia].
#> Default when no mirror is specified is to use www.ensembl.org which may be automatically redirected.
...
#> Ensembl site unresponsive, trying asia mirror
#> Ensembl site unresponsive, trying useast mirror
#> ! [2026-05-22 16:12:26] <simpleError: Your query has been redirected to https://status.ensembl.org indicating this Ensembl service is currently unavailable.
#> !                       Look at ?useEnsembl for details on how to try a mirror site.>
#> ! [2026-05-22 16:12:26] Get errors when connecting with ensembl database...
#> ! [2026-05-22 16:12:27] Retrying...
#> ℹ [2026-05-22 16:12:41] Searching the dataset hsapiens ...
#> ! [2026-05-22 16:13:41] <error/httr2_failure>
...
#> !                        52.                                 │   └─base::eval(expr, p)
#> !                        53.                                 │     └─base::eval(expr, p)
#> !                        54.                                 └─biomaRt::listDatasets(mart_from)
#> !                        55.                                   └─biomaRt:::.listDatasets(mart = mart, verbose = verbose, sort = TRUE)
#> !                        56.                                     └─biomaRt:::bmRequest(...)
#> !                        57.                                       └─httr2::req_perform(request)
#> ! [2026-05-22 16:13:41] Get errors when connecting with ensembl database (ENSEMBL_MART_ENSEMBL)
#> ! [2026-05-22 16:13:42] Retrying...
#> ℹ [2026-05-22 16:14:08] Connecting to the dataset hsapiens_gene_ensembl ...
#> ℹ [2026-05-22 16:14:09] Converting the geneIDs...
#> ℹ [2026-05-22 16:14:10] 97 genes mapped with "ensembl_symbol"
#> ℹ [2026-05-22 16:14:10] ==============================
#> ℹ                       97 genes mapped
#> ℹ                       0 genes unmapped
#> ℹ                       ==============================
#> ℹ [2026-05-22 16:14:10] Cached conversion results for "Mus_musculus"
#> ✔ [2026-05-22 16:14:10] Cell cycle gene prefetching completed "Mus_musculus"
str(ccgenes)
#> List of 5
#>  $ res         :List of 7
...
#>  $ cc_S_genes  : chr [1:42] "Mcm5" "Pcna" "Tyms" "Fen1" ...
#>  $ cc_G2M_genes: chr [1:55] "Hmgb2" "Cdk1" "Nusap1" "Ube2c" ...
```
