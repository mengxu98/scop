...
#> ℹ [2026-04-27 15:28:47] Prefetching cell cycle genes for "Homo_sapiens" ...
#> ✔ [2026-04-27 15:28:47] Cell cycle gene prefetching completed "Homo_sapiens"
str(ccgenes)
#> List of 3
#>  $ res: NULL
...
#> ℹ [2026-04-27 15:28:47] Prefetching cell cycle genes for "Mus_musculus" ...
#> ℹ [2026-04-27 15:29:04] Connect to the Ensembl archives...
#> ! [2026-04-27 15:29:15] <error/httr2_failure>
...
#> ! [2026-04-27 15:29:15] Get errors when connecting with EnsemblArchives...
#> ! [2026-04-27 15:29:16] Retrying...
#> ! [2026-04-27 15:29:27] <error/httr2_failure>
#> !                       Error in `req_perform()`:
#> !                       ! Failed to perform HTTP request.
#> !                       Caused by error in `curl::curl_fetch_memory()`:
#> !                       ! Timeout was reached [www.ensembl.org]:
...
#> !                        57.                                       └─biomaRt:::.getArchiveList(http_config = http_config)
#> !                        58.                                         └─httr2::req_perform(html_request)
#> ! [2026-04-27 15:29:27] Get errors when connecting with EnsemblArchives...
#> ! [2026-04-27 15:29:28] Retrying...
#> ! [2026-04-27 15:29:38] <error/httr2_failure>
#> !                       Error in `req_perform()`:
#> !                       ! Failed to perform HTTP request.
#> !                       Caused by error in `curl::curl_fetch_memory()`:
#> !                       ! Timeout was reached [www.ensembl.org]:
...
#> !                        57.                                       └─biomaRt:::.getArchiveList(http_config = http_config)
#> !                        58.                                         └─httr2::req_perform(html_request)
#> ! [2026-04-27 15:29:38] Get errors when connecting with EnsemblArchives...
#> ! [2026-04-27 15:29:39] Retrying...
#> ! [2026-04-27 15:29:49] <error/httr2_failure>
#> !                       Error in `req_perform()`:
#> !                       ! Failed to perform HTTP request.
#> !                       Caused by error in `curl::curl_fetch_memory()`:
#> !                       ! Timeout was reached [www.ensembl.org]:
...
#> !                        57.                                       └─biomaRt:::.getArchiveList(http_config = http_config)
#> !                        58.                                         └─httr2::req_perform(html_request)
#> ! [2026-04-27 15:29:49] Get errors when connecting with EnsemblArchives...
#> ! [2026-04-27 15:29:50] Retrying...
#> ℹ [2026-04-27 15:30:00] Using the 115 version of ensembl database...
#> ℹ [2026-04-27 15:30:00] Downloading the ensembl database from https://sep2025.archive.ensembl.org...
#> ℹ [2026-04-27 15:30:02] Searching the dataset hsapiens ...
#> ℹ [2026-04-27 15:30:02] Connecting to the dataset hsapiens_gene_ensembl ...
#> ℹ [2026-04-27 15:30:03] Converting the geneIDs...
#> ℹ [2026-04-27 15:30:06] 97 genes mapped with "ensembl_symbol"
#> ℹ [2026-04-27 15:30:06] ==============================
#> ℹ                       97 genes mapped
#> ℹ                       0 genes unmapped
#> ℹ                       ==============================
#> ℹ [2026-04-27 15:30:06] Cached conversion results for "Mus_musculus"
#> ✔ [2026-04-27 15:30:06] Cell cycle gene prefetching completed "Mus_musculus"
str(ccgenes)
#> List of 3
#>  $ res:List of 7
