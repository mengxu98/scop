...
#> ℹ [2025-11-13 11:54:50] Start standard scop workflow...
#> ℹ [2025-11-13 11:54:50] Checking a list of <Seurat> object...
#> ! [2025-11-13 11:54:50] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2025-11-13 11:54:51] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-13 11:54:53] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-13 11:54:53] Use the separate HVF from srt_list
#> ℹ [2025-11-13 11:54:53] Number of available HVF: 2000
#> ℹ [2025-11-13 11:54:53] Finished check
#> ℹ [2025-11-13 11:54:54] Perform `Seurat::ScaleData()`
#> ℹ [2025-11-13 11:54:54] Perform pca linear dimension reduction
#> StandardPC_ 1 
...
#> ℹ [2025-11-13 11:54:55] Perform `Seurat::FindClusters()` with louvain and `cluster_resolution` = 0.6
#> ℹ [2025-11-13 11:54:55] Reorder clusters...
#> ℹ [2025-11-13 11:54:55] Perform umap nonlinear dimension reduction
#> ℹ [2025-11-13 11:54:55] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-13 11:54:55] UMAP will return its model
#> ℹ [2025-11-13 11:54:59] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-13 11:54:59] UMAP will return its model
#> ✔ [2025-11-13 11:55:02] Run scop standard workflow done
FeatureDimPlot(
  pancreas_sub,
...
#> ✔ [2025-11-13 11:55:06] hexbin installed successfully
