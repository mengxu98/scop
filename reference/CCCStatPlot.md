...
#> ℹ [2026-05-23 12:48:50] Start standard processing workflow...
#> ℹ [2026-05-23 12:48:51] Checking a list of <Seurat>...
#> ! [2026-05-23 12:48:51] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-23 12:48:51] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-23 12:48:52] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-23 12:48:53] Use the separate HVF from `srt_list`
#> ℹ [2026-05-23 12:48:53] Number of available HVF: 2000
#> ℹ [2026-05-23 12:48:53] Finished check
#> ℹ [2026-05-23 12:48:53] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-23 12:48:53] Perform pca linear dimension reduction
#> ℹ [2026-05-23 12:48:54] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-05-23 12:48:54] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-23 12:48:54] Reorder clusters...
#> ℹ [2026-05-23 12:48:54] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-23 12:48:55] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-23 12:48:55] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ℹ [2026-05-23 12:48:57] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ✔ [2026-05-23 12:49:00] Standard processing workflow completed
#> ℹ [2026-05-23 12:49:00] Start CellChat analysis
#> ℹ [2026-05-23 12:49:04] Processing condition: "ConditionA"
...
#> [1] ">>> Run CellChat on sc/snRNA-seq data <<< [2026-05-23 12:49:06.424605]"
#> [1] ">>> CellChat inference is done. Parameter values are stored in `object@options$parameter` <<< [2026-05-23 12:49:26.167188]"
#> ℹ [2026-05-23 12:49:26] Processing condition: "ConditionB"
#> [1] "Create a CellChat object from a data matrix"
#> Set cell identities for the new CellChat object 
...
#> triMean is used for calculating the average gene expression per cell group. 
#> [1] ">>> Run CellChat on sc/snRNA-seq data <<< [2026-05-23 12:49:28.257401]"
#> [1] ">>> CellChat inference is done. Parameter values are stored in `object@options$parameter` <<< [2026-05-23 12:49:49.710279]"
#> ℹ [2026-05-23 12:49:49] Merging CellChat objects for comparison "ConditionA_vs_ConditionB"
#> Merge the following slots: 'data.signaling','images','net', 'netP','meta', 'idents', 'var.features' , 'DB', and 'LR'.
#> ✔ [2026-05-23 12:49:50] CellChat analysis completed
#> ! [2026-05-23 12:49:58] `thisplot::StatPlot()` sankey is count-based. For `CCCStatPlot()` with `plot_type = 'sankey'`, `edge_value` is used to rank/filter pairs, but flow width is shown by interaction count.
#> ℹ [2026-05-23 12:50:02] Setting `group.by` to "Features" as `plot.by` is set to "feature"
```
