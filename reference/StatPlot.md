...
#> ℹ [2025-11-13 12:43:19] Start standard scop workflow...
#> ℹ [2025-11-13 12:43:20] Checking a list of <Seurat> object...
#> ! [2025-11-13 12:43:20] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2025-11-13 12:43:20] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-13 12:43:22] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2025-11-13 12:43:23] Use the separate HVF from srt_list
#> ℹ [2025-11-13 12:43:23] Number of available HVF: 2000
#> ℹ [2025-11-13 12:43:23] Finished check
#> ℹ [2025-11-13 12:43:23] Perform `Seurat::ScaleData()`
#> ℹ [2025-11-13 12:43:24] Perform pca linear dimension reduction
#> StandardPC_ 1 
...
#> ℹ [2025-11-13 12:43:25] Perform `Seurat::FindClusters()` with louvain and `cluster_resolution` = 0.6
#> ℹ [2025-11-13 12:43:25] Reorder clusters...
#> ℹ [2025-11-13 12:43:25] Perform umap nonlinear dimension reduction
#> ℹ [2025-11-13 12:43:25] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-13 12:43:25] UMAP will return its model
#> ℹ [2025-11-13 12:43:29] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2025-11-13 12:43:29] UMAP will return its model
#> ✔ [2025-11-13 12:43:34] Run scop standard workflow done
