...
Visualize spatial spots on tissue coordinates, optionally overlaying a
Seurat spatial image.
...
#> Error in SpatialDimPlot(visium_human_pancreas_sub, features = rownames(visium_human_pancreas_sub)[1:2],     layer = "counts"): unused arguments (features = rownames(visium_human_pancreas_sub)[1:2], layer = "counts")
```
