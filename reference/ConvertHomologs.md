...
#> ℹ [2026-07-02 08:32:32] Connect to the Ensembl archives...
#> ℹ [2026-07-02 08:32:35] Using the 116 version of ensembl database...
#> ℹ [2026-07-02 08:32:35] Downloading the ensembl database from https://jun2026.archive.ensembl.org...
#> Ensembl site unresponsive, trying www mirror
#> ℹ [2026-07-02 08:32:47] Searching the dataset mmusculus ...
#> ℹ [2026-07-02 08:32:48] Connecting to the dataset mmusculus_gene_ensembl ...
#> ℹ [2026-07-02 08:33:15] Converting the geneIDs...
#> ! [2026-07-02 08:33:56] <error/httr2_http_405>
...
#> ! [2026-07-02 08:33:57] Get errors when retrieving information from the BioMart database
#> ! [2026-07-02 08:33:58] Retrying...
#> ! [2026-07-02 08:33:58] <error/httr2_http_405>
#> !                       Error in `httr2::req_perform()`:
#> !                       ! HTTP 405 Method Not Allowed.
#> !                       ---
#> !                       Backtrace:
...
#> !                        57.                                       └─biomaRt:::.submitQueryXML(...)
#> !                        58.                                         └─httr2::req_perform(req)
#> ! [2026-07-02 08:33:58] Get errors when retrieving information from the BioMart database
#> ! [2026-07-02 08:33:59] Retrying...
#> ! [2026-07-02 08:34:00] <error/httr2_http_405>
#> !                       Error in `httr2::req_perform()`:
#> !                       ! HTTP 405 Method Not Allowed.
#> !                       ---
#> !                       Backtrace:
...
#> !                        57.                                       └─biomaRt:::.submitQueryXML(...)
#> !                        58.                                         └─httr2::req_perform(req)
#> ! [2026-07-02 08:34:00] Get errors when retrieving information from the BioMart database
#> ! [2026-07-02 08:34:01] Retrying...
#> ! [2026-07-02 08:34:02] <error/httr2_http_405>
#> !                       Error in `httr2::req_perform()`:
#> !                       ! HTTP 405 Method Not Allowed.
#> !                       ---
#> !                       Backtrace:
...
#> !                        57.                                       └─biomaRt:::.submitQueryXML(...)
#> !                        58.                                         └─httr2::req_perform(req)
#> ! [2026-07-02 08:34:02] Get errors when retrieving information from the BioMart database
#> ! [2026-07-02 08:34:03] Retrying...
#> ! [2026-07-02 08:34:04] <error/httr2_http_405>
#> !                       Error in `httr2::req_perform()`:
#> !                       ! HTTP 405 Method Not Allowed.
#> !                       ---
#> !                       Backtrace:
...
#> !                        57.                                       └─biomaRt:::.submitQueryXML(...)
#> !                        58.                                         └─httr2::req_perform(req)
#> ! [2026-07-02 08:34:04] Get errors when retrieving information from the BioMart database
