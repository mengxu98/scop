...
#> ℹ [2026-05-24 15:29:18] Start standard processing workflow...
#> ℹ [2026-05-24 15:29:19] Checking a list of <Seurat>...
#> ! [2026-05-24 15:29:19] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-24 15:29:19] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-24 15:29:21] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-24 15:29:21] Use the separate HVF from `srt_list`
#> ℹ [2026-05-24 15:29:21] Number of available HVF: 2000
#> ℹ [2026-05-24 15:29:21] Finished check
#> ℹ [2026-05-24 15:29:21] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-24 15:29:22] Perform pca linear dimension reduction
#> ℹ [2026-05-24 15:29:22] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-05-24 15:29:23] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-24 15:29:23] Reorder clusters...
#> ℹ [2026-05-24 15:29:23] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-24 15:29:23] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-24 15:29:23] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ℹ [2026-05-24 15:29:27] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ✔ [2026-05-24 15:29:32] Standard processing workflow completed
ht1 <- GroupHeatmap(
  pancreas_sub,
  features = c(
...
#> ℹ [2026-05-24 15:29:33] Species: "Mus_musculus"
#> ℹ [2026-05-24 15:29:33] Loading cached: CSPA version: CSPA nterm:1 created: 2026-05-24 15:10:21
#> ℹ [2026-05-24 15:29:33] Loading cached: TF version: AnimalTFDB4 nterm:2 created: 2026-05-24 14:30:31
pancreas_sub <- RunDEtest(
  pancreas_sub,
  group.by = "CellType"
)
#> ℹ [2026-05-24 15:29:35] Data type is log-normalized
#> ℹ [2026-05-24 15:29:35] Start differential expression test
#> ℹ [2026-05-24 15:29:35] Find all markers(wilcox) among [1] 5 groups...
#> ℹ [2026-05-24 15:29:35] Using 1 core
#> ⠙ [2026-05-24 15:29:35] Running for Ductal [1/5] ■■          20% | ETA:  1s
#> ✔ [2026-05-24 15:29:35] Completed 5 tasks in 939ms
#> 
#> ℹ [2026-05-24 15:29:35] Building results
#> ✔ [2026-05-24 15:29:36] Differential expression test completed
...
#> ℹ [2026-05-24 15:29:47] Start Enrichment analysis
#> ℹ [2026-05-24 15:29:47] Species: "Mus_musculus"
#> ℹ [2026-05-24 15:29:47] Loading cached: GO_BP version: 3.23.0 nterm:14957 created: 2026-05-24 15:12:29
#> ℹ [2026-05-24 15:29:48] Permform enrichment...
#> ℹ [2026-05-24 15:29:48] Using 1 core
#> ⠙ [2026-05-24 15:29:48] Running for 1 [1/5] ■■          20% | ETA: 17s
#> ⠹ [2026-05-24 15:29:48] Running for 3 [3/5] ■■■■■■      60% | ETA:  6s
#> ⠸ [2026-05-24 15:29:48] Running for 4 [4/5] ■■■■■■■■    80% | ETA:  3s
#> ✔ [2026-05-24 15:29:48] Completed 5 tasks in 14.7s
#> 
#> ℹ [2026-05-24 15:29:48] Building results
#> ✔ [2026-05-24 15:30:03] Enrichment analysis done
#> ℹ [2026-05-24 15:30:48] The size of the heatmap is fixed because certain elements are not scalable.
#> ℹ [2026-05-24 15:30:48] The width and height of the heatmap are determined by the size of the current viewport.
#> ℹ [2026-05-24 15:30:48] If you want to have more control over the size, you can manually set the parameters 'width' and 'height'.
