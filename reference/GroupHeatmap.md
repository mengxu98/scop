...
- grouping.var, numerator:
  ...
  Extra grouping variable (e.g. condition) and the level used as
  numerator.
...
- add_violin, fill.by, fill_palette, fill_palcolor:
  ...
  Overlay violins. `fill.by` is `"group"`, `"feature"`, or
  `"expression"`.
...
`feature_metadata`, and `enrichment` (from
[RunEnrichment](https://mengxu98.github.io/scop/reference/RunEnrichment.md)
when term/key/feature annotations are requested).
...
#> ℹ [2026-09-06 21:34:49] Start standard processing workflow...
#> ℹ [2026-09-06 21:34:50] Checking a list of <Seurat>...
#> ! [2026-09-06 21:34:50] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-09-06 21:34:50] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-09-06 21:34:50] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-09-06 21:34:50] Use the separate HVF from `srt_list`
#> ℹ [2026-09-06 21:34:50] Number of available HVF: 2000
#> ℹ [2026-09-06 21:34:50] Finished check
#> ℹ [2026-09-06 21:34:50] Perform `ScaleData()`
#> ℹ [2026-09-06 21:34:50] Perform pca linear dimension reduction
#> ℹ [2026-09-06 21:34:51] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-09-06 21:34:51] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-09-06 21:34:51] Reorder clusters...
#> ℹ [2026-09-06 21:34:51] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-09-06 21:34:51] Perform umap nonlinear dimension reduction
#> ✔ [2026-09-06 21:34:58] Standard processing workflow completed
ht1 <- GroupHeatmap(
  pancreas_sub,
  features = c(
...
#> ℹ [2026-09-06 21:34:58] Species: "Mus_musculus"
#> ℹ [2026-09-06 21:34:58] Loading cached: CSPA version: CSPA nterm:1 created: 2026-09-06 21:25:21
#> ℹ [2026-09-06 21:34:59] Loading cached: TF version: AnimalTFDB4 nterm:2 created: 2026-09-06 20:52:04
pancreas_sub <- RunDEtest(
  pancreas_sub,
  group.by = "CellType"
)
#> ℹ [2026-09-06 21:35:00] Data type is log-normalized
#> ℹ [2026-09-06 21:35:00] Start differential expression test
#> ℹ [2026-09-06 21:35:00] Find all markers(wilcox) among [1] 5 groups...
#> ℹ [2026-09-06 21:35:00] Using 1 core
#> ⠙ [2026-09-06 21:35:00] Running for Ductal [1/5] ■■          20% | ETA: 15s
#> ⠹ [2026-09-06 21:35:00] Running for Ngn3-high-EP [2/5] ■■■■        40% | ETA:  …
#> ⠸ [2026-09-06 21:35:00] Running for Endocrine [3/5] ■■■■■■      60% | ETA:  6s
#> ⠼ [2026-09-06 21:35:00] Running for Ngn3-low-EP [4/5] ■■■■■■■■    80% | ETA:  3s
#> ✔ [2026-09-06 21:35:00] Completed 5 tasks in 15.3s
#> 
#> ℹ [2026-09-06 21:35:00] Building results
#> ✔ [2026-09-06 21:35:16] Differential expression test completed
...
#> ℹ [2026-09-06 21:35:23] Start Enrichment analysis
#> ℹ [2026-09-06 21:35:23] Species: "Mus_musculus"
#> ℹ [2026-09-06 21:35:23] Loading cached: GO_BP version: 3.23.0 nterm:14957 created: 2026-09-06 21:27:14
#> ℹ [2026-09-06 21:35:25] Permform enrichment...
#> ℹ [2026-09-06 21:35:26] Using 1 core
#> ⠙ [2026-09-06 21:35:26] Running for 1 [1/5] ■■          20% | ETA:  3s
#> ✔ [2026-09-06 21:35:26] Completed 5 tasks in 3.1s
#> 
#> ℹ [2026-09-06 21:35:26] Building results
#> ✔ [2026-09-06 21:35:29] Enrichment analysis done
#> ℹ [2026-09-06 21:36:14] The size of the heatmap is fixed because certain elements are not scalable.
#> ℹ [2026-09-06 21:36:14] The width and height of the heatmap are determined by the size of the current viewport.
#> ℹ [2026-09-06 21:36:14] If you want to have more control over the size, you can manually set the parameters 'width' and 'height'.
ht3$plot
