...
Checks and returns a string indicating the type of data. It checks for
the presence of infinite values, negative values, and whether the values
...
#> ! [2026-09-06 21:04:33] Infinite values detected
#> [1] "unknown"
```
