...
- coralysis_dims_use:
  ...
  Dimensions returned by Coralysis PCA that will be utilized for
  downstream cell cluster finding and nonlinear reduction. If \`NULL\`,
  all available Coralysis PCA dimensions will be used by default.
...
- PrepareData_params:
  ...
  A list of parameters for \[Coralysis::PrepareData\].
...
- RunPCA_params:
  ...
  A list of parameters for \[Coralysis::RunPCA\].
