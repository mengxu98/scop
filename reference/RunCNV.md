...
backends and store the results in a consistent SCOP result bundle.
...
- allele_counts:
  ...
  [`numbat::run_numbat()`](https://kharchenkolab.github.io/numbat/reference/run_numbat.html)
  as `df_allele`.
