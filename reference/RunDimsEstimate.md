...
#> ℹ [2026-06-28 15:12:23] Start standard processing workflow...
#> ℹ [2026-06-28 15:12:23] Checking a list of <Seurat>...
#> ! [2026-06-28 15:12:23] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-28 15:12:23] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 15:12:23] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-28 15:12:23] Use the separate HVF from `srt_list`
#> ℹ [2026-06-28 15:12:24] Number of available HVF: 2000
#> ℹ [2026-06-28 15:12:24] Finished check
#> ℹ [2026-06-28 15:12:24] Perform `ScaleData()`
#> ℹ [2026-06-28 15:12:24] Perform pca linear dimension reduction
#> ℹ [2026-06-28 15:12:25] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-28 15:12:25] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-28 15:12:25] Reorder clusters...
#> ℹ [2026-06-28 15:12:25] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-28 15:12:25] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-28 15:12:33] Standard processing workflow completed
RunDimsEstimate(pancreas_sub)
#> ℹ [2026-06-28 15:12:33] Use stored estimated dimensions 1:23 for Standardpca
