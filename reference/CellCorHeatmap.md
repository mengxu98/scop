...
#> ℹ [2026-01-27 07:15:11] Start standard scop workflow...
#> ℹ [2026-01-27 07:15:12] Checking a list of <Seurat>...
#> ! [2026-01-27 07:15:12] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-01-27 07:15:12] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-27 07:15:13] Perform `Seurat::FindVariableFeatures()` on the data 1/1 of the `srt_list`...
#> ℹ [2026-01-27 07:15:14] Use the separate HVF from srt_list
#> ℹ [2026-01-27 07:15:14] Number of available HVF: 2000
#> ℹ [2026-01-27 07:15:14] Finished check
#> ℹ [2026-01-27 07:15:14] Perform `Seurat::ScaleData()`
#> ℹ [2026-01-27 07:15:14] Perform pca linear dimension reduction
#> ℹ [2026-01-27 07:15:16] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-01-27 07:15:16] Reorder clusters...
#> ℹ [2026-01-27 07:15:16] Perform umap nonlinear dimension reduction
#> ℹ [2026-01-27 07:15:16] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ℹ [2026-01-27 07:15:18] Non-linear dimensionality reduction (umap) using (Standardpca) dims (1-50) as input
#> ✔ [2026-01-27 07:15:21] Run scop standard workflow completed
ht1 <- CellCorHeatmap(
  srt_query = pancreas_sub,
  query_group = "SubCellType"
)
#> ℹ [2026-01-27 07:15:21] Use the HVF to calculate distance metric
#> ℹ [2026-01-27 07:15:21] Use [1] 2000 features to calculate distance.
#> As of Seurat v5, we recommend using AggregateExpression to perform pseudo-bulk analysis.
#> This message is displayed once per session.
#> ℹ [2026-01-27 07:15:21] Detected query data type: "log_normalized_counts"
#> ℹ [2026-01-27 07:15:21] Detected reference data type: "log_normalized_counts"
#> ℹ [2026-01-27 07:15:21] Calculate similarity...
#> ℹ [2026-01-27 07:15:21] Use raw method to find neighbors
#> ℹ [2026-01-27 07:15:21] Predict cell type...
ht1$plot
...
#> ℹ [2026-01-27 07:15:23] Rename features for the assay: RNA
panc8_sub <- CheckDataMerge(
  panc8_sub,
  batch = "tech"
)[["srt_merge"]]
#> ℹ [2026-01-27 07:15:23] Spliting `srt_merge` into `srt_list` by column "tech"...
#> ℹ [2026-01-27 07:15:23] Checking a list of <Seurat>...
#> ! [2026-01-27 07:15:23] Data 1/5 of the `srt_list` is "unknown"
#> ℹ [2026-01-27 07:15:23] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 1/5 of the `srt_list`...
#> ℹ [2026-01-27 07:15:24] Perform `Seurat::FindVariableFeatures()` on the data 1/5 of the `srt_list`...
#> ! [2026-01-27 07:15:25] Data 2/5 of the `srt_list` is "unknown"
#> ℹ [2026-01-27 07:15:25] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 2/5 of the `srt_list`...
#> ℹ [2026-01-27 07:15:26] Perform `Seurat::FindVariableFeatures()` on the data 2/5 of the `srt_list`...
#> ! [2026-01-27 07:15:26] Data 3/5 of the `srt_list` is "unknown"
#> ℹ [2026-01-27 07:15:26] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 3/5 of the `srt_list`...
#> ℹ [2026-01-27 07:15:27] Perform `Seurat::FindVariableFeatures()` on the data 3/5 of the `srt_list`...
#> ! [2026-01-27 07:15:27] Data 4/5 of the `srt_list` is "unknown"
#> ℹ [2026-01-27 07:15:27] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 4/5 of the `srt_list`...
#> ℹ [2026-01-27 07:15:28] Perform `Seurat::FindVariableFeatures()` on the data 4/5 of the `srt_list`...
#> ! [2026-01-27 07:15:29] Data 5/5 of the `srt_list` is "unknown"
#> ℹ [2026-01-27 07:15:29] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on the data 5/5 of the `srt_list`...
#> ℹ [2026-01-27 07:15:30] Perform `Seurat::FindVariableFeatures()` on the data 5/5 of the `srt_list`...
#> ℹ [2026-01-27 07:15:30] Use the separate HVF from srt_list
#> ℹ [2026-01-27 07:15:31] Number of available HVF: 2000
#> ℹ [2026-01-27 07:15:32] Finished check
...
#> ℹ [2026-01-27 07:15:35] Use the HVF to calculate distance metric
#> ℹ [2026-01-27 07:15:35] Use [1] 632 features to calculate distance.
#> ℹ [2026-01-27 07:15:35] Detected query data type: "log_normalized_counts"
#> ℹ [2026-01-27 07:15:35] Detected reference data type: "log_normalized_counts"
#> ℹ [2026-01-27 07:15:35] Calculate similarity...
#> ℹ [2026-01-27 07:15:35] Use raw method to find neighbors
#> ℹ [2026-01-27 07:15:35] Predict cell type...
ht2$plot
...
#> ℹ [2026-01-27 07:15:45] Use the HVF to calculate distance metric
#> ℹ [2026-01-27 07:15:45] Use [1] 632 features to calculate distance.
#> ℹ [2026-01-27 07:15:47] Detected query data type: "log_normalized_counts"
#> ℹ [2026-01-27 07:15:47] Detected reference data type: "log_normalized_counts"
#> ℹ [2026-01-27 07:15:47] Calculate similarity...
#> ℹ [2026-01-27 07:15:47] Use raw method to find neighbors
#> ℹ [2026-01-27 07:15:48] Predict cell type...
ht3$plot
...
#> ℹ [2026-01-27 07:16:01] Use the HVF to calculate distance metric
#> ℹ [2026-01-27 07:16:01] Use [1] 632 features to calculate distance.
#> ℹ [2026-01-27 07:16:02] Detected query data type: "log_normalized_counts"
#> ℹ [2026-01-27 07:16:02] Detected reference data type: "log_normalized_counts"
#> ℹ [2026-01-27 07:16:02] Calculate similarity...
#> ℹ [2026-01-27 07:16:02] Use raw method to find neighbors
#> ℹ [2026-01-27 07:16:02] Predict cell type...
