...
#> ℹ [2026-06-27 18:20:31] Start standard processing workflow...
#> ℹ [2026-06-27 18:20:31] Checking a list of <Seurat>...
#> ! [2026-06-27 18:20:31] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-06-27 18:20:31] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-06-27 18:20:31] Perform `FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-06-27 18:20:31] Use the separate HVF from `srt_list`
#> ℹ [2026-06-27 18:20:32] Number of available HVF: 2000
#> ℹ [2026-06-27 18:20:32] Finished check
#> ℹ [2026-06-27 18:20:32] Perform `ScaleData()`
#> ℹ [2026-06-27 18:20:32] Perform pca linear dimension reduction
#> ℹ [2026-06-27 18:20:33] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-06-27 18:20:33] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-06-27 18:20:33] Reorder clusters...
#> ℹ [2026-06-27 18:20:33] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-06-27 18:20:33] Perform umap nonlinear dimension reduction
#> ✔ [2026-06-27 18:20:40] Standard processing workflow completed
...
#> ℹ [2026-06-27 18:20:40] Running scanpy-compatible preprocessing (15998 features -> filter + normalize)...
#> ℹ [2026-06-27 18:20:41] Running scVelo "stochastic" mode with `backend = 'cpp'` (10590 features)
#> ✔ [2026-06-27 18:20:44] scVelo "stochastic" mode completed
#> ✔ [2026-06-27 18:20:44] scVelo cpp backend completed
VelocityPlot(
  pancreas_sub,
  reduction = "umap"
)
