...
#> ℹ [2026-05-23 09:21:24] Start standard processing workflow...
#> ℹ [2026-05-23 09:21:25] Checking a list of <Seurat>...
#> ! [2026-05-23 09:21:25] Data 1/1 of the `srt_list` is "unknown"
#> ℹ [2026-05-23 09:21:25] Perform `NormalizeData()` with `normalization.method = 'LogNormalize'` on 1/1 of `srt_list`...
#> ℹ [2026-05-23 09:21:27] Perform `Seurat::FindVariableFeatures()` on 1/1 of `srt_list`...
#> ℹ [2026-05-23 09:21:28] Use the separate HVF from `srt_list`
#> ℹ [2026-05-23 09:21:28] Number of available HVF: 2000
#> ℹ [2026-05-23 09:21:28] Finished check
#> ℹ [2026-05-23 09:21:28] Perform `Seurat::ScaleData()`
#> ℹ [2026-05-23 09:21:28] Perform pca linear dimension reduction
#> ℹ [2026-05-23 09:21:29] Use stored estimated dimensions 1:23 for Standardpca
#> ℹ [2026-05-23 09:21:29] Perform `Seurat::FindClusters()` with `cluster_algorithm = 'louvain'` and `cluster_resolution = 0.6`
#> ℹ [2026-05-23 09:21:29] Reorder clusters...
#> ℹ [2026-05-23 09:21:29] Skip `log1p()` because `layer = data` is not "counts"
#> ℹ [2026-05-23 09:21:29] Perform umap nonlinear dimension reduction
#> ℹ [2026-05-23 09:21:29] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ℹ [2026-05-23 09:21:36] Perform umap nonlinear dimension reduction using Standardpca (1:23)
#> ✔ [2026-05-23 09:21:42] Standard processing workflow completed
...
#> ℹ [2026-05-23 09:21:42] Running scVelo stochastic embedding with `backend = 'cpp'` using 2000 features
#> ✔ [2026-05-23 09:21:42] scVelo cpp stochastic embedding completed
VelocityPlot(
  pancreas_sub,
  reduction = "umap"
)
