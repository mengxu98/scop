...
#> ℹ [2026-06-28 21:12:00] Skip `log1p()` because `layer = data` is not "counts"
...
#> ℹ [2026-06-28 21:12:14] Running SuperCell with gamma = 20, k.knn = 5 on 1000 cells
...
#> ℹ [2026-06-28 21:12:16] Running MetaCell-style KNN partitioning with k = 20 on 1000 cells
...
#> Warning: x[] <- val: val is coerced to logical for "ngCMatrix" x
#> Warning: x[] <- val: val is coerced to logical for "ngCMatrix" x
#> ℹ [2026-06-28 21:12:18] `RunMetaCell()` ("metacell") built 8 metacells from 1000 cells
#> ℹ [2026-06-28 21:12:18] Metacell size summary: min 17, median 126, mean 125, max 251 cells
#> Warning: Data is of class ngCMatrix. Coercing to dgCMatrix.
#> ✔ [2026-06-28 21:12:18] `RunMetaCell()` returned metacell Seurat with 8 metacells. Original cells in `@misc[["original_srt"]]`
