...
#> ℹ [2026-06-28 10:33:10] Skip `log1p()` because `layer = data` is not "counts"
...
#> ℹ [2026-06-28 10:33:22] Running SuperCell with gamma = 20, k.knn = 5 on 1000 cells
...
#> ℹ [2026-06-28 10:33:25] Running MetaCell-style KNN partitioning with k = 20 on 1000 cells
...
#> Warning: x[] <- val: val is coerced to logical for "ngCMatrix" x
#> Warning: x[] <- val: val is coerced to logical for "ngCMatrix" x
#> ℹ [2026-06-28 10:33:26] `RunMetaCell()` ("metacell") built 8 metacells from 1000 cells
#> ℹ [2026-06-28 10:33:26] Metacell size summary: min 17, median 126, mean 125, max 251 cells
#> Warning: Data is of class ngCMatrix. Coercing to dgCMatrix.
#> ✔ [2026-06-28 10:33:26] `RunMetaCell()` returned metacell Seurat with 8 metacells. Original cells in `@misc[["original_srt"]]`
