...
Rcpp::List runumap_knn(Rcpp::NumericMatrix X, int k, int n_trees, int n_iters, int leaf_size, double seed, int cores);
RcppExport SEXP _scop_runumap_knn(SEXP XSEXP, SEXP kSEXP, SEXP n_treesSEXP, SEXP n_itersSEXP, SEXP leaf_sizeSEXP, SEXP seedSEXP, SEXP coresSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< int >::type cores(coresSEXP);
    rcpp_result_gen = Rcpp::wrap(runumap_knn(X, k, n_trees, n_iters, leaf_size, seed, cores));
    return rcpp_result_gen;
END_RCPP
}
Rcpp::NumericMatrix runumap_layout(Rcpp::NumericMatrix init, Rcpp::IntegerVector head, Rcpp::IntegerVector tail, Rcpp::NumericVector epochs_per_sample, int n_epochs, double a, double b, double gamma, double initial_alpha, double negative_sample_rate, double seed, int cores);
RcppExport SEXP _scop_runumap_layout(SEXP initSEXP, SEXP headSEXP, SEXP tailSEXP, SEXP epochs_per_sampleSEXP, SEXP n_epochsSEXP, SEXP aSEXP, SEXP bSEXP, SEXP gammaSEXP, SEXP initial_alphaSEXP, SEXP negative_sample_rateSEXP, SEXP seedSEXP, SEXP coresSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< double >::type seed(seedSEXP);
    Rcpp::traits::input_parameter< int >::type cores(coresSEXP);
    rcpp_result_gen = Rcpp::wrap(runumap_layout(init, head, tail, epochs_per_sample, n_epochs, a, b, gamma, initial_alpha, negative_sample_rate, seed, cores));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_scop_runumap_knn", (DL_FUNC) &_scop_runumap_knn, 7},
    {"_scop_runumap_layout", (DL_FUNC) &_scop_runumap_layout, 12},
