...
exploring single-cell and spatial omics data.
...
- Multiple methods for automatic annotation of single-cell data
  ...
  [Scmap](https://github.com/hemberg-lab/scmap), KNNPredict),
  significance-based hierarchical clustering with
  [CHOIR](https://github.com/immunogenomics/CHOIR), and methods for
  projection between single-cell datasets (CSSMap, PCAMap, SeuratMap,
  [SymphonyMap](https://github.com/immunogenomics/symphony)).
- Bulk transcriptomics and cellular composition workflows, including
  ...
  [BisqueRNA](https://cran.r-project.org/package=BisqueRNA),
...
- Multiple single-cell downstream analyses:
  - Differential expression and perturbation analysis: identification of
    ...
    cell selection with
    [Scissor](https://github.com/sunduanchen/Scissor), feature-weight
    phenotype scoring with [FWP](https://github.com/jumphone/FWP),
    network comparison with
  ...
  - Enrichment, and functional scoring: over-representation analysis,
    ...
    [UCell](https://github.com/carmonalab/UCell), metabolic pathway
    activity inference via
    [scMetabolism](https://github.com/wu-yc/scMetabolism), and metabolic
    flux estimation via [scFEA](https://github.com/changwn/scFEA).
  - Transcription factor activity analysis via
    [DoRothEA](https://github.com/saezlab/dorothea),
    [SCENIC](https://github.com/aertslab/SCENIC)/[SCENIC+](https://github.com/aertslab/scenicplus),
    [GRNBoost2](https://github.com/aertslab/GRNBoost2),
    [GENIE3](https://bioconductor.org/packages/release/bioc/html/GENIE3.html),
    and [cisTarget](https://github.com/aertslab/RcisTarget), and dynamic
    enrichment analysis.
  - CNV analysis from scRNA-seq with
    [copykat](https://github.com/navinlabcode/copykat),
    [infercnv](https://github.com/broadinstitute/inferCNV),
    [SCEVAN](https://github.com/cevoae/SCEVAN), and
    [fastCNV](https://github.com/rujinwang/fastCNV), plus tumor
    microenvironment scoring via
    [ESTIMATE](https://github.com/mengxu98/estimate).
  - Cellular potency: [CytoTRACE
    2](https://github.com/digitalcytometry/cytotrace2) and
    [FitDevo](https://github.com/jumphone/FitDevo) for predicting
    cellular differentiation potential.
  - RNA velocity: [RNA velocity](https://github.com/theislab/scvelo),
    [Cell2fate](https://github.com/petruccigroup/cell2fate),
  ...
  - Trajectory inference:
    ...
    developmental direction inference with
    [VECTOR](https://github.com/jumphone/Vector), and identification of
    dynamic features.
  - Cell-cell communication:
    [CellChat](https://github.com/jinworks/CellChat), spatially
    constrained
...
- Spatial analysis: modular domain
  ([Banksy](https://github.com/prabhakarlab/Banksy),
  [BayesSpace](https://github.com/edward130603/BayesSpace),
  [PRECAST](https://github.com/feiyoung/PRECAST)), feature,
  neighborhood, integration, deconvolution
  ([SPOTlight](https://github.com/MarcElosua/SPOTlight),
  [SpaNorm](https://github.com/sdtemple/SpaNorm),
  [CARDspa](https://github.com/yelabucsf/CARD)), spot QC
  ([SpotSweeper](https://github.com/pfizer-opensource/SpotSweeper)), and
  [SpatialCellChat](https://github.com/jinworks/SpatialCellChat)
  communication workflows; native spatial networks and cell-boundary
  visualization; and a lightweight bridge to
  [Giotto](https://github.com/drieslab/Giotto) without wrapping its full
  framework.
