...
- Spatial analysis: modular domain ([Banksy](https://github.com/prabhakarlab/Banksy), [BayesSpace](https://github.com/edward130603/BayesSpace), [PRECAST](https://github.com/feiyoung/PRECAST)), feature, neighborhood, integration, deconvolution ([SPOTlight](https://github.com/MarcElosua/SPOTlight), [SpaNorm](https://github.com/sdtemple/SpaNorm), [CARDspa](https://github.com/yelabucsf/CARD)), spot QC ([SpotSweeper](https://github.com/pfizer-opensource/SpotSweeper)), and SpatialCellChat communication workflows; native spatial networks and cell-boundary visualization; and lightweight bridges to Giotto and SPATA2 without wrapping their full frameworks. Use `ListSpatialMethods()`, `SpatialBackendStatus()`, and `SpatialResultInfo()` to discover methods, diagnose optional backends, and inspect stored results; use `SpatialCoordinates()`, `GetSpatialResult()`, and `GetSpatialGraph()` for stable read-only access to coordinates, result bundles, and graphs. See the [Giotto compatibility and framework bridge guide](vignettes/spatial-framework-bridges.Rmd) before choosing between the legacy workflow and native bridges.
